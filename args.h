...
ArgDescriptor argDescriptors[] = {
 ...
 JAWS_ARGS{"whitePieceColor", ArgColor, (void *)0, TRUE, (ArgIniType)WHITE_PIECE_COLOR},
 ...
 {"viewerOptions", ArgString, (void *)&appData.viewerOptions, TRUE,
  (ArgIniType) "-ncp -engineOutputUp false -saveSettingsOnExit false"},
...
ArgDescriptor argDescriptorIndirection = {"", ArgSettingsFilename, (void *)NULL, FALSE};
