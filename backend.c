...
int establish(void);
void read_from_player(InputSourceRef isr, void * closure, char * buf, int count, int error);
void read_from_ics(InputSourceRef isr, void * closure, char * buf, int count, int error);
...
void ReceiveFromProgram(InputSourceRef isr, void * closure, char * buf, int count, int error);
void SendTimeControl(ChessProgramState * cps, int mps, long tc, int inc, int sd, int st);
...
int startedFromPositionFile = FALSE;
Board filePosition; /* [HGM] loadPos */
...
/* Fake up flags for now, as we aren't keeping track of castling availability yet.

[HGM] Change of logic: the flag now only indicates the type of castlings allowed by the rule of the game.  The actual rights
themselves are maintained in the array castlingRights, as part of the game history, and are not probed by this function. */
int PosFlags(int index) {
    int flags = F_ALL_CASTLE_OK;
    if ((index % 2) == 0) {
        flags |= F_WHITE_ON_MOVE;
    }
...
char *fullTimeControlString = NULL, *nextSession, *whiteTC, *blackTC,
     activePartner; /* [HGM] secondary TC: merge of MPS, TC and inc */
...
ChessSquare twoKingsArray[2][BOARD_FILES] = {
 {WhiteRook, WhiteKnight, WhiteBishop, WhiteQueen, WhiteKing, WhiteKing, WhiteKnight, WhiteRook},
 {BlackRook, BlackKnight, BlackBishop, BlackQueen, BlackKing, BlackKing, BlackKnight, BlackRook}
};

ChessSquare KnightmateArray[2][BOARD_FILES] = {
 {WhiteRook, WhiteMan, WhiteBishop, WhiteQueen, WhiteUnicorn, WhiteBishop, WhiteMan, WhiteRook},
 {BlackRook, BlackMan, BlackBishop, BlackQueen, BlackUnicorn, BlackBishop, BlackMan, BlackRook}
};

ChessSquare SpartanArray[2][BOARD_FILES] = {
 {WhiteRook,  WhiteKnight, WhiteBishop, WhiteQueen, WhiteKing,  WhiteBishop, WhiteKnight, WhiteRook },
 {BlackAlfil, BlackDragon, BlackKing,   BlackTower, BlackTower, BlackKing,   BlackAngel,  BlackAlfil}
};

ChessSquare fairyArray[2][BOARD_FILES] = {
  /* [HGM] Queen side differs from King side */
 {WhiteRook,     WhiteKnight, WhiteBishop,   WhiteQueen, WhiteKing, WhiteBishop,   WhiteKnight, WhiteRook    },
 {BlackCardinal, BlackAlfil,  BlackMarshall, BlackAngel, BlackKing, BlackMarshall, BlackAlfil,  BlackCardinal}
};

ChessSquare ShatranjArray[2][BOARD_FILES] = {
  /* [HGM] (movGen knows about Shatranj Q and P) */
 {WhiteRook, WhiteKnight, WhiteAlfil, WhiteKing, WhiteFerz, WhiteAlfil, WhiteKnight, WhiteRook},
 {BlackRook, BlackKnight, BlackAlfil, BlackKing, BlackFerz, BlackAlfil, BlackKnight, BlackRook}
};

ChessSquare makrukArray[2][BOARD_FILES] = {
  /* [HGM] (movGen knows about Shatranj Q and P) */
 {WhiteRook, WhiteKnight, WhiteMan, WhiteKing, WhiteFerz, WhiteMan, WhiteKnight, WhiteRook},
 {BlackRook, BlackKnight, BlackMan, BlackFerz, BlackKing, BlackMan, BlackKnight, BlackRook}
};

ChessSquare aseanArray[2][BOARD_FILES] = {
  /* [HGM] (movGen knows about Shatranj Q and P) */
 {WhiteRook, WhiteKnight, WhiteMan, WhiteFerz, WhiteKing, WhiteMan, WhiteKnight, WhiteRook},
 {BlackRook, BlackKnight, BlackMan, BlackFerz, BlackKing, BlackMan, BlackKnight, BlackRook}
};

ChessSquare lionArray[2][BOARD_FILES] = {
 {WhiteRook, WhiteLion, WhiteBishop, WhiteQueen, WhiteKing, WhiteBishop, WhiteKnight, WhiteRook},
 {BlackRook, BlackLion, BlackBishop, BlackQueen, BlackKing, BlackBishop, BlackKnight, BlackRook}
};


#if (BOARD_FILES >= 10)
ChessSquare ShogiArray[2][BOARD_FILES] = {
 {WhiteQueen, WhiteKnight, WhiteFerz, WhiteWazir, WhiteKing, WhiteWazir, WhiteFerz, WhiteKnight, WhiteQueen},
 {BlackQueen, BlackKnight, BlackFerz, BlackWazir, BlackKing, BlackWazir, BlackFerz, BlackKnight, BlackQueen}
};

ChessSquare XiangqiArray[2][BOARD_FILES] = {
 {WhiteRook, WhiteKnight, WhiteAlfil, WhiteFerz, WhiteWazir, WhiteFerz, WhiteAlfil, WhiteKnight, WhiteRook},
 {BlackRook, BlackKnight, BlackAlfil, BlackFerz, BlackWazir, BlackFerz, BlackAlfil, BlackKnight, BlackRook}
};

ChessSquare CapablancaArray[2][BOARD_FILES] = {
 {WhiteRook, WhiteKnight, WhiteAngel, WhiteBishop, WhiteQueen, WhiteKing, WhiteBishop, WhiteMarshall, WhiteKnight, WhiteRook},
 {BlackRook, BlackKnight, BlackAngel, BlackBishop, BlackQueen, BlackKing, BlackBishop, BlackMarshall, BlackKnight, BlackRook}
};

ChessSquare GreatArray[2][BOARD_FILES] = {
 {WhiteDragon, WhiteKnight, WhiteAlfil, WhiteGrasshopper, WhiteKing, WhiteSilver, WhiteCardinal, WhiteAlfil, WhiteKnight,
  WhiteDragon},
 {BlackDragon, BlackKnight, BlackAlfil, BlackGrasshopper, BlackKing, BlackSilver, BlackCardinal, BlackAlfil, BlackKnight,
  BlackDragon},
};

ChessSquare JanusArray[2][BOARD_FILES] = {
 {WhiteRook, WhiteAngel, WhiteKnight, WhiteBishop, WhiteKing, WhiteQueen, WhiteBishop, WhiteKnight, WhiteAngel, WhiteRook},
 {BlackRook, BlackAngel, BlackKnight, BlackBishop, BlackKing, BlackQueen, BlackBishop, BlackKnight, BlackAngel, BlackRook}
};

ChessSquare GrandArray[2][BOARD_FILES] = {
 {EmptySquare, WhiteKnight, WhiteBishop, WhiteQueen, WhiteKing, WhiteMarshall, WhiteAngel, WhiteBishop, WhiteKnight, EmptySquare},
 {EmptySquare, BlackKnight, BlackBishop, BlackQueen, BlackKing, BlackMarshall, BlackAngel, BlackBishop, BlackKnight, EmptySquare}
};

ChessSquare ChuChessArray[2][BOARD_FILES] = {
 {WhiteMan, WhiteKnight, WhiteBishop, WhiteCardinal, WhiteLion,  WhiteQueen, WhiteDragon,   WhiteBishop, WhiteKnight, WhiteMan},
 {BlackMan, BlackKnight, BlackBishop, BlackDragon,   BlackQueen, BlackLion,  BlackCardinal, BlackBishop, BlackKnight, BlackMan}
};
...
ChessSquare CourierArray[2][BOARD_FILES] = {
 {WhiteRook, WhiteKnight, WhiteAlfil, WhiteBishop, WhiteMan, WhiteKing, WhiteFerz, WhiteWazir, WhiteBishop, WhiteAlfil, WhiteKnight,
  WhiteRook},
 {BlackRook, BlackKnight, BlackAlfil, BlackBishop, BlackMan, BlackKing, BlackFerz, BlackWazir, BlackBishop, BlackAlfil, BlackKnight,
  BlackRook}
};
ChessSquare ChuArray[6][BOARD_FILES] = {
 {WhiteLance,  WhiteCat,    WhiteCopper, WhiteFerz,     WhiteWazir,  WhiteKing,     WhiteAlfil,    WhiteWazir,  WhiteFerz,     WhiteCopper, WhiteCat,
  WhiteLance                                                                                                                                                     },
 {BlackLance,  BlackCat,    BlackCopper, BlackFerz,     BlackWazir,  BlackAlfil,    BlackKing,     BlackWazir,  BlackFerz,     BlackCopper, BlackCat,
  BlackLance                                                                                                                                                     },
 {WhiteAxe,    EmptySquare, WhiteBishop, EmptySquare,   WhiteClaw,   WhiteMarshall, WhiteAngel,    WhiteClaw,   EmptySquare,   WhiteBishop,
  EmptySquare,                                                                                                                                        WhiteAxe   },
 {BlackAxe,    EmptySquare, BlackBishop, EmptySquare,   BlackClaw,   BlackAngel,    BlackMarshall, BlackClaw,   EmptySquare,   BlackBishop,
  EmptySquare,                                                                                                                                        BlackAxe   },
 {WhiteDagger, WhiteSword,  WhiteRook,   WhiteCardinal, WhiteDragon, WhiteLion,     WhiteQueen,    WhiteDragon, WhiteCardinal, WhiteRook,
  WhiteSword,                                                                                                                                         WhiteDagger},
...
void CommonEngineInit(void) {
...

    {
        ...
        if (appData.timeOddsMode) {
            ...
            if (norm > appData.timeOdds[1]) {
                norm = appData.timeOdds[1];
            }
        }
...
void UnloadEngine(ChessProgramState * cps) {
    ...
    cps->pr = NoProc;
    if (appData.debugMode) {
        fprintf(debugFP, "Unload %s\n", cps->which);
    }
}

void ClearOptions(ChessProgramState * cps) {
    int i;
...
void InitEngine(ChessProgramState * cps, int n) {
    ...
    if (appData.protocolVersion[n] > PROTOVER || appData.protocolVersion[n] < 1) {
        ...
        len = snprintf(buf, MSG_SIZ, _("protocol version %d not supported"), appData.protocolVersion[n]);
...
void AddToEngineList(int i) {
    if (addToList) {
        ...
        snprintf(buf + strlen(buf), MSG_SIZ - strlen(buf), "%c%s%c -fd \"%s\"%s%s%s%s%s%s%s%s", quote, p, quote,
         ...
         isUCI ? (isUCI == TRUE                       ? " -fUCI"
                   : gameInfo.variant == VariantShogi ? " -fUSI"
                                                      : " -fUCCI")
               : "",
         storeVariant ? " -variant " : "", storeVariant ? VariantName(gameInfo.variant) : "");
        if (wbOptions && wbOptions[0]) {
            snprintf(buf + strlen(buf), MSG_SIZ - strlen(buf), " %s", wbOptions);
        }
...
void LoadEngine(void) {
    int i;
    if (WaitForEngine(savCps, LoadEngine)) {
        return;
    }
    if (tryNr == 1 && !isUCI) {
        SendToProgram("uci\n", savCps);
        tryNr = 2;
        ScheduleDelayedEvent(LoadEngine, FEATURE_TIMEOUT);
        return;
    }
    if (tryNr) {
    ...
    if (startedFromSetupPosition) {
        SendBoard(savCps, backwardMostMove);
    }
    for (i = backwardMostMove; i < currentMove; i++) {
        SendMoveToProgram(i, savCps);
    }
    ThawUI();
    SetGNUMode();
    if (oldMode == AnalyzeMode) {
        AnalyzeModeEvent();
    }
}
...
static char resetOptions[] = "-reuse -firstIsUCI false -firstHasOwnBookUCI true -firstTimeOdds 1 "
...
void Load(ChessProgramState * cps, int i) {
    ...
    p = engineName;
    while (q = strchr(p, SLASH)) {
        p = q + 1;
    }
    if (*p == NULLCHAR) {
        DisplayError(_("You did not specify the engine executable"), 0);
        return;
    }
...
void InitBackEnd1(void) {
    ...
    /* [AS] Initialize pv info list [HGM] and game state */
    {
        ...
        for (i = 0; i <= framePtr; i++) {
            ...
            for (j = 0; j < BOARD_FILES - 2; j++) {
                boards[i][CASTLING][j] = NoRights;
            }
        }
    }
    ...
    if (appData.icsActive) {
        /* changes dynamically in ICS mode */
        appData.clockMode = TRUE;
    } else if (appData.noChessProgram) {
        /* [HGM] st: searchTime mode now also is clockMode */
        appData.clockMode = FALSE;
        first.sendTime = second.sendTime = 0;
    }

#if ZIPPY
    /* Override some settings from environment variables, for backward compatibility.  Unfortunately, it's not feasible to have the
    env vars just set defaults, at least in xboard.  Ugh. */
    ...
    if (!appData.icsActive) {
        ...
        /* Check for variants that are supported only in ICS mode, or not at all.  Some that are accepted here nevertheless have
           bugs: see comments below. */
        VariantClass variant = StringToVariant(appData.variant);
        switch (variant) {
        /* Need four players and two boards. */
        case VariantBughouse:
        /* Need to hide pieces and move details. */
        case VariantKriegspiel:
        ...
        /* Definitely works. */
        case VariantNormal:
            if (strcmp(appData.variant, "normal") && !appData.noChessProgram) {
                /* [HGM] hope this is an engine-defined variant */
                safeStrCpy(engineVariant, appData.variant, MSG_SIZ);
                return;
            }
        /* [HGM] repetition rules not implemented */
        case VariantXiangqi:
        /* [HGM] TestLegality definitely off! */
        case VariantFairy:
        /* [HGM] should work */
        case VariantGothic:
        /* [HGM] should work */
        case VariantCapablanca:
        /* [HGM] initial forced moves not implemented */
        case VariantCourier:
        /* [HGM] could still mate with pawn drop */
        case VariantShogi:
        /* [HGM] experimental */
        case VariantChu:
        /* [HGM] should work */
        ...
        /* [HGM] untested */
        case VariantFalcon:
        /* holdings not shown, ([HGM] fixed that!) offboard interposition not understood */
        case VariantCrazyhouse:
        /* pieces not automatically shuffled */
        case VariantWildCastle:
        /* pieces not automatically shuffled */
        case VariantNoCastle:
        /* [HGM] works and shuffles pieces */
        case VariantFischeRandom:
        /* should work except for win condition, and doesn't know captures are mandatory */
        case VariantLosers:
        /* should work except for win condition, and doesn't know captures are mandatory */
        case VariantSuicide:
        /* should work except for win condition, and doesn't know captures are mandatory */
        ...
        /* should work except for win condition */
        case VariantAtomic:
        /* should work except for win condition */
        case Variant3Check:
        /* should work except for all win conditions */
        case VariantShatranj:
        /* should work except for draw countdown */
        case VariantMakruk:
        /* should work except for draw countdown */
        case VariantASEAN:
        /* might work if TestLegality is off */
        ...
        /* experimental */
        case VariantSuper:
        /* experimental, requires legality testing to be off */
        case VariantGreat:
        /* S-Chess, should work */
        case VariantSChess:
        /* should work */
...
int NextSessionFromString(char ** str, int * moves, long * tc, long * inc, int * incType) {
    ...
    if (NextIntegerFromString(str, &temp)) {
        return -1;
    }
    if (type) {
        *moves = 0;
    ...
    if (**str != '/') {
        ...
        if (**str == '+') {
            /* increment follows; read it */
            (*str)++;
            if (**str == '!') {
                /* Bronstein TC */
                type = *(*str)++;
            }
            if (result = NextIntegerFromString(str, &temp2)) {
                return -1;
            }
            *inc = temp2 * 1000;
            if (**str == '.') {
                /* read fraction of increment */
                char * start = ++(*str);
                if (result = NextIntegerFromString(str, &temp2)) {
                    return -1;
                }
    ...
    (*str)++;
    /* NOTE: already converted to seconds by ParseTimeControl() */
    result = NextIntegerFromString(str, &temp2);
...
int GetTimeQuota(int movenr, int lastUsed, char * tcString) {
    int incType;
    /* kludge to force reading of first session */
    int moves = 1;
    long time;
    long increment;
    char * s = tcString;
    ...
    if (!s || !*s) {
        /* empty TC string means we ran out of the last sudden-death version */
        return 0;
    }
    do {
        if (moves) {
            NextSessionFromString(&s, &moves, &time, &increment, &incType);
        }
        nextSession = s;
        suddenDeath = moves == 0 && increment == 0;
        if (movenr == -1) {
            /* last move before new session */
            return time;
        }
        if (incType == '*') {
            increment = 0;
        } else /* for sandclock, time is added while not thinking */ if (incType == '!' && lastUsed < increment) {
            increment = lastUsed;
        }
        if (!moves) {
            /* current session is incremental */
            return increment;
        }
        if (movenr >= 0) {
            /* we already finished this session */
            movenr -= moves;
        }
    } while (movenr >= -1); /* try again for next session */

    /* no new time quota on this move */
    return 0;
}
...
int CalculateIndex(int index, int gameNr) {
    int res;
    if (index > 0) {
        /* fixed nmber */
        return index;
    ...
    /* autoinc */
    res = (index == -1 ? gameNr : (gameNr - 1) / 2 + 1);
    if (appData.rewindIndex > 0) {
        /* rewind */
        res = (res - 1) % appData.rewindIndex + 1;
    }
    return res;
}

/* [HGM] taken out of MatchEvent and NextMatchGame (to combine it) */
int LoadGameOrPosition(int gameNr) {
    if (*appData.loadGameFile != NULLCHAR) {
        if (!LoadGameFromFile(appData.loadGameFile, CalculateIndex(appData.loadGameIndex, gameNr), appData.loadGameFile, FALSE)) {
            DisplayFatalError(_("Bad game file"), 0, 1);
            return 0;
        }
    } else if (*appData.loadPositionFile != NULLCHAR) {
        if (!LoadPositionFromFile(
             appData.loadPositionFile, CalculateIndex(appData.loadPositionIndex, gameNr), appData.loadPositionFile)) {
...
void ReserveGame(int gameNr, char resChar) {
    FILE * tf = fopen(appData.tourneyFile, "r+");
    char *p, *q, c, buf[MSG_SIZ];
    if (tf == NULL) {
        /* kludge to terminate match */
        nextGame = appData.matchGames + 1;
        return;
    }
    safeStrCpy(buf, lastMsg, MSG_SIZ);
    DisplayMessage(_("Pick new game"), "");
    /* lock the tourney file while we are messing with it */
    if (flock(fileno(tf), LOCK_EX)) {
        abortMatch = TRUE;
        appData.matchMode = FALSE;
        DisplayError("Access to tourney file denied", 0);
        fclose(tf);
        return;
    }
    ...
    if (appData.debugMode) {
        ...
        while (*r) {
            fprintf(debugFP, *r >= ' ' ? "%c" : "\\%03o", *r), r++;
        }
        fprintf(debugFP, "\n");
    }
    while (*q && *q != ' ') {
        /* get first un-played game (could be beyond end!) */
        q++;
    }
    nextGame = q - p;
    /* could be arbitrary long, but allow to extend by one! */
    q = malloc(strlen(p) + 2);
    ...
    if (appData.debugMode) {
        fprintf(debugFP, "pick next game from '%s': %d\n", q, nextGame);
    }
    /* reserve next game if tourney not yet done */
    if (nextGame <= appData.matchGames && resChar != ' ' && !abortMatch) {
        if (q[nextGame] == NULLCHAR) {
            /* append one char */
            q[nextGame + 1] = NULLCHAR;
        }
        q[nextGame] = '*';
    }
    fseek(tf, -(strlen(p) + 4), SEEK_END);
    c = fgetc(tf);
    /* depending on DOS or Unix line endings we can be one off */
    if (c != '"') {
        fseek(tf, -(strlen(p) + 2), SEEK_END);
    } else {
        fseek(tf, -(strlen(p) + 3), SEEK_END);
    }
    fprintf(tf, "%s\"\n", q);
    /* update, and flush by closing */
    fclose(tf);
    DisplayMessage(buf, "");
    free(p);
    appData.results = q;
     ...
     (gameNr < 0 || nextGame / appData.defaultMatchGames != gameNr / appData.defaultMatchGames)) {
        ...
        if (gameNr < 0 || appData.tourneyType < 1 ||  /* gauntlet engine can always stay loaded as first engine */
         appData.tourneyType > 1 && nextGame / round != gameNr / round) {  /* in multi-gauntlet change only after round */
            /* next game belongs to other pairing; */
            UnloadEngine(&first);
        }
        /* already unload the engines, so TwoMachinesEvent will load new ones. */
        UnloadEngine(&second);
    }
    if (appData.debugMode) {
        fprintf(debugFP, "Reserved, next=%d, nr=%d\n", nextGame, gameNr);
    }
}
...
void MatchEvent(int mode) {
    int dummy;
    /* already in match mode: switch it off */
    if (matchMode) {
        abortMatch = TRUE;
        if (!appData.tourneyFile[0]) {
            /* kludge to let match terminate after next game. */
            appData.matchGames = matchGame;
        }
        return;
    }
    /*if (gameMode != BeginningOfGame) {
    ...
    nextGame = 0;
    /* sets appData.matchGames if this is tourney, to make sure ReserveGame knows it */
    ...
    if (appData.tourneyFile[0]) {
        ...
        if (nextGame > appData.matchGames) {
            ...
            if (strchr(appData.results, '*') == NULL) {
                ...
                /* make a tourney file with increased number of cycles */
                if (f = WriteTourneyFile(appData.results, NULL)) {
                    fclose(f);
                    NextTourneyGame(-1, &dummy);
                    ReserveGame(-1, 0);
                    if (nextGame <= appData.matchGames) {
    ...
    /* [HGM] in tourney engines are loaded automatically */
    } else if (appData.noChessProgram) {
        DisplayFatalError(_("Can't have a match with no chess programs"), 0, 2);
        return;
    }
    matchMode = mode;
    matchGame = roundNr = 1;
    /* [HGM] match: needed in later matches */
    first.matchWins = second.matchWins = totalTime = 0;
    NextMatchGame();
}
...
void InitBackEnd3(void) {
    ...
    if (!appData.noChessProgram) {
        /* [HGM] tidy: redo program version to use name from myname feature */
        free(programVersion);
        programVersion = (char *)malloc(8 + strlen(PACKAGE_STRING) + strlen(first.tidy));
        sprintf(programVersion, "%s + %s", PACKAGE_STRING, first.tidy);
    ...
    if (appData.icsActive) {
        ...
        if (err != 0) {
            if (*appData.icsCommPort != NULLCHAR) {
                len = snprintf(buf, MSG_SIZ, _("Could not open comm port %s"), appData.icsCommPort);
            } else {
                len = snprintf(buf, MSG_SIZ, _("Could not connect to host %s, port %s"), appData.icsHost, appData.icsPort);
            }
        ...
        SetICSMode();
        telnetISR = AddInputSource(icsPR, FALSE, read_from_ics, &telnetISR);
        fromUserISR = AddInputSource(NoProc, FALSE, read_from_player, &fromUserISR);
        if (appData.keepAlive) {
            /* [HGM] alive: schedule sending of dummy 'date' command */
    ...
    if (*appData.cmailGameName != NULLCHAR) {
        ...
        cmailISR = AddInputSource(cmailPR, FALSE, CmailSigHandlerCallBack, &cmailISR);
    }
    ...
    if (StrCaseCmp(appData.initialMode, "") == 0) {
        ...
        if (!appData.icsActive && appData.noChessProgram) {
            /* [HGM] could be fall-back */
            /* "Machine Black" might have been implicitly highlighted */
            gameMode = MachinePlaysBlack;
            /* make sure XBoard knows it is highlighted, so it will un-highlight it */
            ModeHighlight();
            /* in case BeginningOfGame now means "Edit Position" */
    ...
    if (appData.matchMode) {
        if (appData.tourneyFile[0]) {
            /* start tourney from command line */
            FILE * f;
            if (f = fopen(appData.tourneyFile, "r")) {
                /* make sure tourney parmeters re known */
                ParseArgsFromFile(f);
                fclose(f);
                appData.clockMode = TRUE;
                SetGNUMode();
            } else {
                /* for now ignore bad tourney file */
                appData.tourneyFile[0] = NULLCHAR;
            }
        }
        MatchEvent(TRUE);
        ...
        if (*appData.loadGameFile != NULLCHAR) {
            (void)LoadGameFromFile(appData.loadGameFile, appData.loadGameIndex, appData.loadGameFile, TRUE);
        } else if (*appData.loadPositionFile != NULLCHAR) {
            (void)LoadPositionFromFile(appData.loadPositionFile, appData.loadPositionIndex, appData.loadPositionFile);
            /* [HGM] try to make self-starting even after FEN load to allow automatic setup of fairy variants with wtm */
            if (initialMode == BeginningOfGame && !blackPlaysFirst) {
                gameMode = BeginningOfGame;
                setboardSpoiledMachineBlack = 1;
            }
            /* [HGM] loadPos: make that every new game uses the setup from file as long as we do not switch variant */
            if (!blackPlaysFirst) {
        ...
        if (initialMode == AnalyzeMode) {
            ...
            /* [HGM] thinking: moved out of ShowThinkingEvent */
            appData.showThinking = TRUE;
            ShowThinkingEvent();
            AnalyzeFileEvent();
            AnalysisPeriodicEvent(1);
        } else if (initialMode == MachinePlaysWhite) {
            if (appData.noChessProgram) {
                DisplayFatalError(_("MachineWhite mode requires a chess engine"), 0, 2);
                return;
            }
            if (appData.icsActive) {
                DisplayFatalError(_("MachineWhite mode does not work with ICS mode"), 0, 2);
                return;
            }
            MachineWhiteEvent();
        } else if (initialMode == MachinePlaysBlack) {
            if (appData.noChessProgram) {
                DisplayFatalError(_("MachineBlack mode requires a chess engine"), 0, 2);
                return;
            }
            if (appData.icsActive) {
                DisplayFatalError(_("MachineBlack mode does not work with ICS mode"), 0, 2);
                return;
            }
            MachineBlackEvent();
        } else if (initialMode == TwoMachinesPlay) {
            if (appData.noChessProgram) {
                DisplayFatalError(_("TwoMachines mode requires a chess engine"), 0, 2);
                return;
            }
            if (appData.icsActive) {
                DisplayFatalError(_("TwoMachines mode does not work with ICS mode"), 0, 2);
                return;
            }
            TwoMachinesEvent();
...
/* Establish will establish a contact to a remote host.port.  Sets icsPR to a ProcRef for a process (or pseudo-process) used to talk
to the host.  Returns 0 if okay, error code if not. */
int establish(void) {
    char buf[MSG_SIZ];
    ...
    if (*appData.icsCommPort != NULLCHAR) {
        ...
        if (*appData.remoteShell == NULLCHAR) {
            ...
            snprintf(buf, sizeof(buf), "%s %s %s", appData.telnetProgram, appData.icsHost, appData.icsPort);
            ...
            if (*appData.remoteUser == NULLCHAR) {
                snprintf(buf, sizeof(buf), "%s %s %s %s %s", appData.remoteShell, appData.gateway, appData.telnetProgram,
                 appData.icsHost, appData.icsPort);
            } else {
                snprintf(buf, sizeof(buf), "%s %s -l %s %s %s %s", appData.remoteShell, appData.gateway, appData.remoteUser,
        ...
        /* TCP socket interface differs somewhat between Unix and NT; handle details in the front end. */
...
void show_bytes(FILE * fp, char * buf, int count) {
    while (count--) {
...
int OutputMaybeTelnet(ProcRef pr, char * message, int count, int * outError) {
    ...
    /* allow 1 byte for expanding last char */
...
void read_from_player(InputSourceRef isr, void * closure, char * message, int count, int error) {
    ...
    if (count > 0) {
        ...
        if (have_sent_ICS_logon == 2) {
            if (ini = fopen(appData.icsLogon, "w")) {
                /* save first two lines (presumably username & password) on init script file */
        ...
        RemoveInputSource(isr);
        /* [HGM] 666 is kludge to alert front end */
        DisplayFatalError(_("Got end of file from keyboard"), 0, 666);
    }
}
...
void KeepAlive(void) {
    if (!connectionAlive) {
        DisplayFatalError("No response from ICS", 0, 1);
    }
    /* only sticks if no response to 'date' command. */
...
/* This is used for sending logon scripts to the ICS.  Sending without a delay causes problems when using timestamp on ICC (at least
on my machine). */
void SendToICSDelayed(char * s, long msdelay) {
    int count, outCount, outError;
    ...
    outCount = OutputToProcessDelayed(icsPR, s, count, &outError, msdelay);
    if (outCount < count) {
        DisplayFatalError(_("Error writing to ICS"), outError, 1);
    }
}
...
/* Remove all highlighting escape sequences in s.  Also deletes any suffix starting with '('. */
char * StripHighlightAndTitle(char * s) {
    static char retbuf[MSG_SIZ];
    char * p = retbuf;

    while (*s != NULLCHAR) {
        while (*s == '\033') {
            while (*s != NULLCHAR && !isalpha(*s)) {
                s++;
            }
            if (*s != NULLCHAR) {
                s++;
...
char * VariantName(VariantClass v) {
    if (v == VariantUnknown || *engineVariant) {
...
/* Identify a variant from the strings the chess servers use or the PGN Variant tag names we use. */
VariantClass StringToVariant(char * e) {
    ...
    if (sscanf(e, "%dx%d_%c", &i, &i, &c) == 3 || sscanf(e, "%dx%d+%d_%c", &i, &i, &i, &c) == 4) {
        while (*e++ != '_')
            ;
    }

    /* [HGM] on FICS, misc/shogi is not shogi. */
    if (StrCaseStr(e, "misc/")) {
        v = VariantNormal;
        found = TRUE;
    } else {
        for (i = 0; i < sizeof(variantNames) / sizeof(char *); i++) {
            if (p = StrCaseStr(e, variantNames[i])) {
                if (p && i >= VariantShogi && (p != e && !appData.icsActive || isalpha(p[strlen(variantNames[i])]))) {
                    continue;
                }
                v = (VariantClass)i;
                found = TRUE;
    ...
    if (!found) {
        if ((StrCaseStr(e, "fischer") && StrCaseStr(e, "random")) || StrCaseStr(e, "wild/fr") || StrCaseStr(e, "frc") ||
         StrCaseStr(e, "960")) {
            v = VariantFischeRandom;
        } else if ((i = 4, p = StrCaseStr(e, "wild")) || (i = 1, p = StrCaseStr(e, "w"))) {
            p += i;
            ...
            case 3:
            case 4:
                /* Castling illegal even if K & R happen to start in normal positions. */
                v = VariantNoCastle;
                break;
            case 5:
            case 7:
            ...
            case 28:
                v = VariantShatranj;
                break;
            /* Temporary names for future types.  The name *will* change in a future XBoard/WinBoard release once it is defined. */
            case 29:
                v = Variant29;
                break;
            case 30:
            ...
            case 50:
                ...
                break;
            case -1:
                /* Found "wild" or "w" in the string but no number; must assume it's normal chess. */
                v = VariantNormal;
                break;
            default:
...
/* Test whether pattern is present at &buf[*index]; if so, return TRUE, advance *index beyond it, and set leftover_start to the new
value of *index; else return FALSE.  If pattern contains the character '*', it matches any sequence of characters not containing
'\r', '\n', or the character following the '*' (if any), and the matched sequence(s) are copied into star_match. */
...
void SendToPlayer(char * data, int length) {
    int error, outCount;
...
void PackHolding(char packed[], char * holding) {
    char * p = holding;
    char * q = packed;
    int runlength = 0;
    int curr = 9999;
...
void TelnetRequest(unsigned char ddww, unsigned char option) {
    unsigned char msg[3];
...
void CopyHoldings(Board board, char * holdings, ChessSquare lowestPiece) {
    ...
    if (gameInfo.holdingsWidth < 2) {
        return;
    }
    if (gameInfo.variant != VariantBughouse && board[HOLDINGS_SET]) {
        /* Prevent overwriting by pre-board holdings. */
        return;
    }
    ...
    while ((p = *holdings++) != NULLCHAR) {
        ...
        if (j >= gameInfo.holdingsSize) {
            /* Ignore pieces that do not fit. */
            continue;
        }
        if (j < 0) {
            /* should not happen */
...
void VariantSwitch(Board board, VariantClass newVariant) {
    int newHoldingsWidth, newWidth = 8, newHeight = 8, i, j;
    static Board oldBoard;

    startedFromPositionFile = FALSE;
    if (gameInfo.variant == newVariant) {
        return;
    }

    /* [HGM] This routine is called each time an assignment is made to gameInfo.variant during a game, to make sure the board sizes
    are set to match the new variant.  If that means adding or deleting holdings, we shift the playing board accordingly.

    This kludge is needed because in ICS observe mode, we get boards of an ongoing game without knowing the variant, and learn about
    the latter only later.  This can be because of the move list we requested, in which case the game history is refilled from the
    beginning anyway, but also when receiving holdings of a crazyhouse game.  In the latter case, we want to add those holdings to
    the already received position. */
    ...
    if (newWidth != gameInfo.boardWidth || newHeight != gameInfo.boardHeight || newHoldingsWidth != gameInfo.holdingsWidth) {
        ...
        if (newHoldingsWidth > gameInfo.holdingsWidth) {
            for (i = 0; i < BOARD_HEIGHT; i++) {
                for (j = BOARD_RGHT - 1; j >= BOARD_LEFT; j--) {
                    board[i][j + newHoldingsWidth - gameInfo.holdingsWidth] = board[i][j];
                }
            }
    ...
    /* remember correctly formatted board */
    CopyBoard(oldBoard, board);
    /* this sets up board[0], but also other stuff */
    InitPosition(FALSE);
...
void PlotSeekAd(int i) {
    int x, y, color = 0, r = ratingList[i];
    float tc = tcList[i];
    /* outside graph, so cannot be clicked */
    xList[i] = yList[i] = -100;
    if (r < minRating + 100 && r >= 0) {
        r = minRating + 100;
    }
    if (r > maxRating) {
        r = maxRating;
    ...
    y = ((double)r - minRating) / (maxRating - minRating) * (h - vMargin - squareSize / 8 - 1) + vMargin;
    if (ratingList[i] < 0) {
        y = vMargin + squareSize / 4;
    }
    if (strstr(seekAdList[i], " u ")) {
        color = 1;
    }
    if (!strstr(seekAdList[i], "lightning") &&  /* for now all wilds same color */
     !strstr(seekAdList[i], "bullet") && !strstr(seekAdList[i], "blitz") && !strstr(seekAdList[i], "standard")) {
        color = 2;
    }
    if (strstr(seekAdList[i], "(C) ")) {
        /* plot computer seeks as squares */
        color |= SQUARE;
    }
    DrawSeekDot(xList[i] = x + 3 * (color & ~SQUARE), yList[i] = h - 1 - y, colorList[i] = color);
}

void PlotSingleSeekAd(int i) { PlotSeekAd(i); }

void AddAd(char * handle, char * rating, int base, int inc, char rated, char * type, int nr, Boolean plot) {
    char buf[MSG_SIZ], *ext = "";
    VariantClass v = StringToVariant(type);
    if (strstr(type, "wild")) {
        /* append wild number */
        ext = type + 4;
        if (v == VariantFischeRandom) {
            type = "chess960";
        } else if (v == VariantLoadable) {
            type = "setup";
        } else {
            type = VariantName(v);
        }
    ...
    if (nrOfSeekAds < MAX_SEEK_ADS - 1) {
        if (seekAdList[nrOfSeekAds]) {
            free(seekAdList[nrOfSeekAds]);
        }
        /* for if seeker has no rating */
        ratingList[nrOfSeekAds] = -1;
        ...
        if (plot) {
            PlotSingleSeekAd(nrOfSeekAds - 1);
        }
    }
}

void EraseSeekDot(int i) {
    ...
    if (x < hMargin + d) {
        DrawSeekAxis(hMargin, y - squareSize / 8, hMargin, y + squareSize / 8 + 1);
    }
    /* now replot every dot that overlapped */
    for (k = 0; k < nrOfSeekAds; k++) {
        if (k != i) {
...
Boolean MatchSoughtLine(char * line) {
...
int DrawSeekGraph(void) {
    ...
    h = desired_board_dimension_in_pixels(BOARD_HEIGHT, squareSize, lineGap) + 2 * border;
    w = desired_board_dimension_in_pixels(BOARD_WIDTH, squareSize, lineGap) + 2 * border;
    ...
    for (i = 0; i < 4000; i += 100) {
        if (i >= minRating && i < maxRating) {
            ...
            yy = h - 1 - yy;
            /* rating ticks */
            DrawSeekAxis(hMargin - 5, yy, hMargin + 5 * (i % 500 == 0), yy);
            if (i % 500 == 0) {
                char buf[MSG_SIZ];
    ...
    for (i = 1; i < 100; i += (i < 10 ? 1 : 5)) {
        ...
        /* TC ticks */
        DrawSeekAxis(xx, h - 1 - vMargin, xx, h - 6 - vMargin - 3 * (i % 10 == 0));
...
int SeekGraphClick(ClickType click, int x, int y, int moving) {
    ...
    if (!(appData.seekGraph && appData.icsActive && loggedOn && (gameMode == BeginningOfGame || gameMode == IcsIdle))) {
        if (!seekGraphUp) {
            return FALSE;
        }
        /* seek graph is up when it shouldn't be: take it down */
        seekGraphUp = FALSE;
        DrawPosition(TRUE, NULL);
        return TRUE;
    }
    /* initiate cration of seek graph by requesting seek-ad list */
    if (!seekGraphUp) {
        if (click == Release || moving) {
            return FALSE;
        }
        nrOfSeekAds = 0;
        soughtPending = TRUE;
        ...
        /* issue challenge based on clicked ad */
        int dist = 10000;
        int i, closest = 0, second = 0;
        for (i = 0; i < nrOfSeekAds; i++) {
            ...
            /* count in-range ads */
            second += (d - zList[i] < 120);
            if (click == Press && moving != 1 && zList[i] > 0) {
                /* age priority */
                zList[i] *= 0.8;
            }
        }
        if (dist < 120) {
            ...
            if (click == Press) {
                if (moving == 2) {
                    /* right-click; push to back on press */
                    zList[closest] = 100;
                }
                lastDown = closest;
                return TRUE;
            ...
            if (moving == 2) {
                /* ignore right up-clicks on dot */
                return TRUE;
            }
            snprintf(buf, MSG_SIZ, "play %d\n", seekNrList[closest]);
            SendToICS(ics_prefix);
            SendToICS(buf);
            /* let incoming board of started game pop down the graph */
            return TRUE;
        } else if (click == Release) {
            /* release 'miss' is ignored */
            /* make future selection of the rejected ad more difficult */
            zList[lastDown] = 100;
            if (moving == 2) {
                /* right up-click */
                /* refresh graph */
...
/* telnet ECHO option */
int remoteEchoOption = FALSE;

void read_from_ics(InputSourceRef isr, void * closure, char * data, int count, int error) {
/* overflowed at 8K with "inchannel 1" on FICS? */
...
#define STARTED_MOVES_NOHIDE 7
    ...
    /* [HGM] alive: I think, therefore I am... */
    ...
    if (appData.debugMode) {
        ...
        fprintf(debugFP, "ics input %d, castling = %d %d %d %d %d %d\n", f, boards[f][CASTLING][0], boards[f][CASTLING][1],
         boards[f][CASTLING][2], boards[f][CASTLING][3], boards[f][CASTLING][4], boards[f][CASTLING][5]);
    }
    if (count > 0) {
        /* If last read ended with a partial line that we couldn't parse, prepend it to the new read and try again. */
        if (leftover_len > 0) {
        ...
        for (i = 0; i < count; i++) {
            ...
            if (!appData.noJoin) {
                /* Joining just consists of finding matches against the continuation sequence, and discarding that sequence if found
                instead of copying it.  So, until a match fails, there's nothing to do since it might be the complete sequence, and
                thus, something we don't want copied. */
                if (data[i] == cont_seq[cmatch]) {
                    cmatch++;
                    if (cmatch == strlen(cont_seq)) {
                        /* complete match.  just reset the counter */
                        cmatch = 0;
                        /* It's possible for the ICS to not include the space at the end of the last word, making our [correct] join
                        operation fuse two separate words.  The server does this when the space occurs at the width setting. */
                    ...
                    /* Match failed, so we have to copy what matched before falling through and copying this character.  In reality,
                    this will only ever be just the newline character, but it doesn't hurt to be precise. */
        ...
        i = 0;
        while (i < buf_len) {
            /* Deal with part of the TELNET option negotiation protocol.  We refuse to do anything beyond the defaults, except that
            we allow the WILL ECHO option, which ICS uses to turn off password echoing when we are directly connected to it.  We
            reject this option if localLineEditing mode is on (always on in xboard) and we are talking to port 23, which might be a
            real telnet server that will try to keep WILL ECHO on permanently. */
            if (buf_len - i >= 3 && (unsigned char)buf[i] == TN_IAC) {
                ...
                case TN_WILL:
                    ...
                    case TN_ECHO:
                        ...
                        /* Reply only if this is a change, according to the protocol rules. */
                        if (remoteEchoOption) {
                            break;
                        }
                        if (appData.localLineEditing && atoi(appData.icsPort) == TN_PORT) {
                            TelnetRequest(TN_DONT, TN_ECHO);
                        } else {
                            EchoOff();
                            TelnetRequest(TN_DO, TN_ECHO);
                ...
                case TN_WONT:
                    ...
                    default:
                        ...
                        /* Whatever this is, it must already be turned off, because we never agree to turn on anything non-default,
                        so according to the protocol rules, we don't reply. */
                        break;
                    }
                    break;
                case TN_DO:
                ...
                case TN_DONT:
                    ...
                    default:
                        ...
                        /* Whatever this is, we are already not doing it, because we never agree to do anything non-default, so
                        according to the protocol rules, we don't reply. */
                        break;
                    }
                    break;
                case TN_IAC:
            ...
            if (loggedOn && !intfSet) {
                if (ics_type == ICS_ICC) {
                    snprintf(str, MSG_SIZ, "/set-quietly interface %s\n/set-quietly style 12\n", programVersion);
                    if (appData.seekGraph && appData.autoRefresh) {
            ...
            if (started == STARTED_COMMENT) {
                ...
                if (buf[i] == '\n') {
                    ...
                    if (chattingPartner >= 0) {
                        ...
                        if (collective == 1) {
                            /* broadcasted talk also goes to private chatbox of talker */
                            int p;
                            /* strip closing delimiter */
                            talker[strlen(talker + 1) - 1] = NULLCHAR;
                            for (p = 0; p < MAX_CHAT; p++) {
                                if (!StrCaseCmp(talker + 1, chatPartner[p])) {
                        ...
                        chattingPartner = -1;
                        if (collective != 3) {
                            /* [HGM] suppress printing in ICS window */
                            next_out = i + 1;
                        }
                        collective = 0;
                    } else if (!suppressKibitz) {
                        /* [HGM] kibitz */
                        AppendComment(forwardMostMove, StripHighlight(parse), TRUE);
                    } else {
                        /* [HGM kibitz: divert memorized engine kibitz to engine-output window */
                        int nrDigit = 0, nrAlph = 0, j;
                        /* defuse unreasonably long input */
                        if (parse_pos > MSG_SIZ - 30) {
                            parse_pos = MSG_SIZ - 30;
                            parse[parse_pos - 1] = '\n';
                        }
                        parse[parse_pos] = NULLCHAR;
                        /* Try to be smart: if it does not look like search info, it should go to ICS interaction window after all,
                        not to engine-output window. */
                        /* count letters and digits */
                        for (j = 0; j < parse_pos; j++) {
                            nrDigit += (parse[j] >= '0' && parse[j] <= '9');
                            nrAlph += (parse[j] >= 'a' && parse[j] <= 'z');
                            nrAlph += (parse[j] >= 'A' && parse[j] <= 'Z');
                        }
                        /* if more than 10% digit we assume search info */
                        if (nrAlph < 9 * nrDigit) {
                            int depth = 0;
                            float score;
            ...
            if (!loggedOn &&
             (looking_at(buf, &i, "\"*\" is *a registered name") || looking_at(buf, &i, "Logging you in as \"*\"") ||
            ...
            /* skip finger notes */
            if (started == STARTED_NONE && ((buf[i] == ' ' && isdigit(buf[i + 1])) || (buf[i] == '1' && buf[i + 1] == '0')) &&
             buf[i + 2] == ':' && buf[i + 3] == ' ') {
            ...
            if (appData.seekGraph) {
                ...
                if ((gameMode == IcsIdle || gameMode == BeginningOfGame) && looking_at(buf, &i, "* ads displayed")) {
                    soughtPending = FALSE;
                    seekGraphUp = TRUE;
                    DrawSeekGraph();
                    continue;
            ...
            /* skip formula vars */
            if (started == STARTED_NONE && buf[i] == 'f' && isdigit(buf[i + 1]) && buf[i + 2] == ':') {
                started = STARTED_CHATTER;
                i += 3;
                continue;
            }
            ...
            if (appData.autoKibitz && started == STARTED_NONE && !appData.icsEngineAnalyze &&  /* [HGM] [DM] ICS analyze */
                ...
                if ((looking_at(buf, &i, "\n* kibitzes: ") || looking_at(buf, &i, "\n* whispers: ") ||
                 ...
                 (StrStr(star_match[0], gameInfo.white) == star_match[0] ||
                  StrStr(star_match[0], gameInfo.black) == star_match[0])) {  /* kibitz of self or opponent */
                    ...
                    next_out = i;
                    if ((StrStr(star_match[0], gameInfo.white) == star_match[0] && (gameMode == IcsPlayingWhite)) ||
                     (StrStr(star_match[0], gameInfo.black) == star_match[0] &&
                      (gameMode == IcsPlayingBlack))) {  /* opponent kibitz */
                        /* own kibitz we simply discard */
                        started = STARTED_CHATTER;
                    } else {
                        /* make sure it will be collected in parse[] */
                        started = STARTED_COMMENT;
                        parse_pos = 0;
                        parse[0] = NULLCHAR;
                        savingComment = TRUE;
                        suppressKibitz = gameMode != IcsObserving ? 2 : (StrStr(star_match[0], gameInfo.white) == NULL) + 1;
                    }
                    continue;
                } else if ((looking_at(buf, &i, "\nkibitzed to *\n") || looking_at(buf, &i, "kibitzed to *\n") ||
                            looking_at(buf, &i, "\n(kibitzed to *\n") || looking_at(buf, &i, "(kibitzed to *\n")) &&
                 atoi(star_match[0])) {
                    ...
                    if (p = strchr(star_match[0], ' ')) {
                        /* clip off "players)" on FICS */
                        p[1] = NULLCHAR;
                    }
            ...
            if (started == STARTED_NONE &&
             (looking_at(buf, &i, "* tells you:") || looking_at(buf, &i, "* says:") || looking_at(buf, &i, "* whispers:") ||
              looking_at(buf, &i, "* kibitzes:") || looking_at(buf, &i, "* shouts:") || looking_at(buf, &i, "* c-shouts:") ||
              looking_at(buf, &i, "--> * ") || looking_at(buf, &i, "*(*):") && (sscanf(star_match[1], "%d", &channel), 1) ||
              ...
              looking_at(buf, &i, "*(*)(*)(*)(*):") && sscanf(star_match[4], "%d", &channel) == 1)) {
                int p;
                /* strip (C) or (U) off ICS handle */
                sscanf(star_match[0], "%[^(]", talker + 1);
                chattingPartner = -1;
                collective = 0;

                if (channel >= 0) {
                    /* channel broadcast; look if there is a chatbox for this channel */
                    for (p = 0; p < MAX_CHAT; p++) {
                        collective = 1;
                    ...
                    /* kibitz; look if there is a KIBITZ chatbox */
                    for (p = 0; p < MAX_CHAT; p++) {
                        collective = 1;
                    ...
                    /* whisper; look if there is a WHISPER chatbox */
                    for (p = 0; p < MAX_CHAT; p++) {
                        collective = 1;
                ...
                } else if (buf[i - 3] == 't' || buf[oldi + 2] == '>') {
                    /* shout, c-shout or it; look if there is a 'shouts' chatbox */
                    if (buf[i - 8] == '-' && buf[i - 3] == 't') {
                        for (p = 0; p < MAX_CHAT; p++) {
                            /* c-shout; check if dedicatesd c-shout box exists */
                            collective = 1;
                ...
                if (chattingPartner < 0) {
                    /* if not, look if there is a chatbox for this indivdual */
                    for (p = 0; p < MAX_CHAT; p++) {
                        if (!StrCaseCmp(talker + 1, chatPartner[p])) {
                            talker[0] = 0;
                            Colorize(ColorTell, FALSE);
                            if (collective) {
                                safeStrCpy(talker, "broadcasts: ", MSG_SIZ);
                            }
                            collective |= 2;
                            chattingPartner = p;
                            break;
                ...
                if (chattingPartner < 0) {
                    i = oldi, safeStrCpy(lastTalker, talker + 1, MSG_SIZ);
                } else {
                    /* undo the bogus colorations we just made to trigger the souds */
                    Colorize(curColor, TRUE);
                    started = STARTED_COMMENT;
                    parse_pos = 0;
                    parse[0] = NULLCHAR;
                    /* counts as TRUE */
                    savingComment = 3 + chattingPartner;
                    if (collective == 3) {
                        i = oldi;
                    } else {
                        suppressKibitz = TRUE;
            ...
            if (
             ...
             (tkind = 1, looking_at(buf, &i, "* tells you: ")) || looking_at(buf, &i, "* (your partner) tells you: ") ||
             looking_at(buf, &i, "* says: ") ||
             /* Don't color "message" or "messages" output */
             (tkind = 5, looking_at(buf, &i, "*. * (*:*): ")) || looking_at(buf, &i, "*. * at *:*: ") ||
             looking_at(buf, &i, "--* (*:*): ") ||
             ...
             (tkind = 2, looking_at(buf, &i, "* whispers: ")) || looking_at(buf, &i, "* kibitzes: ") ||
             /* Channel tells */
             (tkind = 3, looking_at(buf, &i, "*(*: "))) {
                ...
                if (star_match[0][0] == NULLCHAR || strchr(star_match[0], ' ') || (tkind == 3 && strchr(star_match[1], ' '))) {
                    ...
                    if (started == STARTED_NONE && appData.autoComment &&
                     (gameMode == IcsObserving || gameMode == IcsPlayingWhite || gameMode == IcsPlayingBlack)) {
                        parse_pos = i - oldi;
            ...
            if (looking_at(buf, &i, "* s-shouts: ") || looking_at(buf, &i, "* c-shouts: ")) {
                if (appData.colorize) {
                    if (oldi > next_out) {
                        SendToPlayer(&buf[next_out], oldi - next_out);
                        next_out = oldi;
            ...
            if (looking_at(buf, &i, "* shouts: ") || looking_at(buf, &i, "--> ")) {
                if (appData.colorize) {
                    if (oldi > next_out) {
                        SendToPlayer(&buf[next_out], oldi - next_out);
                        next_out = oldi;
            ...
            if (looking_at(buf, &i, "* offers you") || looking_at(buf, &i, "* offers to be") ||
             looking_at(buf, &i, "* would like to") || looking_at(buf, &i, "* requests to") ||
             looking_at(buf, &i, "Your opponent offers") || looking_at(buf, &i, "Your opponent requests")) {
                if (appData.colorize) {
                    if (oldi > next_out) {
                        SendToPlayer(&buf[next_out], oldi - next_out);
                        next_out = oldi;
            ...
            if (i < backup) {
                i = backup;
                continue;
            }  /* [HGM] for if ZippyControl matches, but the colorie code doesn't */
            ...
            if (looking_at(buf, &i, "\\   ")) {
                ...
                if (savingComment) {
                    ...
                    parse[parse_pos] = NULLCHAR;
                    started = STARTED_COMMENT;
                    /* [HGM] chat: continuation of line for chat box */
                    if (savingComment >= 3) {
                        /* kludge to remember the box */
                        chattingPartner = savingComment - 3;
                    }
                } else {
                    started = STARTED_CHATTER;
                }
            ...
            if (looking_at(buf, &i, "Black Strength :") || looking_at(buf, &i, "<<< style 10 board >>>") ||
             looking_at(buf, &i, "<10>") || looking_at(buf, &i, "#@#")) {
                /* Wrong board style */
                loggedOn = TRUE;
                SendToICS(ics_prefix);
            ...
            if (looking_at(buf, &i, "login:")) {
                if (!have_sent_ICS_logon) {
                    if (ICSInitScript()) {
                        ...
                        /* no init script was found */
                        /* flag that we should capture username + password */
                        have_sent_ICS_logon = (appData.autoCreateLogon ? 2 : 1);
                    }
                } else {
                    /* we have sent (or created) the InitScript, but apparently the ICS rejected it */
                    /* request creation of a new script */
                    have_sent_ICS_logon = (appData.autoCreateLogon ? 2 : 1);
                }
                continue;
            }
            ...
            if (looking_at(buf, &i, "* *vs. * *--- *")) {
                ...
                case H_FALSE:
                    ...
                    case BeginningOfGame:
                        /* User typed "moves" or "oldmoves" while we were idle.  Pretend we asked for these moves and soak them up
                           so user can step through them and/or save them. */
                        Reset(FALSE, TRUE);
                ...
                case H_REQUESTED:
                    ...
                    if (gameInfo.white && gameInfo.black && strcmp(gameInfo.white, star_match[0]) == 0 &&
                ...
                if ((ics_getting_history == H_GOT_REQ_HEADER || ics_getting_history == H_GOT_UNREQ_HEADER) &&
                 (gameInfo.whiteRating == -1 || gameInfo.blackRating == -1)) {
            ...
            if (looking_at(buf, &i, "* * match, initial time: * minute*, increment: * second")) {
            ...
            if (looking_at(buf, &i, "Move  ")) {
                ...
                case H_FALSE:
                    ...
                    break;
                case H_REQUESTED:
                    /* Happens if we are ignoring a move list that is not the one we just requested.  Common if the user tries to
                    observe two games without turning off getMoveList. */
                    break;
                case H_GETTING_MOVES:
                    /* Should not happen */
            ...
            if (looking_at(buf, &i, "% ") ||
             ((started == STARTED_MOVES || started == STARTED_MOVES_NOHIDE) && looking_at(buf, &i, "}*"))) {
                /* [HGM] book */
                char * bookHit = NULL;
                /* [HGM] seekgraph: on ICC sought-list has no termination line */
                if (soughtPending && nrOfSeekAds) {
                    soughtPending = FALSE;
                    seekGraphUp = TRUE;
                    DrawSeekGraph();
                }
                ...
                case STARTED_MOVES_NOHIDE:
                    ...
                    if (appData.zippyPlay && first.initDone) {
                        ...
                        if (gameMode == IcsPlayingWhite) {
                            if (WhiteOnMove(forwardMostMove)) {
                                ...
                                if (first.useColors) {
                                    /* [HGM] book: made sending of "go\n" book dependent */
                                    SendToProgram("white\n", &first);
                                }
                                /* [HGM] book: probe book for initial pos */
                    ...
                    if (gameMode == IcsObserving && ics_gamenum == -1) {
                        /* Moves came from oldmoves or moves command while we weren't doing anything else. */
                        ...
                        DisplayBothClocks();
                        snprintf(str, MSG_SIZ, "%s %s %s", gameInfo.white, _("vs."), gameInfo.black);
                        DisplayTitle(str);
                        gameMode = IcsIdle;
                    } else {
                ...
                if (bookHit) {
                    ...
                    programStats.nodes = programStats.depth = programStats.time = programStats.score = programStats.got_only_move =
                     0;
            ...
            if ((started == STARTED_MOVES || started == STARTED_BOARD || started == STARTED_HOLDINGS ||
                 started == STARTED_MOVES_NOHIDE) &&
             i >= leftover_len) {
            ...
            /* Start of game messages.  Mostly we detect start of game when the first board image arrives.  On some versions of the
               ICS, though, we need to do a "refresh" after starting to observe in order to get the current board right away. */
            ...
            /* Handle auto-observe */
            if (appData.autoObserve && (gameMode == IcsIdle || gameMode == BeginningOfGame) &&
             looking_at(buf, &i, "Game notification: * (*) vs. * (*)")) {
                char * player;
                /* Choose the player that was highlighted, if any. */
                if (star_match[0][0] == '\033' || star_match[1][0] != '\033') {
                    player = star_match[0];
                } else {
                    player = star_match[2];
                }
                ...
                if (appData.debugMode) {
                    fprintf(debugFP, "Ratings from 'Game notification:' %s %d, %s %d\n", player1Name, player1Rating, player2Name,
                     player2Rating);
                }
            ...
            /* Deal with automatic examine mode after a game, and with IcsObserving -> IcsExamining transition */
            if (looking_at(buf, &i, "Entering examine mode for game *") ||
             looking_at(buf, &i, "has made you an examiner of game *")) {
                ...
                if ((gameMode == IcsIdle || gameMode == IcsObserving) && gamenum == ics_gamenum) {
                    /* We were already playing or observing this game, so there is no need to refetch history. */
                    ...
                    /* A previous developer didn't think that this case really could happen. */
                    SendToICS(ics_prefix);
                    SendToICS("refresh\n");
                }
                continue;
            ...
            /* Error messages */
            /*if (ics_user_moved) {*/
            /* [HGM] old way ignored error after move type in; ics_user_moved is not set then! */
            if (1) {
                if (looking_at(buf, &i, "Illegal move") || looking_at(buf, &i, "Not a legal move") ||
                 looking_at(buf, &i, "Your king is in check") || looking_at(buf, &i, "It isn't your turn") ||
                 looking_at(buf, &i, "It is not your move")) {
                    /* Illegal move */
                    /* only backup if we already moved */
                    if (ics_user_moved && forwardMostMove > backwardMostMove) {
                        currentMove = forwardMostMove - 1;
                        /* before DMError */
                        DisplayMove(currentMove - 1);
                        DrawPosition(FALSE, boards[currentMove]);
                        /* [HGM] race */
                        SwitchClocks(forwardMostMove - 1);
                        DisplayBothClocks();
                    }
                    /* [HGM] but always relay error msg */
            ...
            if (looking_at(buf, &i, "still have time") || looking_at(buf, &i, "not out of time") ||
             looking_at(buf, &i, "either player is out of time") || looking_at(buf, &i, "has timeseal; checking")) {
                /* We must have called his flag a little too soon. */
                whiteFlag = blackFlag = FALSE;
                continue;
            }

            if (looking_at(buf, &i, "added * seconds to") || looking_at(buf, &i, "seconds were added to")) {
                /* Update the clocks. */
                SendToICS(ics_prefix);
                SendToICS("refresh\n");
                continue;
            ...
            /* Grab player ratings from the Creating: message.  Note we have to check for the special case when the ICS inserts
            things like [white] or [black]. */
            if (looking_at(buf, &i, "Creating: * (*)* * (*)") || looking_at(buf, &i, "Creating: * (*) [*] * (*)")) {
                /* star_matches:
                   ...
                   The names/ratings are sorted out when the game actually starts (below). */
                ...
                if (appData.debugMode) {
                    fprintf(
                     debugFP, "Ratings from 'Creating:' %s %d, %s %d\n", player1Name, player1Rating, player2Name, player2Rating);
                }
            ...
            if ((tkind = 0, looking_at(buf, &i, "{Game * (* vs. *) *}*")) ||
             (tkind = 1, looking_at(buf, &i, "{Game * (*(*) vs. *(*)) *}*"))) {
                ...
                /* Game start messages */
                if (strncmp(why, "Creating ", 9) == 0 || strncmp(why, "Continuing ", 11) == 0) {
                    gs_gamenum = gamenum;
                    safeStrCpy(gs_kind, strchr(why, ' ') + 1, sizeof(gs_kind) / sizeof(gs_kind[0]));
                    /* [HGM] only if we are not already involved in a game (because gin=1 sends us such messages) */
                    if (ics_gamenum == -1) {
                        /* [HGM] variantswitch: even before we get first board */
                        VariantSwitch(boards[currentMove], StringToVariant(gs_kind));
                    }
#if ZIPPY
...
#endif /*ZIPPY*/
                    /* [HGM] bughouse */
                    partnerBoardValid = FALSE;
                    continue;
                }

                /* Game end messages */
                if (gameMode == IcsIdle || gameMode == BeginningOfGame || ics_gamenum != gamenum) {
                    continue;
                }
                while (endtoken[0] == ' ') {
                    endtoken++;
                ...
                if (appData.zippyPlay && first.initDone) {
                    ...
                    if (first.pr == NoProc) {
                        /* Start the next process early so that we'll be ready for the next challenge. */
                        StartChessProgram(&first);
                    }
                    /* Send "new" early, in case this command takes a long time to finish, so that we'll be ready for the next
                    challenge. */
                    /* [HGM] variantswitch: suppress sending of 'variant' */
                    gameInfo.variant = VariantNormal;
                    Reset(TRUE, TRUE);
                }
#endif /*ZIPPY*/
                if (appData.bgObserve && partnerBoardValid) {
                    DrawPosition(TRUE, partnerBoard);
                }
                continue;
            }

            if (looking_at(buf, &i, "Removing game * from observation") || looking_at(buf, &i, "no longer observing game *") ||
             looking_at(buf, &i, "Game * (*) has no examiners")) {
                if (gameMode == IcsObserving && atoi(star_match[0]) == ics_gamenum) {
                    /* icsEngineAnalyze */
            ...
            if (looking_at(buf, &i, "no longer examining game *")) {
                if (gameMode == IcsExamining && atoi(star_match[0]) == ics_gamenum) {
                    gameMode = IcsIdle;
                    ics_gamenum = -1;
                    ics_user_moved = FALSE;
                }
            ...
            /* Advance leftover_start past any newlines we find, so only partial lines can get reparsed */
            if (looking_at(buf, &i, "\n")) {
                prevColor = curColor;
                ...
                if (started == STARTED_BOARD) {
                    ...
                    if (appData.premove) {
                        char str[MSG_SIZ];
                        if (currentMove == 0 && gameMode == IcsPlayingWhite && appData.premoveWhite) {
                            snprintf(str, MSG_SIZ, "%s\n", appData.premoveWhiteText);
                            if (appData.debugMode) {
                                fprintf(debugFP, "Sending premove:\n");
                            }
                            SendToICS(str);
                        } else if (currentMove == 1 && gameMode == IcsPlayingBlack && appData.premoveBlack) {
                            ...
                            UserMoveEvent(premoveFromX, premoveFromY, premoveToX, premoveToY, premovePromoChar);
                            if (forwardMostMove == oldFMM) {
                                /* premove was rejected, highlight last opponent move */
                    ...
                    if (sscanf(parse, " game %d", &gamenum) == 1) {
                        /* [HGM] bughouse: old code if part of foreground game */
                        if (gamenum == ics_gamenum) {
                            new_piece[0] = NULLCHAR;
                            sscanf(parse, "game %d white [%s black [%s <- %s", &gamenum, white_holding, black_holding, new_piece);
                            white_holding[strlen(white_holding) - 1] = NULLCHAR;
                            black_holding[strlen(black_holding) - 1] = NULLCHAR;
                            if (gameInfo.variant == VariantNormal) {
                                /* [HGM] We seem to switch variant during a game!  Presumably no holdings were displayed, so we have
                                to move the position two files to the right to create room for them! */
                                VariantClass newVariant;
                                /* base guess on board width */
                                switch (gameInfo.boardWidth) {
                                case 9:
                                    newVariant = VariantShogi;
                                    break;
                                case 10:
                                    newVariant = VariantGreat;
                                    break;
                                default:
                                    newVariant = VariantCrazyhouse;
                                    if (strchr(white_holding, 'E') || strchr(black_holding, 'E') || strchr(white_holding, 'H') ||
                                     strchr(black_holding, 'H')) {
                                        newVariant = VariantSChess;
                                    }
                                }
                                /* temp guess */
                                VariantSwitch(boards[currentMove], newVariant);
                                /* Get a move list just to see the header, which will tell us whether this is really bug or zh */
                            ...
                            /* flag holdings as set */
                            boards[forwardMostMove][HOLDINGS_SET] = 1;
#if ZIPPY
                            if (appData.zippyPlay && first.initDone) {
                            ...
                            if (tinyLayout || smallLayout) {
                                ...
                                snprintf(str, MSG_SIZ, "[%s-%s] %s-%s", wh, bh, gameInfo.white, gameInfo.black);
                            } else {
                                snprintf(str, MSG_SIZ, "%s [%s] %s %s [%s]", gameInfo.white, white_holding, _("vs."),
                                 gameInfo.black, black_holding);
                            }
                            /* [HGM] bughouse: when peeking at partner game we already know what he captured... */
                            if (!partnerUp) {
                                DrawPosition(FALSE, boards[currentMove]);
                            }
                            DisplayTitle(str);
                        } else if (appData.bgObserve) {
                            /* [HGM] bughouse: holdings of other game => background */
                            sscanf(parse, "game %d white [%s black [%s <- %s", &gamenum, white_holding, black_holding, new_piece);
                            white_holding[strlen(white_holding) - 1] = NULLCHAR;
                            black_holding[strlen(black_holding) - 1] = NULLCHAR;
                            ...
                            if (twoBoards) {
                                partnerUp = 1;
                                flipView = !flipView;
                            }  /* [HGM] dual: always draw */
                            if (partnerUp) {
                                DrawPosition(FALSE, partnerBoard);
                            }
                            if (twoBoards) {
                                partnerUp = 0;
                                flipView = !flipView;
                    ...
                    if (looking_at(buf, &i, "*% ")) {
                        if (strchr(star_match[0], 7)) {
                            /* Bell(); // FICS fuses bell for next board with prompt in zh captures */
                            SendToPlayer("\007", 1);
                        }
                        savingComment = FALSE;
                        suppressKibitz = 0;
            ...
            /* skip unparsed character and loop back */
            i++;
        }
        if (started != STARTED_MOVES && started != STARTED_BOARD && !suppressKibitz &&  /* [HGM] kibitz */
         /*started != STARTED_HOLDINGS && i > next_out) { /* [HGM] should we compare to leftover_start instead of i? */
        ...
        /* If buffer ends with something we couldn't parse, reparse it after appending the next read. */
    } else if (count == 0) {
        RemoveInputSource(isr);
...
<12> r-b---k- pp----pp ---bP--- ---p---- q------- ------P- P--Q--BP -----R-K W -1 0 0 0 0 0 0 paf MaxII 0 2 12 21 25 234 174 24
 Q/d7-a4 (0:06) Qxa4 0 0

The "<12> " is stripped before it gets to this routine.  The two trailing zeroes (flip state and clock ticking) are a later
addition, and some chess servers may not have them, or may have only the first.  Additional trailing fields may be added in the
future. */

#define PATTERN "%c%d%d%d%d%d%d%d%s%s%d%d%d%d%d%d%d%d%s%s%s%d%d"

#define RELATION_OBSERVING_PLAYED 0
/* examined, oldmoves, or smoves */
#define RELATION_OBSERVING_STATIC -2
...
/* FICS only */
#define RELATION_STARTING_POSITION -4
...
void ParseBoard12(char * string) {
    ...
    char promoChar;
    /* [HGM] ICS80: allow variable board size */
    int ranks = 1, files = 0;
    ...
    elapsed_time[0] = NULLCHAR;
    {
        ...
        while (i < 199 && (string[i] != ' ' || string[i + 2] != ' ')) {
            ...
            if (!strchr(" -pnbrqkPNBRQK", string[i])) {
                /* test for fairies */
                weird = TRUE;
            }
            i++;
        ...
        for (j = 0; j < i; j++) {
            board_chars[j] = string[j];
        }
        board_chars[i] = '\0';
        string += i + 1;
    }
    n = sscanf(string, PATTERN, &to_play, &double_push, &castle_ws, &castle_wl, &castle_bs, &castle_bl, &irrev_count, &gamenum,
     white, black, &relation, &basetime, &increment, &white_stren, &black_stren, &white_time, &black_time, &moveNum, str,
     elapsed_time, move_str, &ics_flip, &ticking);
    ...
    if (moveNum > framePtr) {
        /* [HGM] vari: do not run into saved variations */
        DisplayFatalError(_("Game too long; increase MAX_MOVES and recompile"), 0, 1);
        return;
    }
    ...
    case RELATION_PLAYING_NOTMYMOVE:
        newGameMode = ((relation == RELATION_PLAYING_MYMOVE) == (to_play == 'W')) ? IcsPlayingWhite : IcsPlayingBlack;
        /* [HGM] seekgraph: solve race condition */
        soughtPending = FALSE;
        break;
    ...
    default:
        /* Just display this board.  If user was doing something else, we will forget about it until the next board comes. */
        newGameMode = IcsIdle;
        break;
    ...
    if ((gameMode == IcsPlayingWhite || gameMode == IcsPlayingBlack ||
     ...
     && newGameMode == IcsObserving && gamenum != ics_gamenum && appData.bgObserve) {
        ...
        if (toSqr = strchr(str, '/')) {
            /* extract highlights from long move */
            /* kludge: hide highlighting info in board */
            partnerBoard[EP_STATUS - 3] = toSqr[1] - AAA;
            partnerBoard[EP_STATUS - 4] = toSqr[2] - ONE;
        } else {
            partnerBoard[EP_STATUS - 4] = partnerBoard[EP_STATUS - 3] = -1;
        }
        if (toSqr = strchr(str, '-')) {
            partnerBoard[EP_STATUS - 1] = toSqr[1] - AAA;
            partnerBoard[EP_STATUS - 2] = toSqr[2] - ONE;
        } else {
            partnerBoard[EP_STATUS - 1] = partnerBoard[EP_STATUS - 2] = -1;
        }
        ...
        snprintf(partnerStatus, MSG_SIZ, "W: %d:%02d B: %d:%02d (%d-%d) %c", white_time * fac / 60000,
         (white_time * fac % 60000) / 1000, (black_time * fac / 60000), (black_time * fac % 60000) / 1000, white_stren, black_stren,
         to_play);
        if (!twoBoards) {
    ...
    /* Modify behavior for initial board display on move listing of wild games. */
    switch (ics_getting_history) {
    case H_FALSE:
    case H_REQUESTED:
        break;
    ...
    case H_GOT_UNREQ_HEADER:
        ...
        newGameMode = gameMode;
        /* ICC needs this */
        relation = RELATION_STARTING_POSITION;
        break;
    case H_GOT_UNWANTED_HEADER:
    ...
    if (gameInfo.boardHeight != ranks || gameInfo.boardWidth != files || move_str[1] == '@' && !gameInfo.holdingsWidth ||
     weird && (int)gameInfo.variant < (int)VariantShogi) {
        /* [HGM] We seem to have switched variant unexpectedly.  Try to guess new variant from board size. */
        /* if 8x8, but fairies present */
        VariantClass newVariant = VariantFairy;
        if (ranks == 8 && files == 10) {
            newVariant = VariantCapablanca;
        } else if (ranks == 10 && files == 9) {
            newVariant = VariantXiangqi;
        } else if (ranks == 8 && files == 12) {
            newVariant = VariantCourier;
        } else if (ranks == 9 && files == 9) {
            newVariant = VariantShogi;
        } else if (ranks == 10 && files == 10) {
            newVariant = VariantGrand;
        } else if (!weird) {
            newVariant = move_str[1] == '@' ? VariantCrazyhouse : VariantNormal;
        }
        /* temp guess */
        VariantSwitch(boards[currentMove], newVariant);
        /* Get a move list just to see the header, which will tell us whether this is really bug or zh */
    ...
    /* Take action if this is the first board of a new game, or of a different game than is currently being displayed. */
    if (gamenum != ics_gamenum || newGameMode != gameMode || relation == RELATION_ISOLATED_BOARD) {
        ...
        if (gamenum == -1) {
            newGameMode = IcsIdle;
        } else if ((moveNum > 0 || newGameMode == IcsObserving) && newGameMode != IcsIdle && appData.getMoveList && !reqFlag) {
        ...
        /* Initially flip the board to have black on the bottom if playing black or if the ICS flip flag is set, but let the user
        change it with the Flip View button. */
        flipView = appData.autoFlipView ? (newGameMode == IcsPlayingBlack) || ics_flip : appData.flipView;
        ...
        if (strcmp(player1Name, white) == 0 && strcmp(player2Name, black) == 0) {
            if (appData.debugMode) {
        ...
        } else if (strcmp(player2Name, white) == 0 && strcmp(player1Name, black) == 0) {
            if (appData.debugMode) {
        ...
        if (appData.quietPlay && (gameMode == IcsPlayingWhite || gameMode == IcsPlayingBlack)) {
            SendToICS(ics_prefix);
    ...
    /* In pausing && IcsExamining mode, we ignore boards coming in if they are in a different variation than we are. */
    if (pauseExamInvalid) {
        return;
    }
    ...
    /* [HGM] indicate holdings not set */
    boards[moveNum][HOLDINGS_SET] = 0;
    if (moveNum == 0) {
        startedFromSetupPosition = !CompareBoards(board, initialPosition);
        if (startedFromSetupPosition) {
            /* [HGM] 50-move counter offset */
            initialRulePlies = irrev_count;
        }
    }

    /* [HGM] Set castling rights.  Take the outermost rooks, to make it also work for FRC opening positions.  Note that board12 is
    really defective for later FRC positions, as it has no way to indicate which rook can castle if they are on the same side of the
    king.  For the initial position we grant rights to the outermost rooks, and remember thos rights, and we then copy them on
    positions later in an FRC game.  This means WB might not recognize castlings with rooks that have moved back to their original
    position as illegal, but in ICS mode that is not its job anyway. */
    if (moveNum == 0 || gameInfo.variant != VariantFischeRandom) {
        ...
        for (i = BOARD_LEFT, j = NoRights; i < BOARD_RGHT; i++) {
            if (board[0][i] == WhiteRook) {
                j = i;
            }
        }
        initialRights[0] = boards[moveNum][CASTLING][0] =
         (castle_ws == 0 && gameInfo.variant != VariantFischeRandom ? NoRights : j);
        for (i = BOARD_RGHT - 1, j = NoRights; i >= BOARD_LEFT; i--) {
            if (board[0][i] == WhiteRook) {
                j = i;
            }
        }
        initialRights[1] = boards[moveNum][CASTLING][1] =
         (castle_wl == 0 && gameInfo.variant != VariantFischeRandom ? NoRights : j);
        for (i = BOARD_LEFT, j = NoRights; i < BOARD_RGHT; i++) {
            if (board[BOARD_HEIGHT - 1][i] == BlackRook) {
                j = i;
            }
        }
        initialRights[3] = boards[moveNum][CASTLING][3] =
         (castle_bs == 0 && gameInfo.variant != VariantFischeRandom ? NoRights : j);
        for (i = BOARD_RGHT - 1, j = NoRights; i >= BOARD_LEFT; i--) {
            if (board[BOARD_HEIGHT - 1][i] == BlackRook) {
                j = i;
            }
        }
        initialRights[4] = boards[moveNum][CASTLING][4] =
         (castle_bl == 0 && gameInfo.variant != VariantFischeRandom ? NoRights : j);
        ...
        for (k = BOARD_LEFT; k < BOARD_RGHT; k++) {
            if (board[0][k] == wKing) {
                initialRights[2] = boards[moveNum][CASTLING][2] = k;
            }
        }
        for (k = BOARD_LEFT; k < BOARD_RGHT; k++) {
        ...
        if (gameInfo.variant == VariantTwoKings) {
            ...
            if (board[0][4] == wKing) {
                initialRights[2] = boards[moveNum][CASTLING][2] = 4;
            }
            if (board[BOARD_HEIGHT - 1][4] == bKing) {
                initialRights[5] = boards[moveNum][CASTLING][5] = 4;
            }
        }
    } else {
        int r;
        r = boards[moveNum][CASTLING][0] = initialRights[0];
        if (board[0][r] != WhiteRook) {
            boards[moveNum][CASTLING][0] = NoRights;
        }
        r = boards[moveNum][CASTLING][1] = initialRights[1];
        if (board[0][r] != WhiteRook) {
            boards[moveNum][CASTLING][1] = NoRights;
        }
        r = boards[moveNum][CASTLING][3] = initialRights[3];
        if (board[BOARD_HEIGHT - 1][r] != BlackRook) {
            boards[moveNum][CASTLING][3] = NoRights;
        }
        r = boards[moveNum][CASTLING][4] = initialRights[4];
        if (board[BOARD_HEIGHT - 1][r] != BlackRook) {
            boards[moveNum][CASTLING][4] = NoRights;
        }
    ...
    if (str[0] == 'P') {
        boards[moveNum][EP_STATUS] = EP_PAWN_MOVE;
    }
    if (strchr(move_str, 'x')) {
        boards[moveNum][EP_STATUS] = EP_CAPTURE;
    }
    if (double_push != -1) {
        int dir = WhiteOnMove(moveNum) ? 1 : -1, last = BOARD_HEIGHT - 1;
        /* also set new e.p. variables */
        boards[moveNum][EP_STATUS] = double_push + BOARD_LEFT;
        boards[moveNum][EP_FILE] = boards[moveNum][EP_STATUS];
        boards[moveNum][EP_RANK] = (last + 3 * dir) / 2;
        boards[moveNum][LAST_TO] = 128 * (last + dir) + boards[moveNum][EP_FILE];
    } else {
        boards[moveNum][EP_FILE] = boards[moveNum][EP_RANK] = 100;
    }


    if (ics_getting_history == H_GOT_REQ_HEADER || ics_getting_history == H_GOT_UNREQ_HEADER) {
        /* This was an initial position from a move list, not the current position */
        return;
    }
    ...
    if (newGame) {
        ...
        if (gameMode == IcsExamining && moveNum == 0) {
            /* Workaround for ICS limitation: we are not told the wild type when starting to examine a game.  But if we ask for the
            move list, the move list header will tell us */
            ics_getting_history = H_REQUESTED;
            snprintf(str, MSG_SIZ, "%smoves %d\n", ics_prefix, gamenum);
            SendToICS(str);
        }
     ...
     (moveNum < forwardMostMove && moveNum >= backwardMostMove)) {
        ...
        if (appData.zippyPlay && moveNum < forwardMostMove && first.initDone &&
         (gameMode == IcsObserving || gameMode == IcsExamining) && gameInfo.variant == currentlyInitializedVariant) {
            takeback = forwardMostMove - moveNum;
            for (i = 0; i < takeback; i++) {
                if (appData.debugMode) {
                    fprintf(debugFP, "take back move\n");
                }
                SendToProgram("undo\n", &first);
            }
        }
        ...
        if (gameMode == IcsExamining && moveNum > 0 && appData.getMoveList) {
            ...
            if (appData.zippyPlay && forwardMostMove > 0 && first.initDone) {
                /* [HGM] when we will receive the move list we now request, it will be fed to the engine from the first move on. So
                if the engine is not in the initial position now, bring it there. */
...
#if ZIPPY
    if (appData.zippyPlay && newGame && gameMode != IcsObserving && gameMode != IcsIdle && gameMode != IcsExamining) {
        ZippyFirstBoard(moveNum, basetime, increment);
    }
#endif

    /* Put the move on the move list, first converting to canonical algebraic form. */
    if (moveNum > 0) {
        if (appData.debugMode) {
            int f = forwardMostMove;
        ...
        if (moveNum <= backwardMostMove) {
            /* We don't know what the board looked like before this move.  Punt. */
            ...
            /* Again, we don't know what the board looked like; this is really the start of the game. */
            ...
            int valid;
            char buf[MSG_SIZ], *prom;

            if (gameInfo.variant == VariantShogi && !strchr(move_str, '=') && !strchr(move_str, '@')) {
                /* If ICS does not say 'promote' on non-drop, we defer. */
                strcat(move_str, "=");
            }
            ...
            if ((prom = strstr(move_str, "=")) && !strstr(buf, "=")) {
                /* long move lacks promo specification! */
                strcat(buf, prom);
            }
            /* drops never ambiguous (parser chokes on long form!) */
            if (!appData.testLegality && move_str[1] != '@') {
                if (appData.debugMode) {
                    fprintf(debugFP, "replaced ICS move '%s' by '%s'\n", move_str, buf);
                }
                safeStrCpy(move_str, buf, MSG_SIZ);
            }
            valid = ParseOneMove(move_str, moveNum - 1, &moveType, &fromX, &fromY, &toX, &toY, &promoChar) ||
             ParseOneMove(buf, moveNum - 1, &moveType, &fromX, &fromY, &toX, &toY, &promoChar);
            /* end of long SAN patch */
            if (valid) {
                (void)CoordsToAlgebraic(
                 boards[moveNum - 1], PosFlags(moveNum - 1), fromY, fromX, toY, toX, promoChar, parseList[moveNum - 1]);
                ...
                case MT_CHECK:
                    ...
                    break;
                case MT_CHECKMATE:
                /* [HGM] xq: for notation stalemate that wins counts as checkmate */
                case MT_STAINMATE:
                    strcat(parseList[moveNum - 1], "#");
                    break;
                }
                ...
                if (gameInfo.variant == VariantShogi && currentMoveString[4]) {
                    currentMoveString[4] = '^';
                }
                safeStrCpy(
                 moveList[moveNum - 1], currentMoveString, sizeof(moveList[moveNum - 1]) / sizeof(moveList[moveNum - 1][0]));
                ...
                if (gameInfo.holdingsWidth && !appData.disguise && gameInfo.variant != VariantSuper &&
                 ...
                 gameInfo.variant != VariantSChess) {  /* inherit info that ICS does not give from previous board */
                    for (k = 0; k < ranks; k++) {
                        for (j = BOARD_LEFT; j < BOARD_RGHT; j++) {
                            ChessSquare old, new = boards[moveNum][k][j];
                            if (new == EmptySquare || fromY == DROP_RANK && k == toY && j == toX) {
                                /* dropped pieces always stand for themselves */
                                continue;
                            }
                            old = (k == toY && j == toX) ? boards[moveNum - 1][fromY][fromX]
                                                         : boards[moveNum - 1][k][j];  /* trace back mover */
                            if (old == new) {
                                continue;
                            }
                            if (old == PROMOTED(new)) {
                                /* prevent promoted pieces to revert to primordial ones */
                                boards[moveNum][k][j] = old;
                            } else if (new == WhiteWazir || new == BlackWazir) {
                                if (old < WhiteCannon || old >= BlackPawn && old < BlackCannon) {
                                    /* choose correct type of Gold in promotion */
                                    boards[moveNum][k][j] = PROMOTED(old);
                                } else {
                                    /* preserve type of Gold */
                                    boards[moveNum][k][j] = old;
                                }
                            } else if (old == WhitePawn || old == BlackPawn) {  /* Pawn promotions (but not e.p.capture!) */
                                /* use non-primordial representation of chosen piece */
                                boards[moveNum][k][j] = PROMOTED(new);
                            }
                        }
                    }
                }
        ...
        if (appData.zippyPlay && !newGame && newMove && (!appData.getMoveList || backwardMostMove == 0) && first.initDone) {
            if ((gameMode == IcsPlayingWhite && WhiteOnMove(moveNum)) || (gameMode == IcsPlayingBlack && !WhiteOnMove(moveNum))) {
                if (moveList[moveNum - 1][0] == NULLCHAR) {
                    ...
                    /* [HGM] book */
                    bookHit = SendMoveToBookUser(moveNum - 1, &first, FALSE);
                    if (firstMove && !bookHit) {
                        firstMove = FALSE;
                        if (first.useColors) {
                            SendToProgram(gameMode == IcsPlayingWhite ? "white\ngo\n" : "black\ngo\n", &first);
                        } else {
                            SendToProgram("go\n", &first);
                        }
                        first.maybeThinking = TRUE;
    ...
    if (moveNum > 0 && !gotPremove && !appData.noGUI) {
        /* If move comes from a remote source, animate it.  If it isn't remote, it will have already been animated. */
    ...
    if (gameMode == IcsIdle || relation == RELATION_OBSERVING_STATIC || relation == RELATION_EXAMINING || ics_clock_paused) {
        DisplayBothClocks();
    } else {
        StartClocks();
    }
    ...
    if (gameInfo.variant != VariantBughouse && gameInfo.variant != VariantCrazyhouse && !appData.noGUI) {
        if (tinyLayout || smallLayout) {
            if (gameInfo.variant == VariantNormal) {
                snprintf(str, MSG_SIZ, "%s(%d) %s(%d) {%d %d}", gameInfo.white, white_stren, gameInfo.black, black_stren, basetime,
                 increment);
            } else {
                snprintf(str, MSG_SIZ, "%s(%d) %s(%d) {%d %d w%d}", gameInfo.white, white_stren, gameInfo.black, black_stren,
                 basetime, increment, (int)gameInfo.variant);
            }
        } else {
            if (gameInfo.variant == VariantNormal) {
                snprintf(str, MSG_SIZ, "%s (%d) %s %s (%d) {%d %d}", gameInfo.white, white_stren, _("vs."), gameInfo.black,
                 black_stren, basetime, increment);
            } else {
                snprintf(str, MSG_SIZ, "%s (%d) %s %s (%d) {%d %d %s}", gameInfo.white, white_stren, _("vs."), gameInfo.black,
                 black_stren, basetime, increment, VariantName(gameInfo.variant));
            }
        }
        DisplayTitle(str);
        if (appData.debugMode) {
    ...
    if (!pausing && !appData.noGUI) {
        if (appData.premove) {
            if (!gotPremove || ((gameMode == IcsPlayingWhite) && (WhiteOnMove(currentMove))) ||
        ...
        j = seekGraphUp;
        /* [HGM] seekgraph: when we draw a board, it overwrites the seek graph. */
        seekGraphUp = FALSE;
        if (partnerUp) {
            flipView = originalFlip;
            partnerUp = FALSE;
            j = TRUE;
        }  /* [HGM] bughouse: restore view */
        ...
        if (appData.ringBellAfterMoves && /*!ics_user_moved*/  /* [HGM] use absolute method to recognize own move */
         !((gameMode == IcsPlayingWhite) && (!WhiteOnMove(moveNum)) || (gameMode == IcsPlayingBlack) && (WhiteOnMove(moveNum)))) {
            if (newMove) {
                RingBell();
            } else {
...
void SendToBoth(char * msg) {
    SendToProgram(msg, &first);
    if (second.analyzing) {
        SendToProgram(msg, &second);
    }
}

void AnalysisPeriodicEvent(int force) {
    if (((programStats.ok_to_send == 0 || programStats.line_is_book) && !force) || !appData.periodicUpdates) {
        return;
    }
    ...
    /* Don't send another until we get a response (this makes us stop sending to old Crafty's that don't understand the "." command
    (sending illegal cmds resets node count & time, which looks bad)) */
    programStats.ok_to_send = 0;
}

void ics_update_width(int new_width) { ics_printf("set width %d\n", new_width); }
...
void SendMoveToProgram(int moveNum, ChessProgramState * cps) {
    ...
    if (moveList[moveNum][1] == '@' && moveList[moveNum][0] == '@') {
        ...
        /* send position after move instead. */
        SendBoard(cps, moveNum + 1);
        return;
    }
    if (cps->useUsermove) {
    ...
    if (cps->useSAN) {
        ...
        if (cps->alphaRank) {
            /* [HGM] shogi: temporarily convert to shogi coordinates before sending */
            AlphaRank(moveList[moveNum], 4);
            SendToProgram(moveList[moveNum], cps);
            /* and back */
            AlphaRank(moveList[moveNum], 4);
        } else
            /* Added by Tord: Send castle moves in "O-O" in FRC games if required by the engine.  It would be nice to have a better
               way to identify castle moves here. */
            if (appData.fischerCastling && cps->useOOCastle) {
                ...
                if ((boards[moveNum][fromY][fromX] == WhiteKing && boards[moveNum][toY][toX] == WhiteRook) ||
                 (boards[moveNum][fromY][fromX] == BlackKing && boards[moveNum][toY][toX] == BlackRook)) {
                    if (toX > fromX) {
                        SendToProgram("O-O\n", cps);
                    } else {
                        SendToProgram("O-O-O\n", cps);
                ...
                *c = m[7];
                ...
                if (gameInfo.variant == VariantDuck) {
                    snprintf(buf, MSG_SIZ, "%c%d%c%d,%c%d%c%d%s\n", m[0], m[1] - '0',  /* convert to two moves */
                     m[2], m[3] - '0', m[2], m[3] - '0', m[5], m[6] - '0', c);
                } else if ((boards[moveNum][m[6] - ONE][m[5] - AAA] < BlackPawn) ==
                 (boards[moveNum][m[1] - ONE][m[0] - AAA] < BlackPawn)) {  /* move is kludge to indicate castling */
                    snprintf(buf, MSG_SIZ, "%c%d%c%d,%c%d%c%d\n", m[0], m[1] - '0',  /* convert to two moves */
                     m[2], m[3] - '0', m[5], m[6] - '0', m[2] + (m[0] > m[5] ? 1 : -1), m[3] - '0');
                    ...
                    *c = m[9];
                    ...
                    snprintf(buf, MSG_SIZ, "%c%d%c%d,%c%d%c%d,%c%d%c%d%s\n", m[0], m[1] - '0',  /* convert to three moves */
                     m[7], m[8] - '0', m[7], m[8] - '0', m[5], m[6] - '0', m[5], m[6] - '0', m[2], m[3] - '0', c);
                } else {
                    snprintf(buf, MSG_SIZ, "%c%d%c%d,%c%d%c%d%s\n", m[0], m[1] - '0',  /* convert to two moves */
                     m[5], m[6] - '0', m[5], m[6] - '0', m[2], m[3] - '0', c);
                }
                SendToProgram(buf, cps);
                ...
                if (moveList[moveNum][1] == '@' && (BOARD_HEIGHT < 16 || moveList[moveNum][0] <= 'Z')) {  /* drop move */
                    if (moveList[moveNum][0] == '@') {
                        snprintf(buf, MSG_SIZ, "@@@@\n");
                    } else {
                        snprintf(buf, MSG_SIZ, "%c@%c%d%s", moveList[moveNum][0], moveList[moveNum][2], moveList[moveNum][3] - '0',
                         moveList[moveNum] + 4);
                    }
                } else {
                    snprintf(buf, MSG_SIZ, "%c%d%c%d%s", moveList[moveNum][0], moveList[moveNum][1] - '0', moveList[moveNum][2],
                     moveList[moveNum][3] - '0', moveList[moveNum] + 4);
                }
                SendToProgram(buf, cps);
            } else {
                SendToProgram(moveList[moveNum], cps);
...
void SendMoveToICS(ChessMove moveType, int fromX, int fromY, int toX, int toY, char promoChar) {
    ...
    switch (moveType) {
    default:
        snprintf(user_move, MSG_SIZ, _("say Internal error; bad moveType %d (%d,%d-%d,%d)"), (int)moveType, fromX, fromY, toX, toY);
    ...
    case BlackPromotion:
        if (gameInfo.variant == VariantShatranj || gameInfo.variant == VariantCourier || gameInfo.variant == VariantMakruk) {
            snprintf(user_move, MSG_SIZ, "%c%c%c%c=%c\n", AAA + fromX, ONE + fromY, AAA + toX, ONE + toY, PieceToChar(WhiteFerz));
        } else if (gameInfo.variant == VariantGreat) {
            snprintf(user_move, MSG_SIZ, "%c%c%c%c=%c\n", AAA + fromX, ONE + fromY, AAA + toX, ONE + toY, PieceToChar(WhiteMan));
        } else {
            snprintf(user_move, MSG_SIZ, "%c%c%c%c=%c\n", AAA + fromX, ONE + fromY, AAA + toX, ONE + toY, promoChar);
        }
        break;
    case WhiteDrop:
    case BlackDrop:
drop:
        snprintf(user_move, MSG_SIZ, "%c@%c%c\n", ToUpper(PieceToChar((ChessSquare)fromX)), AAA + toX, ONE + toY);
        break;
    case IllegalMove:
        /* This could be a variant that we don't quite understand. */
        if (fromY == DROP_RANK) {
            /* TODO: Consider whether we should have an 'IllegalDrop' move type. */
            goto drop;
        }
        /* Intentionally fall through. */
    case NormalMove:
...
void UploadGameEvent(void) {  /* [HGM] upload: send entire stored game to ICS as long-algebraic moves. */
    ...
    if (gameMode != IcsExamining) {  /* is this ever not the case? */
        ...
        if (gameInfo.variant != VariantNormal) {
            ...
            for (i = 1; i <= 36; i++) {
                ...
                if (StringToVariant(buf) == gameInfo.variant) {
                    break;
                }
            }
            if (i <= 36 && ics_type == ICS_ICC) {
                snprintf(buf, MSG_SIZ, "%s w%d\n", command, i);
            } else if (i == 22) {
                snprintf(buf, MSG_SIZ, "%s fr\n", command);
            } else {
...
void CoordsToComputerAlgebraic(int rf, int ff, int rt, int ft, char promoChar, char move[9]) {
    if (rf == DROP_RANK) {
        if (ff == EmptySquare) {
            sprintf(move, "@@@@\n");
        } else {
        ...
        if (c && (c == '-' || boards[forwardMostMove][rt][ft] != EmptySquare)) {
            promoChar = '+';
        }
...
int PieceInString(char * s, ChessSquare piece) {
    char *p, ID = ToUpper(PieceToChar(piece)), suffix = PieceSuffix(piece);
    while ((p = strchr(s, ID))) {
        if (!suffix || p[1] == suffix) {
            return TRUE;
        }
        s = p;
    }
...
int Partner(ChessSquare * p) {
    ChessSquare partner = promoPartner[*p];
    if (PieceToChar(*p) != '+' && PieceToChar(partner) != '+') {
        return 0;
    }
    if (PieceToChar(*p) == '+') {
        partner = boards[currentMove][fromY][fromX];
    }
    *p = partner;
    return 1;
}
...
void Sweep(int step) {
    ...
    if (promoSweep >= BlackPawn) {
        king = WHITE_TO_BLACK king, pawn = WHITE_TO_BLACK pawn;
    }
    if (gameInfo.variant == VariantSpartan && pawn == BlackPawn) {
        pawn = BlackLance, king = EmptySquare;
    }
    if (fromY != BOARD_HEIGHT - 2 && fromY != 1 && gameInfo.variant != VariantChuChess) {
        pawn = EmptySquare;
    }
    if (!step) {
        /* piece has shogi-promotion */
        toggleFlag = Partner(&last);
    }
    do {
        if (step && !(toggleFlag && Partner(&promoSweep))) {
            promoSweep -= step;
        }
        if (promoSweep == EmptySquare) {
            /* wrap */
            promoSweep = BlackPawn;
        } else if ((int)promoSweep == -1) {
            promoSweep = WhiteKing;
        } else if (promoSweep == BlackPawn && step < 0 && !toggleFlag) {
            promoSweep = WhitePawn;
        } else if (promoSweep == WhiteKing && step > 0 && !toggleFlag) {
            promoSweep = BlackKing;
        }
        if (!step) {
            step = -1;
        }
       ...
       promoRestrict[0]
      ? !PieceInString(promoRestrict, promoSweep)
      :  /* if choice set available, use it */
      promoSweep == pawn ||
       appData.testLegality &&
        (promoSweep == king || gameInfo.variant != VariantChuChess && (promoSweep == WhiteLion || promoSweep == BlackLion)));
    if (toX >= 0) {
...
int PromoScroll(int x, int y) {
    ...
    if (promoSweep == EmptySquare || !appData.sweepSelect) {
        return FALSE;
    }
    if (abs(x - lastX) < 25 && abs(y - lastY) < 25) {
        return FALSE;
    }
    if (y > lastY + 2) {
        step = -1;
    ...
    lastX = x;
    lastY = y;
    if ((promoSweep < BlackPawn) == flipView) {
        step = -step;
    }
    if (step > 0) {
        selectFlag = 1;
...
void AlphaRank(char * move, int n) {
    if (appData.debugMode) {
        fprintf(debugFP, "alphaRank(%s,%d)\n", move, n);
    }

    if (move[1] == '*' && move[2] >= '0' && move[2] <= '9' && move[3] >= 'a' && move[3] <= 'x') {
        move[1] = '@';
        move[2] = BOARD_RGHT - 1 - (move[2] - '1') + AAA;
        move[3] = BOARD_HEIGHT - 1 - (move[3] - 'a') + ONE;
    } else if (move[0] >= '0' && move[0] <= '9' && move[1] >= 'a' && move[1] <= 'x' && move[2] >= '0' && move[2] <= '9' &&
     move[3] >= 'a' && move[3] <= 'x') {
    ...
    *moveType = yylexstr(moveNum, move, yy_textstr, sizeof yy_textstr);
    ...
    case IllegalMove: /* bug or odd chess variant */
        if (currentMoveString[1] == '@') {  /* illegal drop */
            *fromX = WhiteOnMove(moveNum) ? (int)CharToPiece(ToUpper(currentMoveString[0]))
        ...
        *promoChar = currentMoveString[4];
        if (*promoChar == ';') {
            *promoChar = currentMoveString[7 + 2 * (currentMoveString[8] != 0)];
        }
        if (*fromX < BOARD_LEFT || *fromX >= BOARD_RGHT || *fromY < 0 || *fromY >= BOARD_HEIGHT || *toX < BOARD_LEFT ||
         *toX >= BOARD_RGHT || *toY < 0 || *toY >= BOARD_HEIGHT) {
            if (appData.debugMode) {
                fprintf(
                 debugFP, "Off-board move (%d,%d)-(%d,%d)%c, type = %d\n", *fromX, *fromY, *toX, *toY, *promoChar, *moveType);
            }
    ...
    case BlackDrop:
        *fromX =
         *moveType == WhiteDrop ? (int)CharToPiece(ToUpper(currentMoveString[0])) : (int)CharToPiece(ToLower(currentMoveString[0]));
drop:
        *fromY = DROP_RANK;
        *toX = currentMoveString[2] - AAA;
        *toY = currentMoveString[3] - ONE;
...
void ParsePV(char * pv, Boolean storeComments, Boolean atEnd, int engine) {
    int fromX, fromY, toX, toY;
    char promoChar;
    ChessMove moveType;
    Boolean valid;
    ...
    lastParseAttempt = pv;
    if (!*pv) {
        /* turns out we crash when we parse an empty PV */
        return;
    }
    if ((gameMode == AnalyzeMode || gameMode == AnalyzeFile) && currentMove < forwardMostMove) {
        /* [HGM] engine might not be thinking on forwardMost position! */
        PushInner(currentMove, forwardMostMove);
        pushed = TRUE;
    }
    endPV = forwardMostMove;
    do {
        while (*pv == ' ' || *pv == '\n' || *pv == '\t') {
            /* must still read away whitespace */
            pv++;
        }
        if (nr == 0 && !storeComments && *pv == '(') {
            /* first (ponder) move can be in parentheses */
            pv++;
        }
        lastParseAttempt = pv;
        ...
        if (!valid && nr == 0) {
            if (engine == hintSrc && *lastHint && appData.ponderNextMove &&
             ParseOneMove(lastHint, endPV, &moveType, &fromX, &fromY, &toX, &toY, &promoChar)) {
                ...
                valid++;
                goto append_move;  /* use this hint as first move */
            }
            if (ParseOneMove(pv, endPV - 1, &moveType, &fromX, &fromY, &toX, &toY, &promoChar)) {
                nr++;
                /* PV was for previous position; kludge to make sure we continue */
                moveType = Comment;
                ...
                if (!CompareBoards(boards[endPV], boards[endPV + 2])) {
                    ...
                    safeStrCpy(moveList[endPV - 2], "_0_0",
                     sizeof(moveList[endPV - 2]) / sizeof(moveList[endPV - 2][0]));  /* suppress premove highlight on takeback move */
                }
            }
        }
        /* skip what we parsed */
        pv = strstr(pv, yy_textstr) + strlen(yy_textstr);
        if (nr == 0 && !storeComments && *pv == ')') {
            /* closing parenthesis of ponder move; */
            pv++;
        }
        if (moveType == Comment && storeComments) {
            AppendComment(endPV, yy_textstr, FALSE);
        }
        if (moveType == Comment || moveType == NAG || moveType == ElapsedTime) {
            /* allow comments in PV */
            valid++;
            continue;
        }
append_move:
        ...
        CoordsToAlgebraic(boards[endPV - 1], PosFlags(endPV - 1), fromY, fromX, toY, toX, promoChar, parseList[endPV - 1]);
    } while (valid);
    if (atEnd == 2) {
        /* used hidden, for PV conversion */
        return;
    }
...
int MultiPV(ChessProgramState * cps, int kind) {
    ...
    for (i = 0; i < cps->nrOptions; i++) {
        ...
        if ((kind & 1) && !StrCaseCmp(s, "MultiPV") && cps->option[i].type == Spin) {
            return i;
        }
        if ((kind & 2) && StrCaseStr(s, "multi") && StrCaseStr(s, "PV") && StrCaseStr(s, "margin") && cps->option[i].type == Spin) {
            return -i - 2;
        }
    }
    return -1;
...
/* signals to UnLoadPV() if walked part of PV has to be appended to game */
Boolean extendGame;
...
Boolean LoadMultiPV(int x, int y, char * buf, int index, int * start, int * end, int pane) {
    ...
    if (index == startPV && (p = StrCaseStr(buf + index, "PV="))) {
        startPV = p - buf + 3;
    }
    index = startPV;
    do {
    ...
    if (lineStart == 0 && gameMode == AnalyzeMode) {
        int n = 0;
        if (origIndex > 17 && origIndex < 24) {
            n--;
        } else if (origIndex > index - 6) {
            n++;
        }
        if (n == 0) {  /* click not on "fewer" or "more" */
            ...
            n += cps->option[multi].value;
            if (n < 1) {
                n = 1;
            }
            snprintf(buf2, MSG_SIZ, "option MultiPV=%d\n", n);
            if (cps->option[multi].value != n) {
...
char * PvToSAN(char * pv, int engine) {
    static char buf[10 * MSG_SIZ];
    int i, k = 0, savedEnd = endPV, saveFMM = forwardMostMove;
    *buf = NULLCHAR;
    if (forwardMostMove < endPV) {
        PushInner(forwardMostMove, endPV);  /* shelve PV of PV-walk */
    }
    ParsePV(pv, FALSE, 2, engine + 1);  /* this appends PV to game, suppressing any display of it */
    for (i = forwardMostMove; i < endPV; i++) {
        if (i & 1) {
            snprintf(buf + k, 10 * MSG_SIZ - k, "%s ", parseList[i]);
        } else {
            snprintf(buf + k, 10 * MSG_SIZ - k, "%d. %s ", i / 2 + 1, parseList[i]);
        }
        k += strlen(buf + k);
    }
    snprintf(
     buf + k, 10 * MSG_SIZ - k, "%s", lastParseAttempt);  /* if we ran into stuff that could not be parsed, print it verbatim */
    if (pushed) {
        PopInner(0);
        pushed = FALSE;
    }  /* restore game continuation shelved by ParsePV */
    if (forwardMostMove < savedEnd) {
        PopInner(0);
        forwardMostMove = saveFMM;
    }  /* PopInner would set fmm to endPV! */
    endPV = savedEnd;
    return buf;
}

Boolean LoadPV(int x, int y) {  /* called on right mouse click to load PV */
...
void UnLoadPV(void) {
    ...
    if (extendGame && currentMove > forwardMostMove) {
        ...
        if (pushed) {
            if (shiftKey && storedGames < MAX_VARIATIONS - 2) {  /* wants to start variation, and there is space */
                if (storedGames == 1) {
                    GreyRevert(FALSE);  /* we already pushed the tail, so just make it official */
                }
            } else {
                storedGames--;  /* abandon shelved tail of original game */
            }
        }
        pushed = FALSE;
    ...
    if (pushed) {
        PopInner(0);
        pushed = FALSE;
    }  /* restore shelved game continuation */
    ClearPremoveHighlights();
    DrawPosition(TRUE, boards[currentMove]);
}

void MovePV(int x, int y, int h) {  /* step through PV based on mouse coordinates (called on mouse move) */
    ...
    if (endPV < 0 && pieceSweep == EmptySquare) {
        return;  /* needed in XBoard because lastX/Y is shared :-( */
    }
    ...
    if (currentMove + step > endPV || currentMove + step < forwardMostMove) {
        step = 0;
    }
    currentMove += step;
    if (currentMove == forwardMostMove) {
...
void GetPositionNumber(void) {  /* sets global variable seed */
    int i;
...
void SetUpShuffle(Board board, int number) {
    ...
    if (((BOARD_RGHT - BOARD_LEFT) & 1) == 0) {
        ...
        for (p = (int)WhiteKing; p > (int)WhitePawn; p--) {
            if (p != (int)WhiteBishop && p != (int)WhiteFerz && p != (int)WhiteAlfil) {
                continue;
            }
    ...
    for (p = (int)WhiteKing - 2; p > (int)WhitePawn; p--) {
        ...
        while (piecesLeft[p] >= 2) {
            AddTwoPieces(board, p, 0);  /* add in pairs, for not counting permutations */
        }
        if (piecesLeft[p]) {
            AddOnePiece(board, p, 0, ANY);  /* add the odd piece */
        }
    }
    ...
    if (PosFlags(0) & F_FRC_TYPE_CASTLING) {
        ...
        while (piecesLeft[(int)WhiteKing]) {
            AddOnePiece(board, WhiteKing, 0, ANY);
        }
        while (piecesLeft[(int)WhiteUnicorn]) {
            AddOnePiece(board, WhiteUnicorn, 0, ANY);
        }
    }
    ...
    if (number >= 0) {
        appData.defaultFrcPosition %= nrOfShuffles;  /* normalize */
    }
}

int ptclen(const char * s, char * escapes) {
    int n = 0;
    if (!*escapes) {
        return strlen(s);
    }
    while (*s) {
        n += (!strchr("-*/^", *s) && !strchr(escapes, *s)) - 2 * (*s == '='), s++;
    }
    return n;
}

int SetCharTableEsc(unsigned char * table, const char * map, char * escapes)
...
/*       Basically a safe strcpy that uses the last character as King */
{
    ...
    if (map != NULL && (NrPieces = ptclen(map, escapes)) <= (int)EmptySquare && NrPieces >= 12 && !(NrPieces & 1)) {
        ...
        for (i = offs = 0; i < NrPieces / 2 - 1; i++) {
            char *p, c = 0;
            if (map[j] == '/') {
                offs = WhitePBishop - i, j++;
            }
            if (*escapes && (map[j] == '*' || map[j] == '-' || map[j] == '^')) {
                c = map[j++];
            }
            table[i + offs] = map[j++];
            if (p = strchr(escapes, map[j])) {
                j++, table[i + offs] += 64 * (p - escapes + 1);
            }
            if (c) {
                partner[i + offs] = table[i + offs], table[i + offs] = c;
            }
            if (*escapes && map[j] == '=') {
                pieceNickName[i + offs] = map[++j], j++;
            }
        }
        ...
        if (*escapes) {  /* set up promotion pairing */
            for (i = 0; i < (int)EmptySquare; i++) {
                promoPartner[i] = (i % BlackPawn < 11 ? i + 11 : i % BlackPawn < 22 ? i - 11 : i);  /* default */
            }
            ...
            for (i = 0; i < EmptySquare; i++) {  /* adjust promotion pairing */
                ...
                if (c == '^' || c == '-') {  /* has specified partner */
                    int p;
                    for (p = 0; p < EmptySquare; p++) {
                        if (table[p] == partner[i]) {
                            break;
                        }
                    }
                    if (p < EmptySquare) {
                        if (promoPartner[promoPartner[p]] == p) {
                            promoPartner[promoPartner[p]] = promoPartner[p];  /* divorce old partners */
                        }
                        if (promoPartner[promoPartner[i]] == i) {
                            promoPartner[promoPartner[i]] = promoPartner[i];
                        }
                        promoPartner[p] = i, promoPartner[i] = p;  /* and marry this couple */
                    }
                    if (c == '-') {
                        autoProm[i] = autoProm[p] = '-', c = '^';
                    }
                    if (c == '^') {
                        table[i] = '+';
                    }
...
int SetCharTable(unsigned char * table, const char * map) { return SetCharTableEsc(table, map, ""); }

void Prelude(Board board) {  /* [HGM] superchess: random selection of exo-pieces */
    int i, j, k;
    ChessSquare p;
    ...
    if (appData.pieceToCharTable != NULL) {  /* select pieces to participate from given char table */
        ...
        for (i = (int)WhiteQueen + 1, j = 0; i < (int)WhiteKing && j < 4; i++) {
            if (PieceToChar((ChessSquare)i) != '.') {
                exoPieces[j++] = (ChessSquare)i;
            }
        }
    }
    ...
    j = seed % 4;
    seed /= 4;
    p = board[0][BOARD_LEFT + j];
    board[0][BOARD_LEFT + j] = EmptySquare;
    k = PieceToNumber(p);
    board[k][BOARD_WIDTH - 1] = p;
    board[k][BOARD_WIDTH - 2]++;
    board[handSize - 1 - k][0] = WHITE_TO_BLACK p;
    board[handSize - 1 - k][1]++;
    j = seed % 3 + (seed % 3 >= j);
    seed /= 3;
    p = board[0][BOARD_LEFT + j];
    board[0][BOARD_LEFT + j] = EmptySquare;
    ...
    j = seed % 3;
    seed /= 3;
    p = board[0][BOARD_LEFT + j + 5];
    board[0][BOARD_LEFT + j + 5] = EmptySquare;
    k = PieceToNumber(p);
    board[k][BOARD_WIDTH - 1] = p;
    board[k][BOARD_WIDTH - 2]++;
    board[handSize - 1 - k][0] = WHITE_TO_BLACK p;
    ...
    j = seed % 4;
    seed /= 4;
    put(board, exoPieces[3], 0, j, ANY);
    j = seed % 3;
    seed /= 3;
    put(board, exoPieces[2], 0, j, ANY);
    j = seed % 2;
    seed /= 2;
    put(board, exoPieces[1], 0, j, ANY);
    put(board, exoPieces[0], 0, 0, ANY);
    for (i = BOARD_LEFT; i < BOARD_RGHT; i++) {
        board[BOARD_HEIGHT - 1][i] = WHITE_TO_BLACK board[0][i];
    }
}

void InitPosition(int redraw) {
    ChessSquare(*pieces)[BOARD_FILES];
    int i, j, pawnRow = 1, pieceRows = 1, overrule, oldx = gameInfo.boardWidth, oldy = gameInfo.boardHeight,
              oldh = gameInfo.holdingsWidth;
    static int oldv;

    if (appData.icsActive) {
        /* [HGM] shuffle: in ICS mode, only shuffle on ICS request */
        shuffleOpenings = appData.fischerCastling = FALSE;
    }

    /* [AS] Initialize pv info list [HGM] and game status */
    {
        /* [HGM] vari: spare saved variations */
        for (i = 0; i <= framePtr; i++) {
    ...
    if (startVariant == gameInfo.variant) {
        /* [HGM] nicks: enable nicknames in original variant */
        SetCharTable(pieceNickName, appData.pieceNickNames);
    } else {
        SetCharTable(pieceNickName, "............");
    }
    pieces = FIDEArray;
    ...
    case VariantSChess:
        ...
        gameInfo.holdingsSize = 7;
        for (i = 0; i < BOARD_FILES; i++) {
            initialPosition[VIRGIN][i] = VIRGIN_W | VIRGIN_B;
        }
        break;
    case VariantJanus:
        pieces = JanusArray;
    ...
    case VariantChu:
        ...
        nrCastlingRights = 0;
        /* SetCharTableEsc(pieceToChar,
         "P.BRQSEXOGCATHD.VMLIFN.........^T..^L......^A^H/^F^G^M.^E^X^O^I.^P.^B^R..^D^S^C^VK"
         "p.brqsexogcathd.vmlifn.........^t..^l......^a^h/^f^g^m.^e^x^o^i.^p.^b^r..^d^s^c^vk",
         SUFFIXES); */
        SetCharTableEsc(pieceToChar,
         "P.BRQSEXOG...HD..^DLI^HNV........^T..^L.C...A^AFT/^F^G^M.^E^X^O^I.^P.^B^R..M^S^C^VK"
         "p.brqsexog...hd..^dli^hnv........^t..^l.c...a^aft/^f^g^m.^e^x^o^i.^p.^b^r..m^s^c^vk",
         SUFFIXES);
        break;
    case VariantCourier:
    ...
    if (appData.NrFiles >= 0) {
        if (gameInfo.boardWidth != appData.NrFiles) {
            overrule++;
        }
    ...
    if (appData.holdingsSize >= 0) {
        ...
        /*if (i > gameInfo.boardHeight) {
            i = gameInfo.boardHeight;
        }*/
    ...
    /* seems to work in all common variants */
    pawnRow = gameInfo.boardHeight - 7;
    if (pawnRow < 1) {
        pawnRow = 1;
    }
    if (gameInfo.variant == VariantMakruk || gameInfo.variant == VariantASEAN || gameInfo.variant == VariantGrand ||
    ...
    for (j = 0; j < BOARD_WIDTH; j++) {
        ...
        int fw = (gameInfo.variant == VariantGrand || gameInfo.variant == VariantChuChess ||
         gameInfo.variant == VariantJanggi && j == BOARD_WIDTH / 2);

        if (j == BOARD_LEFT - 1 || j == BOARD_RGHT) {
            /* account holding counts in guard band */
            s = (ChessSquare)0;
        }
        for (i = 0; i < BOARD_HEIGHT; i++) {
        ...
        if (j < BOARD_LEFT || j >= BOARD_RGHT || overrule) {
            continue;
        }
        ...
        if (gameInfo.variant == VariantXiangqi || gameInfo.variant == VariantJanggi) {
            if (j & 1) {
                initialPosition[pawnRow][j] = initialPosition[BOARD_HEIGHT - pawnRow - 1][j] = EmptySquare;
        ...
        if (gameInfo.variant == VariantChu) {
            if (j == (BOARD_WIDTH - 2) / 3 || j == BOARD_WIDTH - (BOARD_WIDTH + 1) / 3) {
                initialPosition[pawnRow + 1][j] = WhiteCobra, initialPosition[BOARD_HEIGHT - pawnRow - 2][j] = BlackCobra;
            }
    ...
    if (gameInfo.variant == VariantChuChess) {
        initialPosition[0][BOARD_WIDTH / 2] = WhiteKing, initialPosition[BOARD_HEIGHT - 1][BOARD_WIDTH / 2 - 1] = BlackKing;
    }
    ...
    if (nrCastlingRights == -1) {
        /* [HGM] Build normal castling rights.  This must be done after board sizing!  This sets default castling rights from none
           to normal corners.  Variants with other castling rights must set them themselves above. */
        nrCastlingRights = 6;
    ...
    if (gameInfo.variant == VariantSChess) {
        ...
        initialPosition[1][1] = initialPosition[2][1] = initialPosition[6][BOARD_WIDTH - 2] = initialPosition[5][BOARD_WIDTH - 2] =
         1;
    }
    ...
    if (*appData.men) {
        LoadPieceDesc(appData.men);
    }

    CopyBoard(boards[0], initialPosition);

    if (oldx != gameInfo.boardWidth || oldy != gameInfo.boardHeight || oldv != gameInfo.variant || oldh != gameInfo.holdingsWidth) {
        InitDrawingSizes(-2, 0);
    }
...
void SendBoard(ChessProgramState * cps, int moveNum) {
    ...
    if (cps->useSetboard) {
        ...
        if (!cps->extendedEdit) {
            left = BOARD_LEFT, right = BOARD_RGHT;  /* only board proper */
        }
            ...
            for (j = left; j < right; j++, bp++) {
                ...
                if ((int)*bp < (int)BlackPawn) {
                    ...
                    if (message[0] == '+' || message[0] == '~') {
                        snprintf(message, MSG_SIZ, "%c%c%d+\n", PieceToChar((ChessSquare)(DEMOTED(*bp))), AAA + j, ONE + i - '0');
                    }
        ...
        for (i = BOARD_HEIGHT - 1; i >= 0; i--) {
            ...
            for (j = left; j < right; j++, bp++) {
                ...
                if (((int)*bp != (int)EmptySquare) && ((int)*bp >= (int)BlackPawn)) {
                    if (j == BOARD_LEFT - 2) {
                        snprintf(message, MSG_SIZ, "%c@%d\n", ToUpper(PieceToChar(*bp)), bp[1]);
                    } else {
                        snprintf(message, MSG_SIZ, "%c%c%d\n", ToUpper(PieceToChar(*bp)), AAA + j, ONE + i - '0');
                    }
                    if (message[0] == '+' || message[0] == '~') {
                        snprintf(message, MSG_SIZ, "%c%c%d+\n", PieceToChar((ChessSquare)(DEMOTED(*bp))), AAA + j, ONE + i - '0');
                    }
...
typedef struct {
    int ff, fr, tf, tr, pc, mark;
} Exclusion;
static Exclusion excluTab[200];
static char
 excludeMap[(BOARD_RANKS * BOARD_FILES * BOARD_RANKS * BOARD_FILES + 7) / 8];  /* [HGM] exclude: bitmap for excluced moves */

static void WriteMap(int s) {
    int j;
    for (j = 0; j < (BOARD_RANKS * BOARD_FILES * BOARD_RANKS * BOARD_FILES + 7) / 8; j++) {
        excludeMap[j] = s;
    }
...
static void UpdateExcludeHeader(int fromY, int fromX, int toY, int toX, char promoChar,
 char state) {  /* search given move in table of header moves, to know where it is listed (and add if not there), and update state */
    char buf[2 * MOVE_LEN], *p;
    Exclusion * e = excluTab;
    int i;
    for (i = 0; i < exCnt; i++) {
        if (e[i].ff == fromX && e[i].fr == fromY && e[i].tf == toX && e[i].tr == toY && e[i].pc == promoChar) {
            break;
        }
    }
    if (i == exCnt) {  /* was not in exclude list; add it */
        ...
        if (strlen(exclusionHeader + excludePtr) < strlen(buf)) {  /* no space to write move */
            if (state != exclusionHeader[19]) {
                exclusionHeader[19] = '*';  /* tail is now in mixed state */
            }
            return;  /* abort */
        }
        e[i].ff = fromX;
        ...
        e[i].mark = excludePtr++;
        for (p = buf; *p; p++) {
            exclusionHeader[excludePtr++] = *p;  /* copy move */
        }
        exCnt++;
    }
...
static int ExcludeOneMove(int fromY, int fromX, int toY, int toX, char promoChar,
 char state) {  /* include or exclude the given move, as specified by state ('+' or '-'), or toggle */
    char buf[MSG_SIZ];
    int j, k;
    ChessMove moveType;
    if ((signed char)promoChar == -1) {  /* kludge to indicate best move */
        if (!ParseOneMove(
             lastPV[0], currentMove, &moveType, &fromX, &fromY, &toX, &toY, &promoChar)) {  /* get current best move from last PV */
...
static void ExcludeClick(int index) {
    ...
    if (index < 25) {  /* none, best or tail clicked */
        if (index < 13) {  /* none: include all */
            ...
            for (i = 0; i < exCnt; i++) {
                exclusionHeader[excluTab[i].mark] = '+';  /* and moves */
            }
            ...
            if (exclusionHeader[19] == '-') {  /* tail was excluded */
                ...
                if (!j) {
                    ExcludeOneMove(0, 0, 0, 0, -1, '+');  /* if no moves were selected, keep best */
                }
            }
        } else {  /* best */
        ...
        for (i = 0; i < exCnt; i++) {
            if (i == exCnt - 1 || excluTab[i + 1].mark > index) {
...
ChessSquare DefaultPromoChoice(int white) {
    ChessSquare result;
    if (gameInfo.variant == VariantShatranj || gameInfo.variant == VariantCourier || gameInfo.variant == VariantMakruk) {
...
int HasPromotionChoice(int fromX, int fromY, int toX, int toY, char * promoChoice, int sweepSelect) {
    ...
    if (toX < BOARD_LEFT || toX >= BOARD_RGHT) {
        return FALSE;  /* move into holdings */
    }

    if (gameMode == EditPosition || gameInfo.variant == VariantXiangqi ||  /* no promotions */
     gameInfo.variant == VariantJanggi || !(fromX >= 0 && fromY >= 0 && toX >= 0 && toY >= 0)) {  /* invalid move */
        return FALSE;
    }
    ...
    if (PieceToChar(CHUPROMOTED(piece)) == '+') {
        highestPromotingPiece = WhiteKing;  /* always obey PTC table */
    }
    if (gameInfo.variant == VariantChu) {
        promotionZoneSize = (BOARD_HEIGHT - deadRanks) / 3;
        if (legal[toY][toX] == 6) {
            return FALSE;  /* no promotion if highlights deny it */
        }
        ...
        if (PieceToChar(piece) != '+' && PieceToChar(CHUPROMOTED(piece)) == '+') {
            highestPromotingPiece = piece;
        }
    } else if (gameInfo.variant == VariantMakruk || gameInfo.variant == VariantGrand || gameInfo.variant == VariantChuChess) {
        promotionZoneSize = 3;
    } else if (gameInfo.variant == VariantSChess && !gameInfo.holdingsSize) {
        promotionZoneSize = 2;
    }
    ...
    if ((int)piece >= BlackPawn) {
        ...
        if (fromY < promotionZoneSize && (gameInfo.variant == VariantChuChess || gameInfo.variant == VariantFairy)) {
            return FALSE;
        }
        highestPromotingPiece = WHITE_TO_BLACK highestPromotingPiece;
    } else {
        if (toY < BOARD_HEIGHT - deadRanks - promotionZoneSize && fromY < BOARD_HEIGHT - deadRanks - promotionZoneSize) {
            return FALSE;
        }
    ...
    if ((int)piece > highestPromotingPiece) {
        return FALSE;  /* non-promoting piece */
    }

    /* weed out mandatory Shogi promotions */
    if (gameInfo.variant == VariantShogi) {
        if (piece >= BlackPawn) {
            if (toY == 0 && piece == BlackPawn || toY == 0 && piece == BlackQueen || toY <= 1 && piece == BlackKnight) {
                *promoChoice = '+';
                return FALSE;
            }
        } else {
    ...
    if (appData.testLegality && (piece == WhitePawn || piece == BlackPawn)) {
        ...
        if (piece == WhitePawn && toY != fromY + 1) {
            return FALSE;  /* deep */
        }
        if (piece == BlackPawn && toY != fromY - 1) {
            return FALSE;  /* deep */
        }
        if (fromX != toX && gameInfo.variant == VariantShogi) {
            return FALSE;
        }
    ...
    if (gameInfo.variant == VariantShatranj || gameInfo.variant == VariantCourier || gameInfo.variant == VariantMakruk) {
        ...
        if (!*engineVariant) {
            return FALSE;  /* if used as parent variant there might be promotion choice */
        }
    }
    ...
    *promoChoice = ToLower(PieceToChar(defaultPromoChoice));
    ...
    if (IS_SHOGI(gameInfo.variant)) {
        *promoChoice = (defaultPromoChoice == piece && sweepSelect ? '=' : '+');  /* obsolete? */
    } else if (Partner(&partner)) {
        *promoChoice = (defaultPromoChoice == piece && sweepSelect ? NULLCHAR : '+');
    }
    if (sweepSelect && gameInfo.variant != VariantGreat && gameInfo.variant != VariantGrand && gameInfo.variant != VariantSuper) {
        return FALSE;
    }
    if (autoQueen) {
        return FALSE;  /* predetermined */
    }

    /* suppress promotion popup on illegal moves that are not premoves */
    premove = gameMode == IcsPlayingWhite && !WhiteOnMove(currentMove) || gameMode == IcsPlayingBlack && WhiteOnMove(currentMove);
    if (appData.testLegality && !premove) {
        moveType = LegalityTest(boards[currentMove], PosFlags(currentMove), fromY, fromX, toY, toX,
         IS_SHOGI(gameInfo.variant) || gameInfo.variant == VariantChuChess ? '+' : NULLCHAR);
        if (moveType == IllegalMove) {
            *promoChoice = NULLCHAR;  /* could be the fact we promoted was illegal */
        }
...
int InPalace(int row, int column) { /* [HGM] for Xiangqi */
    if ((row < 3 || row > BOARD_HEIGHT - 4) && column < (BOARD_WIDTH + 4) / 2 && column > (BOARD_WIDTH - 5) / 2) {
        return TRUE;
    }
    return FALSE;
}
...
int PieceForSquare(int x, int y) {
    ...
    if (x == BOARD_RGHT + 1 && handOffsets & 1) {
        y += handSize - BOARD_HEIGHT;
    }
    if (x == BOARD_LEFT - 2 && !(handOffsets & 2)) {
        y += handSize - BOARD_HEIGHT;
    }
    return boards[currentMove][y][x];
}

ChessSquare More(Board board, int col, int start, int end) {
    int k;
    for (k = start; k < end; k++) {
        if (board[k][col]) {
            return (col == 1 ? WhiteMonarch : BlackMonarch);  /* arrow image */
        }
    }
    return EmptySquare;
}

void DrawPosition(int repaint, Board board) {
    ...
    if (handSize > BOARD_HEIGHT && board) {
        ...
        if (handOffsets & 1) {
            ...
            compactedBoard[BOARD_HEIGHT - 1][BOARD_WIDTH - 1] = More(board, BOARD_WIDTH - 2, BOARD_HEIGHT - 1, handSize);
        }
        if (!(handOffsets & 2)) {
            for (k = 0; k < BOARD_HEIGHT; k++) {
            ...
            compactedBoard[BOARD_HEIGHT - 1][0] = More(board, 1, BOARD_HEIGHT - 1, handSize);
        }
        DrawPositionX(TRUE, compactedBoard);
    } else {
        DrawPositionX(repaint, board);
    }
}
...
int OKToStartUserMove(int x, int y) {
    ...
    /* [HGM] can be > King! */
    white_piece = (int)from_piece >= (int)WhitePawn && (int)from_piece < (int)BlackPawn;
    ...
    case PlayFromGameFile:
        if (!shiftKey || !appData.variations) {
            /* [HGM] allow starting variation in this mode */
            return FALSE;
        }
        /* Intentionally fall through. */
    case EditGame:
    ...
    if (currentMove != forwardMostMove && gameMode != AnalyzeMode && gameMode != EditGame  /* [HGM] vari: treat as AnalyzeMode */
...
Boolean OnlyMove(int * x, int * y, Boolean captures) {
    DisambiguateClosure cl;
    if (appData.zippyPlay || !appData.testLegality) {
        return FALSE;
    }
    switch (gameMode) {
    case MachinePlaysBlack:
    ...
    if (cl.kind == NormalMove || cl.kind == AmbiguousMove && captures && cl.captures == 1 || cl.kind == WhitePromotion ||
     cl.kind == BlackPromotion || cl.kind == WhiteCapturesEnPassant || cl.kind == BlackCapturesEnPassant) {
        fromX = cl.ff;
        fromY = cl.rf;
        *x = cl.ft;
        *y = cl.rt;
...
void UserMoveEvent(int fromX, int fromY, int toX, int toY, int promoChar) {
    ...
    /* Check if the user is playing in turn.  This is complicated because we let the user "pick up" a piece before it is his turn.
    So the piece he tried to pick up may have been captured by the time he puts it down!  Therefore we use the color the user is
    supposed to be playing in this test, not the color of the piece that is currently on the starting square---except in EditGame
    mode, where the user is playing both sides; fortunately there the capture race can't happen.  (It can now happen in IcsExamining
    mode, but that's just too bad.  The user will get a somewhat confusing message in that case.) */
    ...
    case Training:
        if (fromY == DROP_RANK) {
            /* [HGM] drop moves (entered through move type-in) are automatically assigned to side-to-move */
            break;
        }
        if ((int)pup >= (int)BlackPawn && (int)pup < (int)EmptySquare) {
            /* User is moving for Black */
            if (WhiteOnMove(currentMove)) {
                DisplayMoveError(_("It is White's turn"));
                return;
    ...
    case IcsPlayingBlack:
        ...
        if (WhiteOnMove(currentMove)) {
            ...
            /* [HGM] repair animation damage done by premove (in particular emptying from-square) */
            DrawPosition(TRUE, boards[currentMove]);
            return;
        }
        break;
    ...
    case EditPosition:
        /* EditPosition, empty square, or different color piece; click-click move is possible */
        if (toX == -2 || toY == -2) {
            ...
            if (toX == fromX && toY == fromY && boards[0][rf][ff] != EmptySquare) {
                ...
                if (PieceToChar(p) == '+') {
                    gatingPiece = CHUDEMOTED(p);
                } else if (PieceToChar(CHUPROMOTED(p)) == '+') {
                    gatingPiece = CHUPROMOTED(p);
                } else if (p == WhiteKing || p == BlackKing || p == WhiteRook || p == BlackRook || p == WhitePawn
                 ||  p == BlackPawn) {
                    /* toggle virginity of K or R */
                    int n = rightsBoard[toY][toX] ^= 1;
                    DisplayMessage("", n ? _("rights granted") : _("rights revoked"));
                    gatingPiece = p;
                }
            } else {
                /* revoke rights on moving */
                rightsBoard[toY][toX] = 0;
            }
            boards[0][toY][toX] = boards[0][fromY][fromX];
            if (fromX == BOARD_LEFT - 2) {
                /* handle 'moves' out of holdings */
                if (boards[0][fromY][0] != EmptySquare) {
                    if (boards[0][fromY][1]) {
                        boards[0][fromY][1]--;
                    }
                    if (boards[0][fromY][1] == 0) {
                        boards[0][fromY][0] = EmptySquare;
                    }
                }
            } else if (fromX == BOARD_RGHT + 1) {
                if (boards[0][fromY][BOARD_WIDTH - 1] != EmptySquare) {
                    if (boards[0][fromY][BOARD_WIDTH - 2]) {
                        boards[0][fromY][BOARD_WIDTH - 2]--;
                    }
                    if (boards[0][fromY][BOARD_WIDTH - 2] == 0) {
                        boards[0][fromY][BOARD_WIDTH - 1] = EmptySquare;
                    }
                }
            } else if (gameInfo.variant == VariantSChess && !gameInfo.holdingsSize && gatingPiece == EmptySquare &&
             (fromY == 0 || fromY == BOARD_HEIGHT - 1)) {
                /* empty on gating rank -> dark */
                boards[0][fromY][fromX] = DarkSquare;
            } else {
    ...
    if ((toX < 0 || toY < 0) && (fromY != DROP_RANK || fromX != EmptySquare)) {
        return;
    }
    ...
    if ((fromX == BOARD_LEFT - 2 || fromX == BOARD_RGHT + 1) && fromY != DROP_RANK) {
        ...
        if (appData.debugMode) {
            fprintf(debugFP, "Drop move %d, curr=%d, x=%d,y=%d, p=%d\n", moveType, currentMove, fromX, fromY,
             boards[currentMove][fromY][fromX]);
        }
        /* Holdings might not be sent yet in ICS play; we have to figure out which piece belongs here. */
        if (fromX == 0) {
            /* black holdings upside-down */
            fromY = handSize - 1 - fromY;
        }
        /* first piece type in selected holdings */
        fromX = fromX ? WhitePawn : BlackPawn;
        while (
         PieceToChar(fromX) == '.' || PieceToChar(fromX) == '+' || PieceToNumber(fromX) != fromY && fromX != (int)EmptySquare) {
            fromX++;
        }
        fromY = DROP_RANK;
        if (autoProm[fromX] && shiftKey) {
            fromX = CHUPROMOTED(fromX);
        }
    }

    /* [HGM] always test for legality, to get promotion info */
    moveType = LegalityTest(boards[currentMove], PosFlags(currentMove), fromY, fromX, toY, toX, promoChar);

    if (fromY == DROP_RANK && fromX == EmptySquare &&
     (gameMode == AnalyzeMode || gameMode == EditGame || PosFlags(0) & F_NULL_MOVE)) {
        moveType = NormalMove;
    }

    if (moveType == IllegalMove && legal[toY][toX] > 1) {
        /* someone explicitly told us this move is legal */
        moveType = NormalMove;
    }
    ...
    if (doubleClick && gameMode == AnalyzeMode) {
        /* [HGM] exclude: move entered with double-click on from square is for exclusion, not playing */
        if (ExcludeOneMove(fromY, fromX, toY, toX, promoChar, '*')) {
            ClearPremoveHighlights();
        } else {
            /* exclusion indicated by premove highlights */
            ClearHighlights(), SetPremoveHighlights(ff, rf, ft, rt);
        }
        DrawPosition(FALSE, NULL);
        return;
    }

    /* adding moves to book */
    if (addToBookFlag) {
        ...
        if (killX >= 0) {
            snprintf(move, MSG_SIZ, "%c%dx%c%d-%c%d%c", fromX + AAA, fromY + ONE - '0', killX + AAA, killY + ONE - '0', toX + AAA,
             toY + ONE - '0', promoChar);
        }
    ...
    if (gameInfo.variant == VariantSChess && !gameInfo.holdingsSize && !promoChar) {
        ...
        if (file >= 0 && (piece = boards[currentMove][rank][file]) != DarkSquare) {
            /* castling that should have gated at Rook */
            promoChar = ToLower(PieceToChar(piece));
        }
    }

    if (moveType == Swap && killX < 0) {
        killX = fromX, killY = fromY, moveType = NormalMove;
    }
    FinishMove(moveType, fromX, fromY, toX, toY, promoChar);
}

/* Common tail of UserMoveEvent and DropMenuEvent */
int FinishMove(ChessMove moveType, int fromX, int fromY, int toX, int toY, int promoChar) {
    char * bookHit = 0;
    ...
    if ((gameInfo.variant == VariantSuper || gameInfo.variant == VariantGreat || gameInfo.variant == VariantGrand) &&
     promoChar != NULLCHAR) {
        ...
        if (WhiteOnMove(currentMove)) {
            ...
            if (!boards[currentMove][handSize - 1 - k][1]) {
                return 0;
            }
        }
    }
    ...
    if ((gameMode == AnalyzeMode || gameMode == EditGame || gameMode == PlayFromGameFile && appData.variations && shiftKey) &&
     currentMove < forwardMostMove) {
        if (appData.variations && shiftKey) {
    ...
    if (gameInfo.variant == VariantDuck) {
        if (doDuck < 0) {  /* Duck move not yet indicated */
            ...
            duckX = fromX;
            duckY = fromY;
            doDuck = promoChar;  /* remember promotion */
            return 1;
        }
    }
    ...
    if (appData.icsActive) {
        if (gameMode == IcsPlayingWhite || gameMode == IcsPlayingBlack || gameMode == IcsExamining) {
        ...
        if (first.sendTime && (gameMode == BeginningOfGame || gameMode == MachinePlaysWhite || gameMode == MachinePlaysBlack)) {
        ...
        if (gameMode != EditGame && gameMode != PlayFromGameFile && gameMode != AnalyzeMode) {
            ...
            if (second.analyzing) {
                SendMoveToProgram(forwardMostMove - 1, &second);
            }
        }
...
void MarkByFEN(char * fen) {
    ...
    for (r = 0; r < BOARD_HEIGHT; r++) {
        for (f = BOARD_LEFT; f < BOARD_RGHT; f++) {
            legal[r][f] = marker[r][f] = 0;
        }
    }
    r = BOARD_HEIGHT - 1 - deadRanks;
    f = BOARD_LEFT;
    while (*fen) {
        int s = 0;
        if (*fen == 'M') {
            legal[r][f] = 2;
        } else  /* request promotion choice */
            if (*fen == 'B') {
                legal[r][f] = 4;
            } else  /* request auto-promotion to victim */
                if (*fen >= 'A' && *fen <= 'Z') {
                    legal[r][f] = 6;
                } else if (*fen >= 'a' && *fen <= 'z') {
                    *fen += 'A' - 'a';
...
void Mark(Board board, int flags, ChessMove kind, int rf, int ff, int rt, int ft, void * closure) {
    typedef char Markers[BOARD_RANKS][BOARD_FILES];
    Markers * m = (Markers *)closure;
    if (rf == fromY && ff == fromX &&
     (killX < 0     ? !(rt == rf && ft == ff) && legNr & 1
       : kill2X < 0 ? rt == killY && ft == killX || legNr & 2
                    : rt == killY && ft == killX || legNr & 4)) {
        (*m)[rt][ft] = 1 + (board[rt][ft] != EmptySquare || kind == WhiteCapturesEnPassant || kind == BlackCapturesEnPassant),
        legal[rt][ft] = 3;
        if (kind == FirstLeg && (killX < 0 & legNr || legNr & 2 && kill2X < 0)) {
            (*m)[rt][ft] = 5;
        }
    } else if (flags & F_MANDATORY_CAPTURE && board[rt][ft] != EmptySquare) {
        (*m)[rt][ft] = 3, legal[rt][ft] = 3;
    }
}

static int hoverSavedValid;

void MarkTargetSquares(int clear) {
    int x, y, sum = 0;
    if (clear) {  /* no reason to ever suppress clearing */
        for (x = 0; x < BOARD_WIDTH; x++) {
            for (y = 0; y < BOARD_HEIGHT; y++) {
                sum += marker[y][x], marker[y][x] = 0;
            }
        }
        hoverSavedValid = 0;
        if (!sum || clear < 0) {
            return;  /* nothing was cleared,no redraw needed */
        }
    } else {
        int capt = 0;
...
int Explode(Board board, int fromX, int fromY, int toX, int toY) {
    if (gameInfo.variant == VariantAtomic &&
     (board[toY][toX] != EmptySquare ||  /* capture? */
      toX != fromX &&
       (board[fromY][fromX] == WhitePawn ||  /* e.p. ? */
...
int CanPromote(ChessSquare piece, int y) {
    ...
    if (gameMode == EditPosition) {
        return FALSE;  /* no promotions when editing position */
    }
    /* some variants have fixed promotion piece, no promotion at all, or another selection mechanism */
    if (gameInfo.variant == VariantSChess && !gameInfo.holdingsSize) {
        zone = 2;
    }
    if (IS_SHOGI(gameInfo.variant) || gameInfo.variant == VariantXiangqi || gameInfo.variant == VariantJanggi ||
     gameInfo.variant == VariantSuper || gameInfo.variant == VariantGreat ||
     (gameInfo.variant == VariantShatranj || gameInfo.variant == VariantCourier || gameInfo.variant == VariantMakruk) &&
      !*engineVariant) {
        return FALSE;
    }
    return (piece == BlackPawn && y <= zone || piece == WhitePawn && y >= BOARD_HEIGHT - 1 - deadRanks - zone ||
     piece == BlackLance && y <= zone || piece == WhiteLance && y >= BOARD_HEIGHT - 1 - deadRanks - zone);
}

void HoverEvent(int xPix, int yPix, int x, int y) {
    static int oldX = -1, oldY = -1, oldFromX = -1, oldFromY = -1;
    int r, f;
    if (!first.highlight) {
        return;
    }
    if (fromX != oldFromX || fromY != oldFromY) {
        oldX = oldY = -1;  /* kludge to fake entry on from-click */
    }
    if (x == oldX && y == oldY) {
        return;  /* only do something if we enter new square */
    }
    oldFromX = fromX;
    oldFromY = fromY;
...
void ReportClick(char * action, int x, int y) {
    ...
    if (!first.highlight || gameMode == EditPosition) {
        return;
    }
...
void LeftClick(ClickType clickType, int xPix, int yPix) {
    ...
    if (!deferChoice) {  /* when called for a retry, skip everything to the point where we left off */
        ...
        if (clickType == Press && doDuck >= 0) {  /* extra click for Duck placement */
            if (boards[currentMove][y][x] != EmptySquare && (x != duckX || y != duckY)) {
                return;  /* ignore clicks on occupied square */
            }
            killX = x;
            killY = y;
            appData.animate = FALSE;
         ...
         (boards[currentMove][y][x] == EmptySquare || x == createX && y == createY)) {  /* placement click */
            if (clickType == Press) {
                ...
                if (newType != EmptySquare) {
                    ...
                    } while (PieceToChar(newType) == '.');
                } else {
                    newType = selectedType;
                }
                EditPositionMenuEvent(newType, x, y);
                createX = x;
                createY = y;  /* remember where we last dropped */
            }
            return;
        }
        ...
        if (SeekGraphClick(clickType, xPix, yPix, 0)) {
            return;
        }

        prevClickTime = lastClickTime;
        GetTimeMark(&lastClickTime);
        ...
        if (promoSweep != EmptySquare) {  /* up-click during sweep-select of promo-piece */
            ...
            if (!selectFlag && !sweepSelecting && (x != toX || y != toY)) {
                x = fromX, y = fromY;  /* and fake up-click on same square if we were still selecting */
            }
        }

        if (promotionChoice) {  /* we are waiting for a click to indicate promotion piece */
            if (clickType == Release) {
                return;  /* ignore upclick of click-click destination */
            }
            promotionChoice = FALSE;  /* only one chance: if click not OK it is interpreted as cancel */
            if (appData.debugMode) {
                fprintf(debugFP, "promotion click, x=%d, y=%d\n", x, y);
            }
            if (gameInfo.holdingsWidth &&
             (WhiteOnMove(currentMove) ? x == BOARD_WIDTH - 1 && y < gameInfo.holdingsSize && y >= 0
                                       : x == 0 && y >= BOARD_HEIGHT - gameInfo.holdingsSize && y < BOARD_HEIGHT)) {
                /* click in right holdings, for determining promotion piece */
                ChessSquare p = boards[currentMove][y][x];
                if (appData.debugMode) {
                    fprintf(debugFP, "square contains %d\n", (int)p);
                }
                if (p == WhitePawn || p == BlackPawn) {
                    p = EmptySquare;  /* [HGM] Pawns could be valid as deferral */
                }
                if (p != EmptySquare ||
                 gameInfo.variant == VariantGrand && toY != 0 &&
                  toY != BOARD_HEIGHT - 1) {  /* [HGM] grand: empty square means defer */
        ...
        if (clickType == Press &&
         (x == BOARD_LEFT - 1 || x == BOARD_RGHT || x == BOARD_LEFT - 2 && y < BOARD_HEIGHT - gameInfo.holdingsSize ||
        ...
        if (clickType == Press && fromX == x && fromY == y && promoDefaultAltered &&
         SubtractTimeMarks(&lastClickTime, &prevClickTime) >= 200) {
        ...
        if (fromX == -1) {
            ...
            if (gameMode == AnalyzeMode && (pausing || controlKey) && first.excludeMoves) {  /* use pause state to exclude moves */
                doubleClick = TRUE;
                gatingPiece = boards[currentMove][y][x];
            }
            fromX = x;
            fromY = y;
            toX = toY = killX = killY = kill2X = kill2Y = -1;
            safeStrCpy(promoRestrict, defaultChoice, MSG_SIZ);
            if (!appData.oneClick || !OnlyMove(&x, &y, FALSE) ||
             ...
             appData.sweepSelect && CanPromote(boards[currentMove][fromY][fromX], fromY) && originalY != y) {
                ...
                if (OKToStartUserMove(fromX, fromY)) {
                    ...
                    MarkTargetSquares(0);
                    if (gameMode == EditPosition && controlKey) {
        ...
        if (clickType == Press && gameMode != EditPosition) {
            ...
            if ((killX < 0 || x != fromX || y != fromY) &&  /* [HGM] lion: do not interpret igui as deselect! */
             ...
             ((WhitePawn <= fromP && fromP <= WhiteKing && WhitePawn <= toP && toP <= WhiteKing &&
               !(fromP == WhiteKing && toP == WhiteRook && frc) && !(fromP == WhiteRook && toP == WhiteKing && frc)) ||
              (BlackPawn <= fromP && fromP <= BlackKing && BlackPawn <= toP && toP <= BlackKing &&
               ...
               !(fromP == BlackKing && toP == BlackRook && frc)))) {
                    ...
                    if (OKToStartUserMove(x, y)) {
                        if (gameInfo.variant == VariantSChess &&  /* S-Chess: back-rank piece selected after holdings means gating */
                         ...
                         y == (toP < BlackPawn ? 0 : BOARD_HEIGHT - 1)) {
                            ...
                            gatingPiece = doubleClick ? fromP : EmptySquare;
                        }
                        fromX = x;
                        fromY = y;
                        dragging = 1;
                ...
                if (x == fromX && y == fromY) {
                    return;  /* if OnlyMove altered (x,y) we go on */
                }
                second = FALSE;
            }
        ...
        if (x == fromX && y == fromY && clickType == Press && gameMode == EditPosition &&
         SubtractTimeMarks(&lastClickTime, &prevClickTime) < 200) {
        ...
        if (gameMode != EditPosition && !appData.testLegality && !legal[y][x] && fromX >= BOARD_LEFT && fromX < BOARD_RGHT &&
         (x != killX || y != killY) && !sweepSelecting) {
            if (dragging) {
        ...
        if (clickType == Press) {
            if (gameInfo.variant == VariantChuChess && piece != WhitePawn && piece != BlackPawn) {
                defaultPromoChoice = piece;
            }
            if (gameMode == EditPosition && boards[currentMove][fromY][fromX] == EmptySquare) {
                ...
                fromY = y;
                DragPieceBegin(xPix, yPix, FALSE);
                dragging = 1;  /* consider this a new attempt to drag */
                if (x >= BOARD_LEFT && x < BOARD_RGHT) {
                    clearFlag = 1;  /* and defer click-click move of empty-square to up-click */
                }
                return;
            }
            ...
            if (x == killX && y == killY) {  /* second click on this square, which was selected as first-leg target */
                killX = kill2X;
                killY = kill2Y;
                kill2X = kill2Y = -1;  /* this informs us no second leg is coming, so treat as to-click without intermediate */
            } else if (marker[y][x] == 5) {
                return;  /* [HGM] lion: to-click on cyan square; defer action to release */
            }
            if (legal[y][x] == 2 || HasPromotionChoice(fromX, fromY, toX, toY, &promoChoice, FALSE)) {
                if (appData.sweepSelect) {
                    promoSweep = defaultPromoChoice;
                    if (gameInfo.variant != VariantChuChess && PieceToChar(CHUPROMOTED(piece)) == '+') {
                        promoSweep = CHUPROMOTED(piece);
                    }
                    selectFlag = 0;
                    lastX = xPix;
                    lastY = yPix;
                    ReportClick("put", x, y);  /* extra put to prompt engine for 'choice' command */
                    saveFlash = appData.flashCount;
                    appData.flashCount = 0;
                    Sweep(0);  /* Pawn that is going to promote: preview promotion piece */
                    sweepSelecting = 1;
                    DisplayMessage("", _("Pull pawn backwards to under-promote"));
                    MarkTargetSquares(1);
            ...
            sweepSelecting = 0;
            appData.animate = FALSE;  /* do not animate, a selected piece already on to-square */
            safeStrCpy(promoRestrict, defaultChoice, MSG_SIZ);
            appData.flashCount = saveFlash;
            if (appData.animate || appData.highlightLastMove) {
                SetHighlights(fromX, fromY, toX, toY);
            } else {
                ClearHighlights();
...
/* [HGM] this must be done after the move is made, as with arrow it could lead to a board redraw with piece still on from square */
	...
	if (appData.highlightLastMove) {
	    ...
	    ClearHighlights();
            ...
            if (marker[y][x] == 5) {  /* [HGM] lion: this was the release of a to-click or drag on a cyan square */
                ...
                MarkTargetSquares(1);
                if (x == killX && y == killY) {
                    killX = kill2X, killY = kill2Y, kill2X = kill2Y = -1;  /* cancel last kill */
                } else {
                    kill2X = killX;
                    kill2Y = killY;
                    killX = x;
                    killY = y;  /* remember this square as intermediate */
        ...
        if (x >= 0 && x < BOARD_LEFT || x >= BOARD_RGHT) {
            ...
            if (gameMode == EditPosition && piece != EmptySquare && fromX >= BOARD_LEFT && fromX < BOARD_RGHT) {
                int n;
                ...
                } else if (x == BOARD_RGHT + 1 && piece < BlackPawn) {
        ...
        if (gatingPiece != EmptySquare && gameInfo.variant == VariantSChess) {
            promoChoice = ToLower(PieceToChar(gatingPiece));
        }
    }

    if (legal[toY][toX] == 2) {  /* highlight-induced promotion */
        if (piece == defaultPromoChoice) {
            promoChoice = NULLCHAR;  /* deferral */
        } else {
            promoChoice = ToLower(PieceToChar(defaultPromoChoice));
        }
    ...
    if (legal[toY][toX] == 2 && !appData.sweepSelect ||
     HasPromotionChoice(fromX, fromY, toX, toY, &promoChoice, appData.sweepSelect)) {
        SetHighlights(fromX, fromY, toX, toY);
        MarkTargetSquares(1);
        if (gameInfo.variant == VariantSuper || gameInfo.variant == VariantGreat || gameInfo.variant == VariantGrand) {
        ...
        if (gotPremove) {
            SetPremoveHighlights(fromX, fromY, toX, toY), DrawPosition(FALSE, NULL);
        }
...
int RightClick(ClickType action, int x, int y, int * fromX, int * fromY) {
    ...
    if (seekGraphUp) {
        /* [HGM] seekgraph */
        if (action == Press) {
            /* 2 indicates right-click: no pop-down on miss */
            SeekGraphClick(Press, x, y, 2);
        }
        if (action == Release) {
            /* and no challenge on hit */
            SeekGraphClick(Release, x, y, 2);
        }
        return -2;
    }

    if ((gameMode == IcsPlayingWhite || gameMode == IcsPlayingBlack) && !appData.zippyPlay &&
     appData.bgObserve) {
        /* [HGM] bughouse: show background game */
        if (!partnerBoardValid) {
            /* suppress display of uninitialized boards */
            return -2;
        }
        if (appData.dualBoard) {
            /* [HGM] dual: is already displayed */
            return -2;
        }
        if (action == Press) {
    ...
    if (action != Press) {
        /* return code to be ignored */
        return -2;
    }
    switch (gameMode) {
    case IcsExamining:
        if (xSqr < BOARD_LEFT || xSqr >= BOARD_RGHT) {
            return -1;
        }
        /* Intentionally fall through. */
    case EditPosition:
        if (xSqr == BOARD_LEFT - 1 || xSqr == BOARD_RGHT) {
            return -1;
        }
        if (xSqr < 0 || ySqr < 0) {
            return -1;
        ...
        if (appData.pieceMenu) {
            /* select click */
            ChessSquare newType = boards[currentMove][ySqr][xSqr];
            boards[currentMove][ySqr][xSqr] = EmptySquare;
            if (newType == EmptySquare && selectedType == EmptySquare) {
                /* click on empty summons context menu if not deselect */
            ...
            Deselect();
            if (selectedType == EmptySquare) {
                DisplayMessage("", "");
            } else {
                char buf[MSG_SIZ];
                snprintf(buf, MSG_SIZ, "left-click places %s %c", newType < BlackPawn ? _("white") : _("black"),
                 ToUpper(PieceToChar(newType)));
                DisplayMessage("", buf);
            }
            DrawPosition(FALSE, boards[currentMove]);
            return -2;
        ...
        if (xSqr == createX && ySqr == createY && xSqr != BOARD_LEFT - 2 && xSqr != BOARD_RGHT + 1) {
            ...
            boards[currentMove][ySqr][xSqr] = p;
            DrawPosition(FALSE, boards[currentMove]);
            return -2;
        }
        /* [HGM] sweep: prepare selecting piece by mouse sweep */
        pieceSweep = shiftKey ? BlackPawn : WhitePawn;
        createX = toX = xSqr;
        createY = toY = ySqr;
        lastX = x, lastY = y;
        NextPiece(0);
    ...
    case MachinePlaysBlack:
    case TwoMachinesPlay:
        /* [HGM] pv: use for showing PV */
        if (!appData.dropMenu) {
            LoadPV(x, y);
            /* flag front-end to grab mouse events */
            return 2;
        }
        if (gameMode == TwoMachinesPlay || gameMode == AnalyzeMode || gameMode == AnalyzeFile || gameMode == IcsObserving) {
            return -1;
        }
        /* Intentionally fall through. */
    case EditGame:
noZip:
        ...
        if (!appData.dropMenu ||
         appData.testLegality && gameInfo.variant != VariantBughouse && gameInfo.variant != VariantCrazyhouse) {
            return -1;
        }
        /* drop menu */
        whichMenu = 1;
...
void Wheel(int dir, int x, int y) {
    if (gameMode == EditPosition) {
        ...
        if (ySqr < 0 || xSqr < BOARD_LEFT || xSqr >= BOARD_RGHT) {
            return;
        }
        if (flipView) {
            xSqr = BOARD_WIDTH - 1 - xSqr;
        ...
        do {
            ...
            if ((int)boards[currentMove][ySqr][xSqr] < WhitePawn) {
                boards[currentMove][ySqr][xSqr] = BlackKing;
            }
            if ((int)boards[currentMove][ySqr][xSqr] > BlackKing) {
                boards[currentMove][ySqr][xSqr] = WhitePawn;
            }
...
void SendProgramStatsToFrontend(ChessProgramState * cps, ChessProgramStats * cpstats) {
    ...
    if (stats.pv && stats.pv[0]) {
        safeStrCpy(lastPV[stats.which], stats.pv,
         sizeof(lastPV[stats.which]) / sizeof(lastPV[stats.which][0]));  /* [HGM] pv: remember last PV of each */
    }

    if (gameMode == AnalyzeMode && stats.pv && stats.pv[0] && appData.analysisBell && stats.time >= 100 * appData.analysisBell) {
        RingBell();
    }
...
void ClearEngineOutputPane(int which) {
...
char * TourneyStandings(int display) {
    ...
    if (appData.tourneyType < 0 && !strchr(appData.results, '*')) {
        /* standings of Swiss yet TODO */
        return strdup(_("Swiss tourney finished"));
    }
    ...
    if (appData.tourneyType > 0) {
        /* in gauntlet, list only gauntlet engine(s) */
        nPlayers = appData.tourneyType;
    }
...
void Count(Board board, int pCnt[], int * nW, int * nB, int * wStale, int * bStale, int * bishopColor) {  /* count all piece types */
    int p, f, r;
    *nB = *nW = *wStale = *bStale = *bishopColor = 0;
    ...
    for (r = 0; r < BOARD_HEIGHT; r++) {
        for (f = BOARD_LEFT; f < BOARD_RGHT; f++) {
            p = board[r][f];
            pCnt[p]++;
            if (p == WhitePawn && r == BOARD_HEIGHT - 1) {
                (*wStale)++;
            } else if (p == BlackPawn && r == 0) {
                (*bStale)++;  /* count last-Rank Pawns (XQ) separately */
            }
            if (p <= WhiteKing) {
                (*nW)++;
            } else if (p <= BlackKing) {
            ...
            if (p == WhiteBishop || p == WhiteFerz || p == WhiteAlfil || p == BlackBishop || p == BlackFerz || p == BlackAlfil) {
...
int SufficientDefence(int pCnt[], int side, int nMine, int nHis) {
    ...
    if (nMine - myPawns > 2) {
        return FALSE;  /* no trivial draws with more than 1 major */
    }
    ...
    if (pCnt[WhiteCannon + side]) {
        if (pCnt[WhiteFerz + side] + myPawns == 0) {
            return TRUE;  /* Cannon needs platform */
        }
...
int MatingPotential(int pCnt[], int side, int nMine, int nHis, int stale, int bisColor) {
    VariantClass v = gameInfo.variant;

    if (v == VariantShogi || v == VariantCrazyhouse || v == VariantBughouse) {
        return TRUE;  /* drop games always winnable */
    }
    if (v == VariantShatranj) {
        return TRUE;  /* always winnable through baring */
    }
    if (v == VariantLosers || v == VariantSuicide || v == VariantGiveaway) {
        return TRUE;
    }
    if (v == Variant3Check || v == VariantAtomic) {
        return nMine > 1;  /* can win through checking / exploding King */
    }
    ...
    if (v == VariantXiangqi) {
        ...
        if (nMine + stale == 1) {
            return (pCnt[BlackFerz - side] > 1 && pCnt[BlackKnight - side] > 0);  /* bare K can stalemate KHAA (!) */
        }
        if (nMine > 2) {
            return TRUE;  /* if we don't have P, H or R, we must have CC */
        }
        if (nMine == 2 && pCnt[WhiteCannon + side] == 0) {
            return TRUE;  /* We have at least one P, H or R */
        }
        ...
        if (stale) {  /* we have at least one last-rank P plus perhaps C */
            ...
            return pCnt[WhiteFerz + side]  /* KCAK */
             || pCnt[WhiteAlfil + side] &&
             pCnt[BlackRook - side] + pCnt[BlackCannon - side] + pCnt[BlackFerz - side]  /* KCEKA, KCEKX (X!=H) */
             || majors + (12 * pCnt[BlackFerz - side] | 6 * pCnt[BlackAlfil - side]) >
             16;  /* KCKAA, KCKAX, KCKEEX, KCKEXX (XX!=HH), KCKXXX */
        }
        ...
        if (nMine == 2 && nHis == 1 && pCnt[WhiteBishop + side] + pCnt[WhiteFerz + side] + pCnt[WhiteKnight + side]) {
            return FALSE;  /* KBK is only draw */
        }
        ...
        if (nMine == 1) {
            return FALSE;  /* bare King */
        }
        if (nBishops && bisColor == 3) {
            return TRUE;  /* There must be a second B/A/F, which can either block (his) or attack (mine) the escape square */
        }
        nMine += (nBishops > 0) - nBishops;  /* By now all Bishops (and Ferz) on like-colored squares, so count as one */
        if (nMine > 2 && nMine != pCnt[WhiteAlfil + side] + 1) {
            return TRUE;  /* At least two pieces, not all Alfils */
        }
        /* by now we have King + 1 piece (or multiple Bishops on the same color) */
        if (pCnt[WhiteKnight + side]) {
            return (pCnt[BlackKnight - side] + pCnt[BlackBishop - side] + pCnt[BlackMan - side] + pCnt[BlackWazir - side] +
              pCnt[BlackSilver - side] + bisColor  /* KNKN, KNKB, KNKF, KNKE, KNKW, KNKM, KNKS */
...
int CompareWithRights(Board b1, Board b2) {
    int rights = 0;
    if (!CompareBoards(b1, b2)) {
        return FALSE;
    }
    if (b1[EP_STATUS] != b2[EP_STATUS]) {
        return FALSE;
    }
...
int Adjudicate(ChessProgramState * cps) {  /* [HGM] some adjudications useful with buggy engines */
    ...
    if (appData.testLegality) { /* [HGM] Some more adjudications for obstinate engines */
        ...
        if ((gameInfo.variant == VariantAtomic || gameInfo.variant == VariantDuck) && nr[WhiteKing] + nr[BlackKing] < 2) {
            ...
            if (canAdjudicate && appData.checkMates) {
                ...
                GameEnds(WhiteOnMove(forwardMostMove) ? BlackWins : WhiteWins, "Xboard adjudication: King destroyed", GE_XBOARD);
                return 1;
            }
        }
        ...
        if (nrW == 1 || nrB == 1) {
            if (gameInfo.variant == VariantLosers) {  /* [HGM] losers: bare King wins (stm must have it first) */
            ...
            } else if (gameInfo.variant == VariantShatranj && --bare < 0) { /* bare King */
                ...
                if (canAdjudicate && appData.checkMates) {
                    ...
                    GameEnds(nrW > 1 ? WhiteWins : nrB > 1 ? BlackWins : GameIsDrawn, "Xboard adjudication: Bare king", GE_XBOARD);
                    return 1;
                }
            }
        } else {
        ...
        case MT_STAINMATE:
            ...
            if ((signed char)boards[forwardMostMove][EP_STATUS] !=
             EP_CHECKMATE) {  /* [HGM] don't touch win through baring or K-capt */
                boards[forwardMostMove][EP_STATUS] = EP_STALEMATE;  /* default result for stalemate is draw */
                if (gameInfo.variant == VariantLosers || gameInfo.variant == VariantGiveaway ||
                 gameInfo.variant == VariantDuck) {  /* [HGM] losers: */
                    ...
                    boards[forwardMostMove][EP_STATUS] =
                     nrW == nrB ? EP_STALEMATE : ((nrW < nrB) != WhiteOnMove(forwardMostMove) ? EP_CHECKMATE : EP_WINS);
        ...
        case MT_CHECKMATE:
            ...
            if (gameInfo.variant == VariantShogi) {
                if (forwardMostMove > backwardMostMove && moveList[forwardMostMove - 1][1] == '@' &&
        ...
        case EP_STALEMATE:
            ...
            break;
        case EP_CHECKMATE:
            result = WhiteOnMove(forwardMostMove) ? BlackWins : WhiteWins;
            break;
        case EP_WINS:
        ...
        if (!MatingPotential(nr, WhitePawn, nrW, nrB, staleW, bishopColor) &&
         !MatingPotential(nr, BlackPawn, nrB, nrW, staleB, bishopColor)) { /* includes KBK, KNK, KK of KBKB with like Bishops */
            ...
            if (canAdjudicate && appData.materialDraws) {
                ...
                if (engineOpponent) {
                    /* suppress reply */
                    SendToProgram("force\n", engineOpponent);
                    /* make sure opponent gets to see last move */
                    SendMoveToProgram(forwardMostMove - 1, engineOpponent);
                }
          ...
          : nrW + nrB == 4 &&
           (nr[WhiteRook] == 1 && nr[BlackRook] == 1 /* KRKR */
            ...
            if (--moveCount < 0 && appData.trivialDraws &&
             canAdjudicate) { /* if the first 3 moves do not show a tactical win, declare draw */
                if (engineOpponent) {
                    /* suppress reply */
                    SendToProgram("force\n", engineOpponent);
                    /* make sure opponent gets to see move */
        ...
        if (gameInfo.variant == VariantMakruk &&  /* Makruk counting rules */
         (nrW == 1 || nrB == 1 || nr[WhitePawn] + nr[BlackPawn] == 0)) {  /* which only kick in when pawnless or bare King */
            ...
            while (count >= backwardMostMove) {
                ...
                if (wom) {
                    mine = nrW, his = nrB, c = BlackPawn;
                } else {
                    mine = nrB, his = nrW, c = WhitePawn;
                }
                if (mine > 1 && np) {
                    count++;
                    break;
                ...
                if (mine > 1) {
                    ...
                    maxcnt = (nr[WhiteRook + c] > 1      ? 8
                               : nr[WhiteRook + c]       ? 16
                               : nr[WhiteMan + c] > 1    ? 22
                               : nr[WhiteKnight + c] > 1 ? 32
                               : nr[WhiteMan + c]        ? 44
                                                         : 64) -
                     his - 1;
                }
                while (boards[count][EP_STATUS] != EP_CAPTURE && count > backwardMostMove) {
                    /* seek previous character */
                    count--;
                }
    ...
    /* Check for rep-draws */
    count = 0;
    drop = gameInfo.holdingsSize &&
     (gameInfo.variant != VariantSuper && gameInfo.variant != VariantSChess && gameInfo.variant != VariantGreat &&
      gameInfo.variant != VariantGrand);
    for (k = forwardMostMove - 2; k >= backwardMostMove && k >= forwardMostMove - 100 &&
     (drop ||
      (signed char)boards[k][EP_STATUS] < EP_UNKNOWN && (signed char)boards[k + 2][EP_STATUS] <= EP_NONE &&
       (signed char)boards[k + 1][EP_STATUS] <= EP_NONE);
     k -= 2) {
        int rights = 0;
        if (CompareBoards(boards[k], boards[forwardMostMove])) {
            ...
            if (rights == 0 && ++count > appData.drawRepeats - 2 && canAdjudicate && appData.drawRepeats > 1) {
                ...
                if ((gameInfo.variant == VariantXiangqi || gameInfo.variant == VariantShogi) && appData.testLegality) {
                    ...
                    if (appData.debugMode) {
                        fprintf(debugFP, "XQ perpetual test, our=%d, his=%d\n", ourPerpetual, hisPerpetual);
                    }
                    if (ourPerpetual && !hisPerpetual) {  /* we are actively checking him: forfeit */
                        result = WhiteOnMove(forwardMostMove) ? WhiteWins : BlackWins;
                        details = "Xboard adjudication: perpetual checking";
                    } else if (hisPerpetual && !ourPerpetual) {  /* he is checking us, but did not repeat yet */
                        break;  /* (or we would have caught him before). Abort repetition-checking loop. */
                    } else if (gameInfo.variant == VariantShogi) {  /* in Shogi other repetitions are draws */
                        ...
                        if (!ourPerpetual && !hisPerpetual) {  /* no perpetual check, test for chase */
                            ...
                            if (ourPerpetual && !hisPerpetual) {  /* we are actively chasing him: forfeit */
                                ...
                                result = WhiteOnMove(forwardMostMove) ? WhiteWins : BlackWins;
                                details = resdet;
                                snprintf(resdet, MSG_SIZ, "Xboard adjudication: perpetual chasing of %c%c", ourPerpetual >> 8,
                                 ourPerpetual & 255);
                            } else if (hisPerpetual && !ourPerpetual) {  /* he is chasing us, but did not repeat yet */
    ...
    if (gameInfo.variant == VariantXiangqi && (count >= 100 || count >= 2 * appData.ruleMoves)) {
        ...
        while (i <= forwardMostMove) {
            ...
            if (inCheck || lastCheck) {
                count--;  /* check does not count */
            }
            i++;
        }
    }
    /* do not accept 50-move claims in Makruk */
    if (count >= 100 && gameInfo.variant != VariantMakruk) {
        boards[forwardMostMove][EP_STATUS] = EP_RULE_DRAW;
    }
    ...
    /* If draw offer is pending, treat it as a draw claim when draw condition present, to allow engines a way to claim draws before
    making their move to avoid a race condition occurring after their move. */
...
static int BitbaseProbe(void) {
    ...
    if (BOARD_HEIGHT != 8 || BOARD_RGHT - BOARD_LEFT != 8) {
        return 12;
    }
    if (gameInfo.holdingsSize && gameInfo.variant != VariantSuper && gameInfo.variant != VariantSChess) {
        return 12;
    }
    if (loaded == 2 && forwardMostMove < 2) {
        loaded = 0;  /* retry on new game */
    }
    for (r = 0; r < BOARD_HEIGHT; r++) {
        for (f = BOARD_LEFT; f < BOARD_RGHT; f++) {
            ...
            if (type != WhiteKing && type > WhiteQueen) {
                return 12;  /* unorthodox piece */
            }
            if (type == WhiteKing) {
                type = WhiteQueen + 1;
            }
    ...
    /* probe EGBB */
    if (loaded == 2) {
        return 13;  /* loading failed before */
    }
    if (loaded == 0) {
        ...
        lib = LoadLibrary(buf);
        if (!lib) {
            DisplayError(_("could not load EGBB library"), 0);
            return 13;
        }
        loadBB = (PLOAD_EGBB)GetProcAddress(lib, "load_egbb_xmen");
        probeBB = (PPROBE_EGBB)GetProcAddress(lib, "probe_egbb_xmen");
        if (!loadBB || !probeBB) {
            DisplayError(_("wrong EGBB version"), 0);
            return 13;
        }
        p[1] = NULLCHAR;
        loadBB(buf, 64 * 1028, 2);  /* 2 = SMART_LOAD */
        loaded = 1;  /* success! */
    }
...
char * SendMoveToBookUser(
 int moveNr, ChessProgramState * cps, int initial) {  /* [HGM] book: this routine intercepts moves to simulate book replies */
    char * bookHit = NULL;
    ...
    if (bookHit) {
        setboardSpoiledMachineBlack = FALSE;  /* suppress 'go' in SendMoveToProgram */
    }
    if (!initial) {
        SendMoveToProgram(moveNr, cps);  /* with hit on initial position there is no move */
    }
    ...
    if (bookHit) {
        ...
        if (cps->useSAN) {
            ...
            ChessMove moveType;
            move = buf + 30;
            if (ParseOneMove(bookHit, forwardMostMove, &moveType, &fromX, &fromY, &toX, &toY, &promoChar)) {
                (void)CoordsToAlgebraic(
                 boards[forwardMostMove], PosFlags(forwardMostMove), fromY, fromX, toY, toX, promoChar, move);
            } else {
                if (appData.debugMode) {
                    fprintf(debugFP, "Book move could not be parsed\n");
                }
                bookHit = NULL;
            }
        }
        ...
        SendToProgram(buf, cps);
        if (!initial) {
            firstMove = FALSE;  /* normally we would clear the firstMove condition after return & sending 'go' */
        }
...
int LoadError(char * errmess, ChessProgramState * cps) {  /* unloads engine and switches back to -ncp mode if it was first */
    if (cps->initDone) {
        return FALSE;
    }
    ...
    if (cps == &first) {
        appData.noChessProgram = TRUE;
        gameMode = MachinePlaysBlack;
        ModeHighlight();  /* kludge to unmark Machine Black menu */
        gameMode = BeginningOfGame;
        ModeHighlight();
        SetNCPMode();
    }
    if (GetDelayedEvent()) {
        CancelDelayedEvent(), ThawUI();  /* [HGM] cancel remaining loading effort scheduled after feature timeout */
    }
    DisplayMessage("", "");  /* erase waiting message */
    if (errmess) {
        DisplayError(errmess, 0);  /* announce reason, if given */
    }
    return TRUE;
}
...
FakeBookMove:  /* [HGM] book: we jump here to simulate machine moves after book hit */
    ...
    if ((sscanf(message, "%s %s %s", buf1, buf2, machineMove) == 3 && strcmp(buf2, "...") == 0) ||
     (sscanf(message, "%s %s", buf1, machineMove) == 2 && strcmp(buf1, "move") == 0)) {
            ...
            if (gameInfo.variant == VariantDuck) {
                ...
                if (legs == 2) {
                    sscanf(p, "%c%d", &f, &kill2Y), kill2X = f - AAA,
                                                    kill2Y -= ONE - '0';  /* in 3-leg move 2nd kill is to-sqr of 1st leg */
                } else if (*p == *buf) {  /* if first-leg to not equal to second-leg from first leg says unmodified (assume it is */
                                          /* King move of castling) */
        ...
        if (!ParseOneMove(machineMove, forwardMostMove, &moveType, &fromX, &fromY, &toX, &toY, &promoChar)) {
            /* Machine move could not be parsed; ignore it. */
            snprintf(buf1, MSG_SIZ * 10, _("Illegal move \"%s\" from %s machine"), machineMove, _(cps->which));
            DisplayMoveError(buf1);
            snprintf(buf1, MSG_SIZ * 10, "Xboard: Forfeit due to invalid move: %s (%c%c%c%c via %c%c, %c%c) res=%d", machineMove,
             fromX + AAA, fromY + ONE, toX + AAA, toY + ONE, killX + AAA, killY + ONE, kill2X + AAA, kill2Y + ONE, moveType);
            if (gameMode == TwoMachinesPlay) {
        ...
        if (gameMode == TwoMachinesPlay && appData.testLegality) {
            ...
            if (gameInfo.variant == VariantDuck &&
             (killX < BOARD_LEFT || killX >= BOARD_RGHT || killY < 0 || killY >= BOARD_HEIGHT ||
              boards[forwardMostMove][killY][killX] != EmptySquare && (killX != fromX || killY != fromY))) {
                moveType = IllegalMove;
            }
            if (moveType == IllegalMove) {
                snprintf(buf1, MSG_SIZ * 10, "Xboard: Forfeit due to illegal move: %s (%c%c%c%c)%c", machineMove, fromX + AAA,
                 fromY + ONE, toX + AAA, toY + ONE, 0);
                GameEnds(cps->twoMachinesColor[0] == 'w' ? BlackWins : WhiteWins, buf1, GE_XBOARD);
                return;
        ...
        if (*appData.finger) {
            ...
            if (f) {
                ...
                DisplayFatalError("Bad output file", errno, 0);
                return;
            }
            free(fen);
     ...
     (!appData.testLegality || gameInfo.variant == VariantFairy || gameInfo.variant == VariantUnknown || prelude ||
      NonStandardBoardSize(gameInfo.variant, gameInfo.boardWidth, gameInfo.boardHeight,
       gameInfo.holdingsSize))) {  /* [HGM] allow first engine to define opening position */
        ...
        Board tmp;
        if (appData.icsActive || forwardMostMove != 0 || cps != &first) {
            return;
        }
        *buf = NULLCHAR;
    ...
    if (sscanf(message, "piece %s %s", buf2, buf1) == 2) {
        ...
        piece = CharToPiece(ID & 255);
        if (promoted) {
            piece = CHUPROMOTED(piece);
        }
        if (cps != &first ||
         appData.testLegality &&
          *engineVariant == NULLCHAR
          /* always accept definition of  */
          && piece != WhiteFalcon &&
          piece != BlackFalcon
          /* wild-card pieces.            */
          && piece != WhiteCobra &&
          piece != BlackCobra
          /* For variants we don't have   */
          &&
          gameInfo.variant != VariantBerolina
          /* correct rules for, we cannot */
          &&
          gameInfo.variant != VariantCylinder
          /* enforce legality on our own! */
          && gameInfo.variant != VariantUnknown && gameInfo.variant != VariantGreat && gameInfo.variant != VariantFairy) {
            return;
        }
        if (piece < EmptySquare) {
            pieceDefs = TRUE;
    ...
    if (!strncmp(message, "dice ", 5)) {
        ...
        if (gameMode != TwoMachinesPlay || (cps->twoMachinesColor[0] == 'w') == WhiteOnMove(forwardMostMove)) {
            ...
            if (gameMode != TwoMachinesPlay) {
                ...
                if (human) {
                    snprintf(buf, MSG_SIZ, "Your dice roll:%s (mine %s)", diceRoll, previousRoll);
                } else {
                    snprintf(buf, MSG_SIZ, "My dice roll:%s", diceRoll);
                }
                DisplayTitle(buf);
            } else if (cps->other->dice) {
                SendToProgram(buf, cps->other);
            }
        }
        return;
    }
    ...
    if (loggedOn) {
        ...
        if (!strncmp(message, "whisper", 7) || !strncmp(message, "kibitz", 6) || !strncmp(message, "draw", 4) ||
    ...
    if (strncmp(message + 1, "llegal move", 11) == 0 || strncmp(message, "Error", 5) == 0) {
        if (StrStr(message, "name") || StrStr(message, "rating") || StrStr(message, "?") || StrStr(message, "result") ||
         ...
         StrStr(message, "hint") || StrStr(message, "random") || StrStr(message, "depth") || StrStr(message, "accepted")) {
            return;
        }
        ...
        if (cps->sendTime != 1 && (StrStr(message, "time") || StrStr(message, "otim"))) {
        ...
        if (gameMode == BeginningOfGame || gameMode == EndOfGame || gameMode == IcsIdle) {
            return;
        }
        ...
        if (appData.forceIllegal) {
            ...
            if (!cps->useSetboard) {  /* hideous kludge on kludge, because SendBoard sucks. */
                ...
                /* FEN case, also sets stm properly */
                SendBoard(cps, forwardMostMove);
            }
            if (gameMode == MachinePlaysWhite || gameMode == MachinePlaysBlack || gameMode == TwoMachinesPlay) {
                SendToProgram("go\n", cps);
            }
            return;
        } else if (gameMode == PlayFromGameFile) {
            /* Stop reading this game file */
            gameMode = EditGame;
            ModeHighlight();
        }
        /* [HGM] illegal-move claim should forfeit game when Xboard only passes fully legal moves. */
        if (appData.testLegality && gameMode == TwoMachinesPlay) {
            GameEnds(cps->twoMachinesColor[0] == 'w' ? BlackWins : WhiteWins, "False illegal-move claim", GE_XBOARD);
            /* do not take back move we tested as valid */
            return;
        }
        currentMove = forwardMostMove - 1;
        ...
        DisplayBothClocks();
        snprintf(
         buf1, 10 * MSG_SIZ, _("Illegal move \"%s\" (rejected by %s chess program)"), parseList[currentMove], _(cps->which));
        DisplayMoveError(buf1);
        DrawPosition(FALSE, boards[currentMove]);
    ...
    if (strncmp(message, "time", 4) == 0 && StrStr(message, "Illegal")) {
        /* Program has a broken "time" command that outputs a string not ending in newline.  Don't use it. */
        cps->sendTime = 0;
    }
    ...
    /* If chess program startup fails, exit with an error messagem because attempts to recover here are futile.

     [HGM] Well, we try anyway. */
    if ((StrStr(message, "unknown host") != NULL) || (StrStr(message, "No remote directory") != NULL) ||
     (StrStr(message, "not found") != NULL) || (StrStr(message, "No such file") != NULL) ||
     (StrStr(message, "can't alloc") != NULL) || (StrStr(message, "Permission denied") != NULL)) {
        cps->maybeThinking = FALSE;
        snprintf(buf1, sizeof(buf1), _("Failed to start %s chess program %s on %s: %s\n"), _(cps->which), cps->program, cps->host,
         message);
        RemoveInputSource(cps->isr);
        if (appData.icsActive) {
            DisplayFatalError(buf1, 0, 1);
        } else {
            if (LoadError(oldError ? NULL : buf1, cps)) {
                /* error has then been handled by LoadError */
                return;
            }
            if (!oldError) {
                /* if reason neatly announced, suppress general error popup */
                DisplayError(buf1, 0);
            }
        }
        return;
    ...
    if (sscanf(message, "Hint: %s", buf1) == 1) {
        ...
        if (cps == &first && hintRequested) {
            hintRequested = FALSE;
            if (ParseOneMove(buf1, forwardMostMove, &moveType, &fromX, &fromY, &toX, &toY, &promoChar)) {
                (void)CoordsToAlgebraic(
                 boards[forwardMostMove], PosFlags(forwardMostMove), fromY, fromX, toY, toX, promoChar, buf1);
                snprintf(buf2, sizeof(buf2), _("Hint: %s"), buf1);
                DisplayInformation(buf2);
            } else {
                /* Hint move could not be parsed!? */
                snprintf(buf2, sizeof(buf2), _("Illegal hint move \"%s\"\nfrom %s chess program"), buf1, _(cps->which));
                DisplayError(buf2, 0);
            }
        } else {
    ...
    if (gameMode == BeginningOfGame || gameMode == EndOfGame || gameMode == IcsIdle || cps->lastPing != cps->lastPong) {
        return;
    }
    ...
    if (strncmp(message, "1-0", 3) == 0) {
        ...
        /* [HGM] pass claimer indication for claim test */
        ...
        return;
    } else if (strncmp(message, "White matches", 13) == 0 || strncmp(message, "Black matches", 13) == 0) {
        /* [HGM] ignore GNUShogi noises */
        return;
    } else if (strncmp(message, "White", 5) == 0 && message[5] != '(' && StrStr(message, "Black") == NULL) {
        GameEnds(WhiteWins, "White mates", GE_ENGINE1 + (cps != &first));
        return;
    } else if (strncmp(message, "Black", 5) == 0 && message[5] != '(') {
        GameEnds(BlackWins, "Black mates", GE_ENGINE1 + (cps != &first));
        return;
    } else if (strcmp(message, "resign") == 0 || strcmp(message, "computer resigns") == 0) {
        switch (gameMode) {
        case MachinePlaysBlack:
        case IcsPlayingBlack:
        ...
        return;
    } else if (strstr(message, "Draw") != NULL || strstr(message, "game is a draw") != NULL) {
        GameEnds(GameIsDrawn, "Draw", GE_ENGINE1 + (cps != &first));
        return;
    } else if (strstr(message, "offer") != NULL && strstr(message, "draw") != NULL) {
#if ZIPPY
        if (appData.zippyPlay && first.initDone) {
            /* Relay offer to ICS */
            SendToICS(ics_prefix);
    ...
    if (appData.showThinking  /* [HGM] thinking: test all options that cause this output */
     || !appData.hideThinkingFromHuman || appData.adjudicateLossThreshold != 0 || EngineOutputIsUp()) {
        ...
        if (!ignore) {
            /* [HGM] info: filter out info lines */
            ChessProgramStats tempStats = programStats;
            int solved = 0;
            buf1[0] = NULLCHAR;
            if (sscanf(message, "%d%c %d %d %llu %[^\n]\n", &plylev, &plyext, &curscore, &time, &nodes, buf1) >= 5) {
                ...
                if (appData.pvSAN[cps == &second]) {
                    pv = PvToSAN(buf1, cps == &second);
                }

                if (*bestMove) {  /* rememer time best EPD move was first found */
                    int ff1, tf1, fr1, tr1, ff2, tf2, fr2, tr2;
                    char pp1, pp2;
                    ChessMove mt;
                    char * p = bestMove;
                ...
                if (serverMoves && (time > 100 || time == 0 && plylev > 7)) {
                    ...
                    buf[strlen(buf) - 1] = gameMode == MachinePlaysWhite ? 'w'
                     : gameMode == MachinePlaysBlack                     ? 'b'
                                                                         : cps->twoMachinesColor[0];
                    if (appData.debugMode) {
                        fprintf(debugFP, "write PV on file '%s'\n", buf);
                    }
                    if (f = fopen(buf, "w")) {  /* export PV to applicable PV file */
                        fprintf(f, "%5.2f/%-2d %s", curscore / 100., plylev, pv);
                        fclose(f);
                    } else {
                        /* TRANSLATORS: PV = principal variation, what the chess engine thinks are the best future moves. */
                ...
                if (cps->nps >= 0) { /* [HGM] nps: use engine nodes or time to decrement clock */
                    ...
                    if (cps->nps == 0) {
                        /* use engine reported time */
                        ticklen = 10 * time;
                    } else {
                        /* convert node count to time */
                        ticklen = (1000. * (double)(nodes)) / cps->nps;
                    }
                    if (WhiteOnMove(forwardMostMove) &&
                     (gameMode == MachinePlaysWhite || gameMode == TwoMachinesPlay && cps->twoMachinesColor[0] == 'w')) {
                ...
                if (pv[0] != NULLCHAR) {
                    if (strlen(pv) >= sizeof(tempStats.movelist) && appData.debugMode) {
                        fprintf(debugFP, "PV is too long; using the first %u bytes.\n", (unsigned)sizeof(tempStats.movelist) - 1);
                    }
                ...
                if (tempStats.score != 0 || tempStats.nodes != 0 || tempStats.time != 0) {
                    /* [HGM] info: only set stats if genuine PV and not an info line */
                    programStats = tempStats;
                }

                SendProgramStatsToFrontend(cps, &tempStats);

                /* [AS] Protect the thinkOutput buffer from overflow... this is only useful if buf1 hasn't overflowed first! */
                if ((gameMode == AnalyzeMode && appData.whitePOV || appData.scoreWhite) && !WhiteOnMove(forwardMostMove)) {
                    curscore *= -1;
                }
                ...
                snprintf(thinkOutput, sizeof(thinkOutput) / sizeof(thinkOutput[0]), "[%d]%c%s %s%s", plylev,
                 (gameMode == TwoMachinesPlay ? ToUpper(cps->twoMachinesColor[0]) : ' '), score_buf, prefixHint ? lastHint : "",
                 prefixHint ? " " : "");
                ...
                /* crafty (9.25+) says "(only move) <move>" if there is only 1 legal move. */
                ...
                /* Not really, but we also use this member to mean "line isn't going to change" (Crafty isn't searching, so stats
                won't change) */
                ...
                return;
            } else if (sscanf(message, "stat01: %d %llu %d %d %d %s", &time, &nodes, &plylev, &mvleft, &mvtot, mvname) >= 5) {
                /* The stat01: line is from Crafty (9.29+) in response to the "." command */
            ...
            } else if (thinkOutput[0] != NULLCHAR && strncmp(message, "    ", 4) == 0) {
...
/* Parse a game score from the character string "game", and record it as the history of the current game.  The game score is NOT
   assumed to start from the standard position.  The display is not updated in any way. */
void ParseGameHistory(char * game) {
    ChessMove moveType;
    ...
    *p = NULLCHAR;
    ...
    for (;;) {
        ...
        switch (moveType) {
        case IllegalMove:
            /* maybe suicide chess, etc. */
            if (appData.debugMode) {
                fprintf(debugFP, "Illegal move from ICS: '%s'\n", yy_text);
                fprintf(
                 debugFP, "board L=%d, R=%d, H=%d, holdings=%d\n", BOARD_LEFT, BOARD_RGHT, BOARD_HEIGHT, gameInfo.holdingsWidth);
                setbuf(debugFP, NULL);
            }
            /* Intentionally fall through. */
        case WhitePromotion:
        ...
        case WhiteDrop:
        case BlackDrop:
            if (currentMoveString[0] == '@') {
                /* no null moves in ICS mode! */
                continue;
            }
            fromX = moveType == WhiteDrop ? (int)CharToPiece(ToUpper(currentMoveString[0]))
                                          : (int)CharToPiece(ToLower(currentMoveString[0]));
            fromY = DROP_RANK;
            toX = currentMoveString[2] - AAA;
            toY = currentMoveString[3] - ONE;
        ...
        case GameUnfinished:
            ...
            while (q = strchr(p, '\n')) {
                /* [HGM] crush linefeeds in result message */
                *q = ' ';
            }
            gameInfo.resultDetails = StrSave(p);
            continue;
        }
        if (boardIndex >= forwardMostMove && !(gameMode == IcsObserving && ics_gamenum == -1)) {
            backwardMostMove = blackPlaysFirst ? 1 : 0;
            return;
        }
        (void)CoordsToAlgebraic(boards[boardIndex], PosFlags(boardIndex), fromY, fromX, toY, toX, promoChar, parseList[boardIndex]);
        ...
        default:
            break;
        case MT_CHECK:
            if (boards[boardIndex][CHECK_COUNT]) {
                boards[boardIndex][CHECK_COUNT] -= mask & 0x101;
            }
...
void ApplyMove(int fromX, int fromY, int toX, int toY, int promoChar, Board board) {
    ...
    int promoRank =
     gameInfo.variant == VariantMakruk || gameInfo.variant == VariantGrand || gameInfo.variant == VariantChuChess ? 3 : 1;

    /* [HGM] compute & store e.p. status and castling rights for new position */
    /* we can always do that 'in place', now pointers to these rights are passed to ApplyMove */

    if (gameInfo.variant == VariantBerolina) {
        berolina = EP_BEROLIN_A;
    }
    if (gameInfo.variant == VariantSChess && !gameInfo.holdingsSize) {
        promoRank = 2;
    }
    oldEP = (signed char)board[EP_STATUS];
    epRank = board[EP_RANK];
    epFile = board[EP_FILE];
    lastFile = board[LAST_TO] & 255, lastRank = board[LAST_TO] >> 8;
    ...
    if (fromY == DROP_RANK) {
        ...
        if (killX >= 0 && killY >= 0) {  /* [HGM] lion: Lion trampled over something */
            ...
            if (gameInfo.variant == VariantDuck) {  /* killXY used to indicate Duck move */
                ...
                for (r = 0; r < BOARD_HEIGHT; r++) {
                    for (f = BOARD_LEFT; f < BOARD_RGHT; f++) {
                        if (board[r][f] == DarkSquare) {
                            board[r][f] = EmptySquare;
                        }
                    }
                }
                board[killY][killX] = DarkSquare;
            } else {
                killed = board[killY][killX], board[killY][killX] = EmptySquare, board[EP_STATUS] = EP_CAPTURE;
                if (kill2X >= 0 && kill2Y >= 0) {
        ...
        if (pieceDesc[pawn] && strchr(pieceDesc[pawn], 'e')) {  /* piece with user-defined e.p. capture */
            board[EP_RANK] = epRank;
            board[EP_FILE] = epFile;  /* Ughh! cleared it too soon :-( */
            isEP = EnPassantTest(board, PosFlags(currentMove), fromY, fromX, toY, toX, promoChar);
            if (isEP != 1) {
                board[EP_RANK] = board[EP_FILE] = 100;  /* assumes only e.p. capturing pieces generate rights! */
            }
            if (isEP == 2) {
        ...
        if (pawn == WhiteLance || pawn == BlackLance) {
            if (gameInfo.variant != VariantSuper && gameInfo.variant != VariantChu) {
                if (gameInfo.variant == VariantSpartan) {
                    board[EP_STATUS] = EP_PAWN_MOVE;  /* in Spartan no e.p. rights must be set */
                } else {
                    pawn +=
                     WhitePawn - WhiteLance;  /* Lance is Pawn-like in most variants, so let Pawn code treat it by this kludge */
                }
            }
        }
        if (pawn == WhitePawn) {
            ...
            if (!isEP && toY - fromY >= 2) {
                board[EP_FILE] = (2 * fromX + toX + 1) / 3;
                board[EP_RANK] = toY - 1 | 128 * (toY - fromY > 2);
                if (toX > BOARD_LEFT && board[toY][toX - 1] == BlackPawn && gameInfo.variant != VariantBerolina || toX < fromX) {
                    board[EP_STATUS] = toX | berolina;
                }
                if (toX < BOARD_RGHT - 1 && board[toY][toX + 1] == BlackPawn && gameInfo.variant != VariantBerolina ||
                 toX > fromX) {
                    board[EP_STATUS] = toX;
                }
            }
        } else if (pawn == BlackPawn) {
            if (fromY != toY) {  /* [HGM] Xiangqi sideway Pawn moves should not count as 50-move breakers */
                board[EP_STATUS] = EP_PAWN_MOVE;
            }
            if (!isEP && toY - fromY <= -2) {
                board[EP_FILE] = (2 * fromX + toX + 1) / 3;
                board[EP_RANK] = toY + 1 | 128 * (fromY - toY > 2);
                if (toX > BOARD_LEFT && board[toY][toX - 1] == WhitePawn && gameInfo.variant != VariantBerolina || toX < fromX) {
                    board[EP_STATUS] = toX | berolina;
                }
                if (toX < BOARD_RGHT - 1 && board[toY][toX + 1] == WhitePawn && gameInfo.variant != VariantBerolina ||
                 toX > fromX) {
                    board[EP_STATUS] = toX;
                }
            }
        ...
        if (fromY == 0) {
            board[TOUCHED_W] |= 1 << fromX;
        } else  /* new way to keep track of virginity */
            if (fromY == BOARD_HEIGHT - 1) {
                board[TOUCHED_B] |= 1 << fromX;
            }
        if (toY == 0) {
            board[TOUCHED_W] |= 1 << toX;
        } else if (toY == BOARD_HEIGHT - 1) {
            board[TOUCHED_B] |= 1 << toX;
        }

        for (i = 0; i < nrCastlingRights; i++) {
            if (board[CASTLING][i] == fromX && castlingRank[i] == fromY || board[CASTLING][i] == toX && castlingRank[i] == toY) {
        ...
        if (gameInfo.variant == VariantSChess) {  /* update virginity */
            ...
            if (fromY == offs) {
                board[VIRGIN][fromX] &= ~VIRGIN_W;  /* loss by moving */
            }
            if (fromY == BOARD_HEIGHT - 1 - offs) {
                board[VIRGIN][fromX] &= ~VIRGIN_B;
            }
            if (toY == offs) {
                board[VIRGIN][toX] &= ~VIRGIN_W;  /* loss by capture */
            }
            if (toY == BOARD_HEIGHT - 1 - offs) {
                board[VIRGIN][toX] &= ~VIRGIN_B;
            }
        }

        if (fromX == toX && fromY == toY && killX < 0) {
            return;
        }
        ...
        if (autoProm[piece]) {
        ...
        } else if (pieceDesc[piece] && killX >= 0 && strchr(pieceDesc[piece], 'O')  /* Betza castling-enabled */
         && (piece < BlackPawn ? killed < BlackPawn : killed >= BlackPawn)) {  /* and tramples own */
        ...
        } else if (nrCastlingRights == 0 && board[toY][toX] < EmptySquare && (piece < BlackPawn) == (board[toY][toX] < BlackPawn)) {
            ...
            if (piece == WhiteKing && board[toY][toX] == WhiteRook || piece == WhiteRook && board[toY][toX] == WhiteKing) {
                board[EP_STATUS] = EP_NONE;  /* capture was fake! */
                board[toY][toX] = EmptySquare;
                if ((toX > fromX) != (piece == WhiteRook)) {
                    board[0][BOARD_RGHT - 2] = WhiteKing;
                    board[0][BOARD_RGHT - 3] = WhiteRook;
                } else {
                    board[0][BOARD_LEFT + 2] = WhiteKing;
                    board[0][BOARD_LEFT + 3] = WhiteRook;
                }
            } else if (piece == BlackKing && board[toY][toX] == BlackRook || piece == BlackRook && board[toY][toX] == BlackKing) {
                board[EP_STATUS] = EP_NONE;
                board[toY][toX] = EmptySquare;
                if ((toX > fromX) != (piece == BlackRook)) {
                    board[BOARD_HEIGHT - 1][BOARD_RGHT - 2] = BlackKing;
                    board[BOARD_HEIGHT - 1][BOARD_RGHT - 3] = BlackRook;
                } else {
                    board[BOARD_HEIGHT - 1][BOARD_LEFT + 2] = BlackKing;
                    board[BOARD_HEIGHT - 1][BOARD_LEFT + 3] = BlackRook;
                }
                /* End of code added by Tord */
            ...
            } else if (piece == king && fromX != BOARD_LEFT && fromX != BOARD_RGHT - 1  /* [HGM] cylinder *  */
             ...
             toY >= BOARD_HEIGHT - promoRank && promoChar  /* defaulting to Q is done elsewhere */
                ...
                if (board[toY][toX] < WhiteCannon &&
                 PieceToChar(PROMOTED(board[toY][toX])) == '~') { /* [HGM] use shadow piece (if available) */
                    board[toY][toX] = (ChessSquare)(PROMOTED(board[toY][toX]));
                }
            } else if ((fromY >= BOARD_HEIGHT >> 1) &&
             (epFile == toX || oldEP == EP_UNKNOWN || appData.testLegality || abs(toX - fromX) > 4) && (toX != fromX) &&
             gameInfo.variant != VariantXiangqi && gameInfo.variant != VariantJanggi && gameInfo.variant != VariantBerolina &&
             (pawn == WhitePawn) && (board[toY][toX] == EmptySquare)) {
                if (lastFile == 100) {
                    lastFile = (board[fromY][toX] == BlackPawn ? toX : fromX),
                    lastRank = fromY;  /* assume FIDE e.p. if victim present */
                }
                board[toY][toX] = piece;
                captured = board[lastRank][lastFile], board[lastRank][lastFile] = EmptySquare;
            } else if ((fromY == BOARD_HEIGHT - 4) && (toX == fromX) && gameInfo.variant == VariantBerolina &&
             (piece == WhitePawn) && (board[toY][toX] == EmptySquare)) {
             ...
             && toY == fromY && toX < fromX - 1) {
                ...
                board[fromY][rookX] = EmptySquare;
                board[toY][toX] = king;
            } else if (fromY == 7 && fromX == 3 && piece == BlackKing && toY == 7 && toX == 5) {
                board[toY][toX] = BlackKing;
                board[fromY][7] = EmptySquare;
                board[toY][4] = BlackRook;
            } else if (fromY == 7 && fromX == 3 && piece == BlackKing && toY == 7 && toX == 1) {
                board[toY][toX] = BlackKing;
             ...
             toY < promoRank && promoChar) {
                ...
                if (board[toY][toX] < BlackCannon &&
                 PieceToChar(PROMOTED(board[toY][toX])) == '~') { /* [HGM] use shadow piece (if available) */
                    board[toY][toX] = (ChessSquare)(PROMOTED(board[toY][toX]));
                }
            } else if ((fromY < BOARD_HEIGHT >> 1) &&
             (epFile == toX && epRank == toY || oldEP == EP_UNKNOWN || appData.testLegality || abs(toX - fromX) > 4) &&
             (toX != fromX) && gameInfo.variant != VariantXiangqi && gameInfo.variant != VariantJanggi &&
             gameInfo.variant != VariantBerolina && (pawn == BlackPawn) && (board[toY][toX] == EmptySquare)) {
                if (lastFile == 100) {
                    lastFile = (board[fromY][toX] == WhitePawn ? toX : fromX), lastRank = fromY;
                }
                board[toY][toX] = piece;
                captured = board[lastRank][lastFile], board[lastRank][lastFile] = EmptySquare;
            } else if ((fromY == 3) && (toX == fromX) && gameInfo.variant == VariantBerolina && (piece == BlackPawn) &&
             (board[toY][toX] == EmptySquare)) {
    ...
    if (gameInfo.holdingsWidth != 0) {
        ...
        [HGM] OK, so I have written it. Holdings are stored in the penultimate board files, so they are automaticlly stored in the
        game history. */
        if (fromY == DROP_RANK || gameInfo.variant == VariantSChess && promoChar && piece != WhitePawn && piece != BlackPawn) {
            /* Delete from holdings, by decreasing count and erasing image if necessary. */
        ...
        if (captured != EmptySquare && gameInfo.holdingsSize > 0 && gameInfo.variant != VariantBughouse &&
         gameInfo.variant != VariantSChess) {
        ...
        if (captured != EmptySquare) {
            ...
            for (y = toY - 1; y <= toY + 1; y++) {
                for (x = toX - 1; x <= toX + 1; x++) {
                    if (y >= 0 && y < BOARD_HEIGHT && x >= BOARD_LEFT && x < BOARD_RGHT && board[y][x] != WhitePawn &&
                     board[y][x] != BlackPawn) {
    ...
    if (gameInfo.variant == VariantSChess) {
        ...
        if (promoChar != NULLCHAR && promoChar != '=' && piece != WhitePawn && piece != BlackPawn) {
            if (!gameInfo.holdingsSize && rank >= 0 && rank < BOARD_HEIGHT) {
                if (board[rank][file] == DarkSquare) {
                    file = (toX > fromX ? BOARD_RGHT - 1 : BOARD_LEFT);  /* must be castling */
                }
    ...
    } else if (!appData.testLegality && promoChar != NULLCHAR &&
     promoChar != '=') {  /* without legality testing, unconditionally believe promoChar */
        ...
        if ((newPiece <= WhiteMan || newPiece >= BlackPawn && newPiece <= BlackMan)  /* unpromoted piece specified */
         && pieceToChar[PROMOTED(newPiece)] == '~') {
            newPiece = PROMOTED(newPiece);  /* but promoted version available */
        }
...
void MakeMove(int fromX, int fromY, int toX, int toY, int promoChar) {
    ...
    /* [HGM] dice: consumed by this move */
    diceRoll[0] = NULLCHAR;
    if (gameInfo.variant != VariantDuck) {
        if (kill2X >= 0) {
            x = kill2X, y = kill2Y;
        } else if (killX >= 0 && killY >= 0) {
            /* [HGM] lion: make SAN move to intermediate square, if there is one */
            x = killX, y = killY;
        }
    }
    (void)CoordsToAlgebraic(boards[forwardMostMove], PosFlags(forwardMostMove), fromY, fromX, y, x, (killX < 0) * promoChar, s);
    if (kill2X >= 0 && kill2Y >= 0) {
        /* The second leg of a three-leg move is always a capture. */
        sprintf(s + strlen(s), "x%c%d", killX + AAA, killY + ONE - '0');
    }
    if (killX >= 0 && killY >= 0) {
        if (gameInfo.variant == VariantDuck) {
            if (promoChar) {
                sprintf(s + strlen(s), "=%c,%c%d", ToUpper(promoChar), killX + AAA, killY + ONE - '0');
            } else {
                sprintf(s + strlen(s), ",%c%d", killX + AAA, killY + ONE - '0');
            }
        } else {
            sprintf(s + strlen(s), "%c%c%d%c",
             p == EmptySquare || toX == fromX && toY == fromY || toX == kill2X && toY == kill2Y ? '-' : 'x', toX + AAA,
             toY + ONE - '0', promoChar);
        }
    }

    /* [HGM] Write moves to file for broadcasting.  TODO: Should really be a separate routine. */
    if (serverMoves != NULL) {
        int timeLeft;
        static int lastLoadFlag = 0;
        int king, piece;
        ...
        if (forwardMostMove == 0) {
            ...
            fprintf(serverMoves, loadFlag | lastLoadFlag ? ":" : ";");
        }
        ...
        /* e.p. suffix */
        if ((boards[forwardMostMove][fromY][fromX] == WhitePawn || boards[forwardMostMove][fromY][fromX] == BlackPawn) &&
         boards[forwardMostMove][toY][toX] == EmptySquare && fromX != toX && fromY != toY) {
        ...
        if (promoChar != NULLCHAR) {
            if (fromY == 0 || fromY == BOARD_HEIGHT - 1) {
                /* Seirawan gating */
                fprintf(serverMoves, ":%c%c:%c%c", WhiteOnMove(forwardMostMove) ? 'w' : 'b', ToLower(promoChar), AAA + fromX,
                 ONE + fromY);
            } else {
        ...
        if (!loadFlag) {
            char buf[MOVE_LEN * 2], *p;
            int len;
            fprintf(serverMoves, "/%d/%d", pvInfoList[forwardMostMove].depth, pvInfoList[forwardMostMove].score);
            if (forwardMostMove + 1 & 1) {
                timeLeft = whiteTimeRemaining / 1000;
            } else {
                timeLeft = blackTimeRemaining / 1000;
            }
    ...
    /* [HGM] race: incrementing move number inside */
    SwitchClocks(forwardMostMove + 1);
    ...
    CoordsToComputerAlgebraic(fromY, fromX, toY, toX, promoChar, moveList[forwardMostMove - 1]);
    ...
    default:
        break;
    case MT_CHECK:
        if (boards[forwardMostMove][CHECK_COUNT]) {
            boards[forwardMostMove][CHECK_COUNT] -= mask & 0x101;
        }
...
void ShowMove(int fromX, int fromY, int toX, int toY) {
    int instant = (gameMode == PlayFromGameFile) ? (matchMode || (appData.timeDelay == 0 && !pausing)) : pausing;
    if (appData.noGUI) {
        return;
    }
    if (!pausing || gameMode == PlayFromGameFile || gameMode == AnalyzeFile) {
        if (!instant) {
            if (forwardMostMove == currentMove + 1) {
                AnimateMove(boards[forwardMostMove - 1], fromX, fromY, toX, toY);
            }
        }
        currentMove = forwardMostMove;
    }
...
void SendEgtPath(
 ChessProgramState * cps) { /* [HGM] EGT: match formats given in feature with those given by user, and send info for each match */
    char buf[MSG_SIZ], name[MSG_SIZ], *p;

    if ((p = cps->egtFormats) == NULL || appData.egtFormats == NULL) {
        return;
    }
    ...
    while (*p) {
        ...
        *q++ = ':';
        *q = 0;
        if (appData.defaultPathEGTB && appData.defaultPathEGTB[0] && strcmp(name, ",nalimov:") == 0) {
        ...
        } else if ((s = StrStr(appData.egtFormats, name + 1)) == appData.egtFormats ||
         (s = StrStr(appData.egtFormats, name)) != NULL) {
            ...
            while (*r && *r != ',') {
                r++;  /* path info is everything upto next ';' or end of string */
            }
            c = *r;
            *r = 0;  /* temporarily null-terminate path info */
        ...
        if (*p == ',') {
            p++;  /* read away comma to position for next format name */
        }
    }
}

static int NonStandardBoardSize(VariantClass v, int boardWidth, int boardHeight, int holdingsSize) {
    int width = 8, height = 8, holdings = 0;  /* most common sizes */
    if (v == VariantUnknown || *engineVariant) {
        return 0;  /* engine-defined name never needs prefix */
    }
    /* correct the deviations default for each variant */
    if (v == VariantXiangqi || v == VariantJanggi) {
        width = 9, height = 10;
    }
    if (v == VariantShogi) {
        width = 9, height = 9, holdings = 7;
    }
    if (v == VariantBughouse || v == VariantCrazyhouse) {
        holdings = 5;
    }
    if (v == VariantCapablanca || v == VariantCapaRandom || v == VariantGothic || v == VariantFalcon || v == VariantJanus) {
        width = 10;
    }
    if (v == VariantCourier) {
        width = 12;
...
char * SupportedVariant(char * list, VariantClass v, int boardWidth, int boardHeight, int holdingsSize, int proto,
 char * engine) {  /* returns error message (recognizable by upper-case) if engine does not support the variant */
    ...
    if (NonStandardBoardSize(v, boardWidth, boardHeight, holdingsSize)) { /* [HGM] make prefix for non-standard board size. */
        snprintf(b, MSG_SIZ, "%dx%d+%d_%s", boardWidth, boardHeight, holdingsSize, variant);  /* cook up sized variant name */
        ...
        if (StrStr(list, b) == NULL) {
            ...
            if (proto != 1 && StrStr(list, "boardsize") == NULL) {
                snprintf(
                 variantError, MSG_SIZ, "Board size %dx%d+%d not supported by %s", boardWidth, boardHeight, holdingsSize, engine);
                return NULL;
            }
            /* [HGM] here we really should compare with the maximum supported board size */
        }
    } else {
        snprintf(b, MSG_SIZ, "%s", variant);
    }
    if (proto == 1) {
        return b;  /* for protocol 1 we cannot check and hope for the best */
    }
    p = StrStr(list, b);
    while (p && (p != list && p[-1] != ',' || p[strlen(b)] && p[strlen(b)] != ',')) {
        p = StrStr(p + 1, b);
    }
    if (p == NULL) {
...
void InitChessProgram(ChessProgramState * cps, int setup) {
    ...
    if (gameInfo.variant != VariantNormal && gameInfo.variant != VariantLoadable
     /* [HGM] also send variant if board size non-standard */
     || gameInfo.boardWidth != 8 || gameInfo.boardHeight != 8 || gameInfo.holdingsSize != 0) {
        b = SupportedVariant(cps->variants, gameInfo.variant, gameInfo.boardWidth, gameInfo.boardHeight, gameInfo.holdingsSize,
         cps->protocolVersion, cps->tidy);
...
char * ResendOptions(ChessProgramState * cps, int toEngine) {  /* send the stored value of the options */
    int i;
...
void StartChessProgram(ChessProgramState * cps) {
    ...
    if (cps->isUCI && strstr(appData.adapterCommand, "%niceEngines")) {
        /* no nicing on nice adapters! */
        priority = 0;
    }
    ...
    if (strcmp(cps->host, "localhost") == 0) {
        ...
        if (*appData.remoteUser == NULLCHAR) {
            snprintf(buf, sizeof(buf), "%s %s %s", appData.remoteShell, cps->host, cps->program);
        } else {
            snprintf(buf, sizeof(buf), "%s %s -l %s %s", appData.remoteShell, cps->host, appData.remoteUser, cps->program);
        }
    ...
    if (err != 0) {
        ...
        /* [HGM] bit of a rough kludge: ignore failure, (which XBoard would do anyway), and let I/O discover it */
        DisplayError(buf, err);
        if (cps != &first) {
            return;
        }
        appData.noChessProgram = TRUE;
...
void TwoMachinesEventIfReady(void) {
...
char * MakeName(char * template) {
    ...
    while (*p++ = *template++) {
        if (p[-1] == '%') {
            ...
            snprintf(p - 1, MSG_SIZ - 10 - (p - buf), "%02d", i);
            p += strlen(p);
        }
    }
    return buf;
...
FILE * WriteTourneyFile(char * results, FILE * f) {
    ...
    if (f == NULL) {
        DisplayError(_("Could not write on tourney file"), 0);
    } else {
...
void Substitute(char * participants, int expunge) {
    ...
    if (appData.tourneyFile[0] == NULLCHAR) {
        free(participants);
        return;
    }
    r = p = participants;
    q = appData.participants;
    while (*p && *p == *q) {
        if (*p == '\n') {
            r = p + 1, nPlayers++;
        }
    ...
    if (changes == 1) {
        ...
        *p = NULLCHAR;
        ...
        for (i = 1; mnemonic[i]; i++) {
            if (!strcmp(buf, mnemonic[i])) {
                break;
            }
        }
        if (mnemonic[i]) {
            ...
            DisplayError(_("No engine with the name you gave is installed"), 0);
        }
    }
    if (changes == 0) {
        DisplayError(_("First change an engine by editing the participants list\nof the Tournament Options dialog"), 0);
    }
    if (changes > 1) {
        DisplayError(_("You can only change one engine at the time"), 0);
    }
    free(participants);
    return;
}

int CheckPlayers(char * participants) {
    int i;
    char buf[MSG_SIZ], *p;
    NamesToList(firstChessProgramNames, command, mnemonic, "all");
    while (p = strchr(participants, '\n')) {
        *p = NULLCHAR;
        for (i = 1; mnemonic[i]; i++) {
            if (!strcmp(participants, mnemonic[i])) {
                break;
            }
        }
        if (!mnemonic[i]) {
...
int NamesToList(char * names, char ** engineList, char ** engineMnemonic, char * group) {
        ...
        *q = 0;
        ...
        if (buf[0] == '#') {
            if (strstr(buf, "# end") == buf) {
                ...
                continue;
            }  /* leave group, and suppress printing label */
            depth++;  /* we must be entering a new group */
            if (all) {
                continue;  /* suppress printing group headers when complete list requested */
            }
            header = 1;
            if (skip && !strcmp(group, buf)) {
                depth = 0;
                skip = FALSE;
            }  /* start when we reach requested group */
        }
        if (depth != header && !all || skip) {
            continue;  /* skip contents of group (but print first-level header) */
        }
        if (engineList[i]) {
            free(engineList[i]);
        }
        ...
        if (buf[0] != '#') {
            insert = p, TidyProgramName(engineList[i], "localhost", buf);  /* group headers not tidied */
        }
        if (engineMnemonic[i]) {
            free(engineMnemonic[i]);
        }
        if ((q = strstr(engineList[i] + 2, "variant")) && q[-2] == ' ' && (q[-1] == '/' || q[-1] == '-') &&
         (q[7] == ' ' || q[7] == '=')) {
            strcat(buf, " (");
...
#define SWAP(item, temp) \
    temp = appData.item[0]; \
    appData.item[0] = appData.item[n]; \
    appData.item[n] = temp;

void SwapEngines(int n) {  /* swap settings for first engine and other engine (so far only some selected options) */
    int h;
    char * p;
    if (n == 0) {
        return;
...
int GetEngineLine(char * s, int n) {
    int i;
    char buf[MSG_SIZ];
...
int SetPlayer(int player, char * p) {  /* [HGM] find the engine line of the partcipant given by number, and parse its options. */
    int i;
    ...
    engineName = strdup(p);
    if (p = strchr(engineName, '\n')) {
        *p = NULLCHAR;
    }
    for (i = 1; command[i]; i++) {
        if (!strcmp(mnemonic[i], engineName)) {
            break;
        }
    }
    if (mnemonic[i]) {
        ...
        appData.protocolVersion[0] = PROTOVER;
        ParseArgsFromString(buf);
        ...
        matchMode = FALSE;
        appData.matchGames = matchGame = roundNr = 0;
        ModeHighlight();
        DisplayError(buf, 0);
        return 0;
    }
...
int Pairing(int nr, int nPlayers, int * whitePlayer, int * blackPlayer, int * syncInterval) {  /* determine players from game number */
    ...
    curCycle = nr / gamesPerCycle;
    nr %= gamesPerCycle;
    curRound = nr / gamesPerRound;
    nr %= gamesPerRound;
    curPairing = nr / appData.defaultMatchGames;
    nr %= appData.defaultMatchGames;
    ...
    if (appData.cycleSync) {
        *syncInterval = gamesPerCycle;
    }
    if (appData.roundSync) {
        *syncInterval = gamesPerRound;
    }

    if (appData.debugMode) {
        fprintf(debugFP, "cycle=%d, round=%d, pairing=%d curGame=%d\n", curCycle, curRound, curPairing, matchGame);
    }
    ...
    if (appData.tourneyType == 0) {
        if (curPairing == (nPlayers - 1) / 2) {
            ...
            *whitePlayer = curRound - (nPlayers - 1) / 2 + curPairing;
            if (*whitePlayer < 0) {
                *whitePlayer += nPlayers - 1 + (nPlayers & 1);
            }
            *blackPlayer = curRound + (nPlayers - 1) / 2 - curPairing;
            if (*blackPlayer >= nPlayers - 1 + (nPlayers & 1)) {
                *blackPlayer -= nPlayers - 1 + (nPlayers & 1);
            }
        }
...
int NextTourneyGame(
 int nr, int * swapColors) {  /* !!!major kludge!!! fiddle appData settings to get everything in order for next tourney game */
    char *p, *q;
    int whitePlayer, blackPlayer, firstBusy = 1000000000, syncInterval = 0, nPlayers, OK = 1;
    FILE * tf;
    if (appData.tourneyFile[0] == NULLCHAR) {
        return 1;  /* no tourney, always allow next game */
    }
    tf = fopen(appData.tourneyFile, "r");
    if (tf == NULL) {
        DisplayFatalError(_("Bad tournament file"), 0, 1);
        return 0;
    }
    ParseArgsFromFile(tf);
    fclose(tf);
    ...
    if (appData.tourneyType < 0) {
        ...
        *swapColors = 0;
        ...
        whitePlayer = savedWhitePlayer - 1;
        blackPlayer = savedBlackPlayer - 1;
        matchGame = 1;
        roundNr = nr / syncInterval + 1;
    }

    if (first.pr != NoProc && second.pr != NoProc || nr < 0) {
        return 1;  /* engines already loaded */
    }

    /* redefine engines, engine dir, etc. */
    NamesToList(firstChessProgramNames, command, mnemonic, "all");  /* get mnemonics of installed engines */
    if (first.pr == NoProc) {
        if (!SetPlayer(whitePlayer, appData.participants)) {
            OK = 0;  /* find white player amongst it, and parse its engine line */
        }
        InitEngine(&first, 0);  /* initialize ChessProgramStates based on new settings. */
    }
    if (second.pr == NoProc) {
        SwapEngines(1);
        if (!SetPlayer(blackPlayer, appData.participants)) {
            OK = 0;  /* find black player amongst it, and parse its engine line */
        }
    ...
    if (matchMode && appData.debugMode) {
        ...
        if (strcmp(buf, currentDebugFile)) {
            ...
            if (appData.serverFileName) {
                ...
                if (serverFP && first.pr != NoProc) {
                    fprintf(serverFP, "StartChildProcess (dir=\".\") .\\%s\n", first.tidy);
                }
                if (serverFP && second.pr != NoProc) {
                    fprintf(serverFP, "StartChildProcess (dir=\".\") .\\%s\n", second.tidy);
                }
            }
        }
...
int GameCheckSum(void) {
    ...
    if (i > 1 && sum == 0) {
        /* make sure never zero for non-empty game */
        sum++;
    }
...
void GameEnds(ChessMove result, char * resultDetails, int whosays) {
    ...
    if (endingGame) {
        return; /* [HGM] crash: forbid recursion */
    }
    endingGame = 1;
    if (twoBoards) {  /* [HGM] dual: switch back to one board */
        twoBoards = partnerUp = 0;
        InitDrawingSizes(-2, 0);
        /* observed game becomes foreground */
        DrawPosition(TRUE, partnerBoard);
    }
    if (appData.debugMode) {
    ...
    /* [HGM] abort any move the user is entering.  [HGM] lion */
    kill2Y = -1;
    kill2X = -1;
    killY = -1;
    killX = -1;
    ...
    if (pausing) {
        /* can happen when we abort a paused game (New Game or Quit) */
        PauseEvent();
    }

    if (appData.icsActive && (whosays == GE_ENGINE || whosays >= GE_ENGINE1)) {
        /* If we are playing on ICS, the server decides when the game is over, but the engine can offer to draw, claim a draw, or
        resign. */
#if ZIPPY
        if (appData.zippyPlay && first.initDone) {
    ...
    /* If this is an ICS game, only ICS can really say it's done;
       if not, anyone can. */
    isIcsGame =
     (gameMode == IcsPlayingWhite || gameMode == IcsPlayingBlack || gameMode == IcsObserving || gameMode == IcsExamining);
    ...
    if (!isIcsGame || whosays == GE_ICS) {
        ...
        if (gameMode == TwoMachinesPlay && appData.testClaims) {
            if (appData.testLegality && whosays >= GE_ENGINE1) {
                ...
                } else if ((signed char)boards[forwardMostMove][EP_STATUS] ==
                 EP_WINS) {  /* added code for games where being mated is a win */
                    /* [HGM] verify: engine mate claims accepted if they were flagged */
                    trueResult = WhiteOnMove(forwardMostMove) ? WhiteWins : BlackWins;
                } else if ((signed char)boards[forwardMostMove][EP_STATUS] == EP_STALEMATE) {  /* only used to indicate draws now */
                ...
                if ((gameInfo.holdingsWidth == 0 || gameInfo.variant == VariantSuper || gameInfo.variant == VariantGreat ||
                 ...
                 (result == WhiteWins && claimer == 'w' ||
                  result == BlackWins && claimer == 'b')) {  /* case to verify: engine claims own win */
                    if (appData.debugMode) {
                        fprintf(debugFP, "result=%d sp=%d move=%d\n", result, (signed char)boards[forwardMostMove][EP_STATUS],
                         forwardMostMove);
                    }
                ...
                } else if (result == GameIsDrawn && (signed char)boards[forwardMostMove][EP_STATUS] > EP_DRAWS &&
                 (forwardMostMove <= backwardMostMove || (signed char)boards[forwardMostMove - 1][EP_STATUS] > EP_DRAWS ||
                ...
                if (!*appData.tourneyFile) {
                    matchGame--;  /* replay even in plain match */
                }
            }
                 ...
                 lastSavedGame != GameCheckSum()  /* [HGM] save: suppress duplicates */
                    ...
                    if (*appData.saveGameFile != NULLCHAR) {
                        if (result == GameUnfinished && matchMode && *appData.tourneyFile) {
                            /* [HGM] protect tourney PGN from aborted games, and prompt for name instead */
                            AutoSaveGame();
                        } else {
                            SaveGameToFile(appData.saveGameFile, TRUE);
                        }
                    } else if (appData.autoSaveGames) {
                        if (gameMode != IcsObserving || !appData.onlyOwn) {
                            AutoSaveGame();
                        }
                    }
                    ...
                    /* Only does something during Monte-Carlo book building */
                    AddGameToBook(FALSE);
                }
            }

            /* Tell program how the game ended in case it is learning.

            [HGM] Moved this to after saving the PGN, just in case the engine died and we got here through time loss.  In that case,
            we will get a fatal error writing the pipe, which would otherwise lose us the PGN.

            [HGM] crash: not needed anymore, but doesn't hurt; output during GameEnds should never be fatal anymore. */
            if (gameMode == MachinePlaysWhite || gameMode == MachinePlaysBlack || gameMode == TwoMachinesPlay ||
             gameMode == IcsPlayingWhite || gameMode == IcsPlayingBlack || gameMode == BeginningOfGame) {
                char buf[MSG_SIZ];
                snprintf(buf, MSG_SIZ, "result %s {%s}\n", PGNResult(result), resultDetails);
                if (first.pr != NoProc) {
                    SendToProgram(buf, &first);
                }
                if (second.pr != NoProc && gameMode == TwoMachinesPlay) {
        ...
        if (appData.icsActive) {
            ...
            ics_user_moved = FALSE;
            /* Clean up premove.  It's ugly when the game has ended and the premove highlights are still on the board. */
            if (gotPremove) {
                gotPremove = FALSE;
                ClearPremoveHighlights();
                DrawPosition(FALSE, boards[currentMove]);
        ...
        } else if (gameMode == EditGame || gameMode == PlayFromGameFile || gameMode == AnalyzeMode || gameMode == AnalyzeFile) {
    ...
    if (matchMode && (gameMode == TwoMachinesPlay || (waitingForGame || startingEngine) && exiting)) {
        ...
        if (exiting) {
            resChar = ' ';  /* quit while waiting for round sync: unreserve already reserved game */
        }
        if (appData.tourneyFile[0]) {  /* [HGM] we are in a tourney; update tourney file with game result */
            if (appData.afterGame && appData.afterGame[0]) {
                RunCommand(appData.afterGame);
            }
            ReserveGame(nextGame, resChar);  /* sets nextGame */
            if (nextGame > appData.matchGames) {
                appData.tourneyFile[0] = 0, ranking = TourneyStandings(3);  /* tourney is done */
            } else {
                ranking = strdup("busy");  /* suppress popup when aborted but not finished */
            }
        } else {
            roundNr = nextGame = matchGame + 1;  /* normal match, just increment; round equals matchGame */
        }
        ...
        if (nextGame <= appData.matchGames && !abortMatch) {
            ...
            if (appData.epd) {
                snprintf(buf, MSG_SIZ, "-------------------------------------- ");
                OutputKibitz(2, buf);
                snprintf(buf, MSG_SIZ, _("Average solving time %4.2f sec (total time %4.2f sec) "),
                 totalTime / (100. * first.matchWins), totalTime / 100.);
                OutputKibitz(2, buf);
                snprintf(buf, MSG_SIZ, _("%d avoid-moves played "), second.matchWins);
                if (second.matchWins) {
                    OutputKibitz(2, buf);
                }
                snprintf(buf, MSG_SIZ, _("Solved %d out of %d (%3.1f%%) "), first.matchWins, nextGame - 1,
                 first.matchWins * 100. / (nextGame - 1));
                OutputKibitz(2, buf);
            }
            snprintf(buf, MSG_SIZ, _("Match %s vs. %s: final score %d-%d-%d"), first.tidy, second.tidy, first.matchWins,
             second.matchWins, appData.matchGames - (first.matchWins + second.matchWins));
            if (!appData.tourneyFile[0]) {
                matchGame++, DisplayTwoMachinesTitle();  /* [HGM] update result in window title */
            }
            if (ranking && strcmp(ranking, "busy") && appData.afterTourney && appData.afterTourney[0]) {
                RunCommand(appData.afterTourney);
            }
    ...
    if ((gameMode == AnalyzeMode || gameMode == AnalyzeFile) && !(nextGameMode == AnalyzeMode || nextGameMode == AnalyzeFile)) {
        ExitAnalyzeMode();
    }
    gameMode = nextGameMode;
    ModeHighlight();
    ...
    if (popupRequested) {  /* [HGM] crash: this calls GameEnds recursively through ExitEvent! Make it a harmless tail recursion. */
        if (matchMode == TRUE) {  /* match through command line: exit with or without popup */
            if (ranking) {
                ToNrEvent(forwardMostMove);
                if (strcmp(ranking, "busy")) {
                    DisplayFatalError(ranking, 0, 0);
                } else {
                    ExitEvent(0);
                }
            } else {
...
/* Assumes program was just initialized (initString sent).  Leaves program in force mode. */
void FeedMovesToProgram(ChessProgramState * cps, int upto) {
    int i;
    ...
    if (currentlyInitializedVariant != gameInfo.variant) {
        ...
        if (!SupportedVariant(cps->variants, gameInfo.variant, gameInfo.boardWidth, gameInfo.boardHeight, gameInfo.holdingsSize,
             cps->protocolVersion, "")) {
            /* [HGM] refrain from feeding moves altogether if variant is unsupported! */
            return;
        }
        snprintf(buf, MSG_SIZ, "variant %s\n", VariantName(gameInfo.variant));
        SendToProgram(buf, cps);
...
int ResurrectChessProgram(void) {
    ...
    if ((gameMode == AnalyzeMode || gameMode == AnalyzeFile || appData.icsEngineAnalyze) && first.analysisSupport) {
...
int AutoPlayOneMove(void) {
    ...
    if (gameMode == AnalyzeFile && currentMove > backwardMostMove && programStats.depth) {
        ...
        if (currentMove < forwardMostMove) {
            AppendComment(currentMove + 1, lastPV[0], 2);
...
int LoadGameOneMove(ChessMove readAhead) {
    ...
    if (gameMode != PlayFromGameFile && gameMode != AnalyzeFile && gameMode != AnalyzeMode && gameMode != Training) {
        gameFileFP = NULL;
        return FALSE;
    }
    ...
    case BlackASideCastleFR:
        ...
        if (appData.debugMode) {
            fprintf(debugFP, "Parsed %s into %s virgin=%x,%x\n", yy_text, currentMoveString, boards[forwardMostMove][TOUCHED_W],
             boards[forwardMostMove][TOUCHED_B]);
        }
        fromX = currentMoveString[0] - AAA;
        fromY = currentMoveString[1] - ONE;
        toX = currentMoveString[2] - AAA;
    ...
    case IllegalMove:
        if (appData.testLegality) {
            ...
            snprintf(move, MSG_SIZ, _("Illegal move: %d.%s%s"), (forwardMostMove / 2) + 1,
    ...
    case AmbiguousMove:
        ...
        snprintf(move, MSG_SIZ, _("Ambiguous move: %d.%s%s"), (forwardMostMove / 2) + 1, WhiteOnMove(forwardMostMove) ? " " : ".. ",
         yy_text);
        DisplayError(move, 0);
        done = TRUE;
        break;
    ...
    case ImpossibleMove:
        ...
        snprintf(
         move, MSG_SIZ, _("Illegal move: %d.%s%s"), (forwardMostMove / 2) + 1, WhiteOnMove(forwardMostMove) ? " " : ".. ", yy_text);
        DisplayError(move, 0);
        done = TRUE;
        break;
    }
...
int LoadGameFromFile(char * filename, int n, char * title, int useList) {
    ...
    if (useList && n == 0) {
        ...
        } else if (!ListEmpty(&gameList) && ((ListGame *)gameList.tailPred)->number > 1) {
...
void MakeRegisteredMove(void) {
    ...
    if (cmailMoveRegistered[lastLoadGameNumber - 1]) {
        ...
        case CMAIL_DRAW:
            ...
            thinkOutput[0] = NULLCHAR;
            safeStrCpy(moveList[currentMove], cmailMove[lastLoadGameNumber - 1],
             sizeof(moveList[currentMove]) / sizeof(moveList[currentMove][0]));
...
int CmailLoadGame(FILE * f, int gameNumber, char * title, int useList) {
    int retVal;
    ...
    if (cmailCommentList[lastLoadGameNumber - 1] != NULL) {
        commentList[currentMove] = StrSave(cmailCommentList[lastLoadGameNumber - 1]);
        DisplayComment(currentMove - 1, commentList[currentMove]);
    }
...
int ReloadGame(int offset) {
    ...
    if (cmailMsgLoaded) {
        return CmailLoadGame(lastLoadGameFP, gameNumber, lastLoadGameTitle, lastLoadGameUseList);
    } else {
        return LoadGame(lastLoadGameFP, gameNumber, lastLoadGameTitle, lastLoadGameUseList);
    }
}

int keys[EmptySquare + 1];

int PositionMatches(Board b1, Board b2) {
    int r, f, sum = 0;
    switch (appData.searchMode) {
    case 1:
        return CompareWithRights(b1, b2);
    case 2:
        for (r = 0; r < BOARD_HEIGHT; r++) {
            for (f = BOARD_LEFT; f < BOARD_RGHT; f++) {
                if (b2[r][f] != EmptySquare && b1[r][f] != b2[r][f]) {
                    return FALSE;
                }
            }
        }
    ...
    case 3:
        for (r = 0; r < BOARD_HEIGHT; r++) {
            for (f = BOARD_LEFT; f < BOARD_RGHT; f++) {
                if ((b2[r][f] == WhitePawn || b2[r][f] == BlackPawn) && b1[r][f] != b2[r][f]) {
                    return FALSE;
                }
...
/* gamble on that game will not be more than 500 moves */
Move initialSpace[DSIZE + 1000];
    ...
    for (r = 0; r < BOARD_HEIGHT; r++) {
        for (f = BOARD_LEFT; f < BOARD_RGHT; f++) {
            ...
            if (board[r][f] == EmptySquare) {
                ...
                counts[board[r][f]]++;
                if (board[r][f] == WhiteKing) {
                    pieceList[1] = n;
                } else if (board[r][f] == BlackKing) {
                    /* remember which are Kings, for castling */
                    pieceList[2] = n;
                }
                total++;
            }
...
void PackMove(int fromX, int fromY, int toX, int toY, ChessSquare promoPiece) {
    ...
    } else if (piece == pieceList[2] && fromY == toY) {
        if ((toX > fromX + 1 || toX < fromX - 1) && fromX != BOARD_LEFT && fromX != BOARD_RGHT - 1) {
    ...
    } else if (epOK && (pieceType[piece] == WhitePawn || pieceType[piece] == BlackPawn) && fromX != toX && quickBoard[sq] == 0) {
        quickBoard[(fromY << 4) + toX] = 0;
        moveDatabase[movePtr].piece = Q_EP;
        moveDatabase[movePtr++].to = (fromY << 4) + toX;
        moveDatabase[movePtr].to = sq;
    } else if (promoPiece != pieceType[piece]) {
...
int PackGame(Board board) {
    Move * newSpace = NULL;
    /* terminate previous game */
    moveDatabase[movePtr].piece = 0;
    if (movePtr > dataSize) {
        if (appData.debugMode) {
            fprintf(debugFP, "move-cache overflow, enlarge to %d MB\n", dataSize / 128);
        }
        /* increase size by factor 8 (512KB -> 4MB -> 32MB -> 256MB -> 2GB) */
        dataSize *= 8;
        if (dataSize) {
            newSpace = (Move *)calloc(dataSize + 1000, sizeof(Move));
        }
        if (newSpace) {
            int i;
            Move *p = moveDatabase, *q = newSpace;
            for (i = 0; i < movePtr; i++) {
                /* copy to newly allocated space */
                *q++ = *p++;
            }
            if (dataSize > 8 * DSIZE) {
                /* and free old space (if it was allocated) */
                free(moveDatabase);
            }
            moveDatabase = newSpace;
        } else {
            /* calloc failed, we must be out of memory. Too bad... */
            /* prevent calloc events for all subsequent games */
            dataSize = 0;
            /* and signal this one isn't cached */
            return 0;
        }
    }
    movePtr++;
...
int QuickCompare(Board board, int * minCounts, int * maxCounts) {
    ...
    case 1:
        ...
        if (!(turn & board[EP_STATUS - 1])) {
            /* wrong side to move */
            return FALSE;
        }
        for (r = 0; r < BOARD_HEIGHT; r++) {
            for (f = BOARD_LEFT; f < BOARD_RGHT; f++) {
                if (board[r][f] != pieceType[quickBoard[(r << 4) + f]]) {
                    return FALSE;
                }
            }
        }
        break;
    case 2:
        /* can have extra material on empty squares */
        for (r = 0; r < BOARD_HEIGHT; r++) {
            for (f = BOARD_LEFT; f < BOARD_RGHT; f++) {
                if (board[r][f] == EmptySquare) {
                    continue;
        ...
        break;
    case 3:
        /* material with exact pawn structure */
        for (r = 0; r < BOARD_HEIGHT; r++) {
            for (f = BOARD_LEFT; f < BOARD_RGHT; f++) {
                if (board[r][f] != WhitePawn && board[r][f] != BlackPawn) {
                    continue;
                }
                if (board[r][f] != pieceType[quickBoard[(r << 4) + f]]) {
                    return FALSE;
    ...
    case 4:
        ...
        break;
    case 6:
        /* material range with given imbalance */
        for (r = 0; r < BlackPawn; r++) {
            if (counts[r] - minCounts[r] != counts[r + BlackPawn] - minCounts[r + BlackPawn]) {
                return FALSE;
            }
        }
        /* Intentionally fall through. */
    case 5:
        /* material range */
        for (r = 0; r < EmptySquare; r++) {
            if (counts[r] < minCounts[r] || counts[r] > maxCounts[r]) {
                return FALSE;
            }
        }
    }
...
int QuickScan(Board board, Move * move) {
    ...
    int stretch = 0;
    int found = -1;
    int total = MakePieceList(board, counts);
    do {
        ...
        if (found < 0) {  /* if already found just scan to game end for final piece count */
            if (QuickCompare(soughtBoard, minSought, maxSought) ||
             ...
             flipSearch &&
              (QuickCompare(flipBoard, minSought, maxSought) ||
            ...
            if (stretch && (appData.searchMode == 1 || stretch >= appData.stretch)) {
                found = cnt + 1 - stretch;
            }
            if (found >= 0 && !appData.minPieces) {
                return found;
            }
        }
        if (piece <= Q_PROMO) {
            /* special moves encoded by otherwise invalid piece numbers 1-4 */
            if (!piece) {
                return (appData.minPieces && (total < appData.minPieces || total > appData.maxPieces) ? -1 : found);
            }
            if (piece == Q_PROMO) {
                /* promotion, encoded as (Q_PROMO, to) + (piece, promoType) */
                piece = (++move)->piece;
                ...
                /* e.p. capture, encoded as (Q_EP, ep-sqr) + (piece, to) */
                counts[pieceType[quickBoard[to]]]--;
                quickBoard[to] = 0;
                total--;
                move++;
                continue;
            } else if (piece <= Q_BCASTL) {
                /* castling, encoded as (Q_XCASTL, king-to) + (rook, rook-to) */
                /* first two elements of pieceList contain King numbers */
                piece = pieceList[piece];
                /* so this must be King */
                from = pieceList[piece];
                quickBoard[from] = 0;
                pieceList[piece] = to;
                /* for FRC this has to be done here */
                from = pieceList[(++move)->piece];
                /* rook */
                quickBoard[from] = 0;
                quickBoard[to] = piece;
                to = move->to;
        ...
        if (appData.searchMode > 2) {
            /* account capture */
            counts[pieceType[quickBoard[to]]]--;
        }
        if ((total -= (quickBoard[to] != 0)) < soughtTotal && found < 0) {
            /* piece count dropped below what we search for */
            return -1;
        }
        quickBoard[from] = 0;
aftercastle:
...
void InitSearch(void) {
    ...
    if (currentMove == 0 && gameMode == EditPosition) {
        soughtBoard[EP_STATUS - 1] = blackPlaysFirst + 1;  /* (!) */
    }
    ...
    for (r = 0; r < 6; r++) {
        reverseBoard[CASTLING][r] = boards[currentMove][CASTLING][(r + 3) % 6];
    }
    if (appData.findMirror && appData.searchMode <= 3 &&
     (!nrCastlingRights ||
    ...
    for (r = 0; r < BlackPawn; r++) {
        maxReverse[r] = maxSought[r + BlackPawn], maxReverse[r + BlackPawn] = maxSought[r];
    }
    if (appData.searchMode >= 5) {
        for (r = BOARD_HEIGHT / 2; r < BOARD_HEIGHT; r++) {
            for (f = BOARD_LEFT; f < BOARD_RGHT; f++) {
                soughtBoard[r][f] = EmptySquare;
            }
        }
        MakePieceList(soughtBoard, minSought);
        for (r = 0; r < BlackPawn; r++) {
            minReverse[r] = minSought[r + BlackPawn], minReverse[r + BlackPawn] = minSought[r];
        }
    }
...
int GameContainsPosition(FILE * f, ListGame * lg) {
    ...
    if (lg->gameInfo.variant != gameInfo.variant) {
        /* wrong variant */
        return -1;
    }
    if (appData.eloThreshold1 &&
     (lg->gameInfo.whiteRating < appData.eloThreshold1 && lg->gameInfo.blackRating < appData.eloThreshold1)) {
        return -1;
    }
    if (appData.eloThreshold2 &&
     (lg->gameInfo.whiteRating < appData.eloThreshold2 || lg->gameInfo.blackRating < appData.eloThreshold2)) {
        return -1;
    }
    if (appData.dateThreshold && (!lg->gameInfo.date || atoi(lg->gameInfo.date) < appData.dateThreshold)) {
        return -1;
    }
    if (!initDone) {
        for (next = WhitePawn; next < EmptySquare; next++) {
            keys[next] = random() >> 8 ^ random() << 6 ^ random() << 20;
        }
        initDone = TRUE;
    }
    if (lg->gameInfo.fen) {
        ParseFEN(boards[scratch], &btm, lg->gameInfo.fen, FALSE);
    } else {
        /* default start position */
        CopyBoard(boards[scratch], initialPosition);
    }
    if (lg->moves) {
        turn = btm + 1;
        if ((next = QuickScan(boards[scratch], &moveDatabase[lg->moves])) < 0) {
            /* quick scan rules out it is there */
            return -1;
        }
        if (appData.searchMode >= 4) {
            /* for material searches, trust QuickScan. */
            return next;
        }
    }
    if (btm) {
    ...
    if (PositionMatches(boards[scratch], boards[currentMove])) {
        return plyNr;
    }
    fseek(f, lg->offset, 0);
    yynewfile(f);
    while (1) {
        ...
        case PGNTag:
            if (plyNr) {
                /* After we have seen moves, any tags will be start of next game. */
                return -1;
            }
        default:
            continue;
        ...
        case GNUChessGame:
            if (plyNr) {
                /* After we have seen moves, this is for a new game. */
                return -1;
            }
            continue;

        /* We cannot reconstruct the game beyond with these next two. */
        case AmbiguousMove:
        case ImpossibleMove:
        /* The game ends here with these next four. */
        case WhiteWins:
        case BlackWins:
        case GameIsDrawn:
        case GameUnfinished:
        ...
        case BlackDrop:
            fromX =
             next == WhiteDrop ? (int)CharToPiece(ToUpper(currentMoveString[0])) : (int)CharToPiece(ToLower(currentMoveString[0]));
            fromY = DROP_RANK;
            toX = currentMoveString[2] - AAA;
            toY = currentMoveString[3] - ONE;
            promoChar = 0;
        ...
        /* Move encountered: perform it.  We need to shuttle between two boards, because even/odd index determines side to move. */
        plyNr++;
        ApplyMove(fromX, fromY, toX, toY, promoChar, boards[scratch]);
        if (PositionMatches(boards[scratch], boards[currentMove])) {
            return plyNr;
        }
        if (appData.ignoreColors && PositionMatches(boards[scratch], reverseBoard)) {
            return plyNr;
        }
        if (appData.findMirror) {
            if (PositionMatches(boards[scratch], flipBoard)) {
                return plyNr;
            }
            if (appData.ignoreColors && PositionMatches(boards[scratch], rotateBoard)) {
                return plyNr;
            }
        }
    }
...
int LoadGame(FILE * f, int gameNumber, char * title, int useList) {
    ChessMove cm;
    char buf[MSG_SIZ];
    int gn = gameNumber;
    ListGame * lg = NULL;
    ...
    if (useList) {
        ...
        GameListDestroy();
        if (fseek(f, 0, 0) == -1) {
            if (f == lastLoadGameFP ? gameNumber == lastLoadGameNumber + 1 : gameNumber == 1) {
                gn = 1;
            } else {
    ...
    if (lg && lg->gameInfo.white && lg->gameInfo.black) {
        snprintf(buf, sizeof(buf), "%s %s %s", lg->gameInfo.white, _("vs."), lg->gameInfo.black);
        DisplayTitle(buf);
    ...
    /* Skip the first gn-1 games in the file.  Also skip over anything that precedes an identifiable start of game marker, to avoid
    being confused by garbage at the start of the file.  Currently recognized start of game markers are the move number "1", the
    pattern "gnuchess .* game", the pattern "^[#;%] [^ ]* game file", and a PGN tag block.  A game that starts with one of the
    latter two patterns will also have a move number 1, possibly following a position diagram.

    5-4-02: Let's try being more lenient and allowing a game to start with an unnumbered move.  Does that break anything? */
    ...
    while (gn > 0) {
        ...
        case GameIsDrawn:
            if (cmailMsgLoaded && (CMAIL_MAX_GAMES == lastLoadGameNumber)) {
                if (cmailResult[CMAIL_MAX_GAMES - gn - 1] != CMAIL_OLD_RESULT) {
                    nCmailResults++;
                    cmailResult[CMAIL_MAX_GAMES - gn - 1] = CMAIL_OLD_RESULT;
                }
            }
            break;
        ...
        case NormalMove:
        case FirstLeg:
            /* Only a NormalMove can be at the start of a game without a position diagram. */
    ...
    if (cm == XBoardGame) {
        ...
        for (;;) {
            ...
            if (cm == EndOfFile || cm == GNUChessGame || cm == XBoardGame) {
                /* Empty game; pretend end-of-file and handle later */
                cm = EndOfFile;
                break;
            }

            if (cm == MoveNumberOne || cm == PositionDiagram || cm == PGNTag || cm == Comment) {
                break;
            }
        }
    ...
    if ((cm == EndOfFile && lastLoadGameStart != EndOfFile) || cm == WhiteWins || cm == BlackWins || cm == GameIsDrawn ||
     cm == GameUnfinished) {
    ...
    /* if the first token after the PGN tags is a move and not move number 1, retrieve it from the parser. */
    if (cm != MoveNumberOne) {
        LoadGameOneMove(cm);
    }
...
int ReloadPosition(int offset) {
    ...
    return LoadPosition(lastLoadPositionFP, positionNumber, lastLoadPositionTitle);
}
...
int LoadPosition(FILE * f, int positionNumber, char * title) {
    char *p, line[MSG_SIZ];
    Board initial_position;
    int i, j, fenMode, pn;
    ...
    if (positionNumber < 0) {
        ...
        if (fseek(f, 0, 0) == -1) {
            if (f == lastLoadPositionFP ? positionNumber == lastLoadPositionNumber + 1 : positionNumber == 1) {
                pn = 1;
            } else {
                DisplayError(_("Can't seek on position file"), 0);
                return FALSE;
    ...
    /* [HGM] FEN can begin with digit, any piece letter valid in this variant, or a + for Shogi promoted pieces (or * for
    blackout). */
    ...
    if (appData.debugMode) {
        ...
        for (i = 0; i < 2; i++) {
            for (j = 0; j < 6; j++) {
                fprintf(debugFP, " %d", boards[i][CASTLING][j]);
            }
            fprintf(debugFP, "\n");
        }
        for (j = 0; j < 6; j++) {
            fprintf(debugFP, " %d", initialRights[j]);
        }
        fprintf(debugFP, "\n");
...
void CopyPlayerNameIntoFileName(char ** dest, char * src) {
...
void GetOutOfBookInfo(char * buf) {
    int oob[2];
    int i;
    /* output move numbers start at 1 */
    int offset = backwardMostMove & (~1l);
    ...
    if (oob[0] >= 0 || oob[1] >= 0) {
        for (i = 0; i < 2; i++) {
            ...
            if (idx >= 0) {
                ...
                sprintf(buf + strlen(buf), "%s%.2f", pvInfoList[idx].score >= 0 ? "+" : "", pvInfoList[idx].score / 100.0);
            }
        }
    }
}
...
static void SaveGamePGN2(FILE * f) {
    ...
    /* [AS] Buffer for move+PV info */
    char move_buffer[100];

    /* output move numbers start at 1 */
    offset = backwardMostMove & (~1l);

    PrintPGNTags(f, &gameInfo);

    if (appData.numberTag && matchMode) {
        /* [HGM] number tag */
        fprintf(f, "[Number \"%d\"]\n", nextGame + 1);
    }
...
int SaveGameOldStyle(FILE * f) {
    ...
    if (gameInfo.resultDetails != NULL && gameInfo.resultDetails[0] != NULLCHAR) {
        fprintf(f, "%s (%s)\n\n", PGNResult(gameInfo.result), gameInfo.resultDetails);
    } else {
        fprintf(f, "%s\n\n", PGNResult(gameInfo.result));
    }
...
/* TODO: Re-evaluate the utility of Cmail as it relates to builds for Windows.  ReloadCmailMsgEvent, MailMoveEvent, and CMailMsg
...
void ReloadCmailMsgEvent(int unregister) {
    ...
    /* Any registered moves are unregistered if unregister is set, i.e. invoked by the signal handler. */
    if (unregister) {
    ...
    if (inFilename == NULL) {
        /* Because the filenames are static they only get malloced once and they never get freed. */
    ...
    /* LoadGameFromFile(CMAIL_MAX_GAMES) with cmailMsgLoaded == TRUE counts the games, notes how each one terminated, etc.

    It would be nice to remove this kludge and instead gather all the information while building the game list.  (And to keep it in
    the game list nodes instead of having a bunch of fixed-size parallel arrays.)  Note this will require getting each game's
    termination from the PGN tags, as the game list builder does not process the game moves.  --mann */
    cmailMsgLoaded = TRUE;
...
int RegisterMove(void) {
    ...
    if (cmailMailedMove || (cmailResult[lastLoadGameNumber - 1] == CMAIL_OLD_RESULT)) {
        /* Allow free viewing. */
        return TRUE;
    }
    ...
    if ((currentMove == cmailOldMove + 1) ||
     ((currentMove == cmailOldMove) &&
      ((cmailMoveType[lastLoadGameNumber - 1] == CMAIL_ACCEPT) || (cmailMoveType[lastLoadGameNumber - 1] == CMAIL_RESIGN)))) {
        if (gameInfo.result != GameUnfinished) {
            cmailResult[lastLoadGameNumber - 1] = CMAIL_NEW_RESULT;
        }

        if (commentList[currentMove] != NULL) {
            cmailCommentList[lastLoadGameNumber - 1] = StrSave(commentList[currentMove]);
        }
        safeStrCpy(cmailMove[lastLoadGameNumber - 1], moveList[currentMove - 1],
         sizeof(cmailMove[lastLoadGameNumber - 1]) / sizeof(cmailMove[lastLoadGameNumber - 1][0]));
...
# endif
    ...
    if (!(cmailMailedMove || RegisterMove())) {
        return;
    }

    if (cmailMailedMove || (nCmailMovesRegistered + nCmailResults == nCmailGames)) {
        snprintf(string, MSG_SIZ, partCommandString, appData.debugMode ? " -v" : "", appData.cmailGameName);
        ...
        if (commandOutput == NULL) {
            ...
            *(msg + nBytes) = '\0'; /* \0 for end-of-string*/
            ...
            if (StrStr(msg, "Mailed cmail message to ") != NULL) {
                ...
                if (archived && ((arcDir = (char *)getenv("CMAIL_ARCDIR")) != NULL)) {
                    snprintf(buffer, MSG_SIZ, "%s/%s.%s.archive", arcDir, appData.cmailGameName, gameInfo.date);
...
char * CmailMsg(void) {
    ...
    if (cmailMailedMove) {
        ...
        for (i = 0; i < nCmailGames; i++) {
            if (!(cmailMoveRegistered[i] || (cmailResult[i] == CMAIL_OLD_RESULT))) {
                if (prependComma) {
...
void ExitEvent(int status) {
    ...
    if (endingGame) {
        int count = 0;
        if (appData.debugMode) {
            fprintf(debugFP, "ExitEvent() during GameEnds(), wait\n");
        }
        while (endingGame && count++ < 10) {
            DoSleep(1);
        }
        if (appData.debugMode && endingGame) {
            fprintf(debugFP, "GameEnds() seems stuck, proceed exiting\n");
        }
    }
...
void UnPauseEngine(ChessProgramState * cps) {
...
void PauseEvent(void) {
    ...
    if (pausing) {
        ...
        if (gameMode == MachinePlaysWhite || gameMode == TwoMachinesPlay || gameMode == MachinePlaysBlack) {
            ...
            if (second.pause) {
                UnPauseEngine(&second);
            } else if (gameMode == TwoMachinesPlay && appData.ponderNextMove) {
                SendToProgram("hard\n", &second);
            }
            StartClocks();
        } else {
            if (jawsClock && gameMode == EditGame) {
                StartClocks();
            }
            DisplayBothClocks();
        }
...
void EditCommentEvent(void) {
    ...
    if (currentMove < 1 || parseList[currentMove - 1][0] == NULLCHAR) {
        ...
        snprintf(title, MSG_SIZ, _("Edit comment on %d.%s%s"), (currentMove - 1) / 2 + 1,
         WhiteOnMove(currentMove - 1) ? " " : ".. ", parseList[currentMove - 1]);
    }
...
void StartSecond(void) {
    if (WaitForEngine(&second, StartSecond)) {
        return;
    }
...
void MachineWhiteEvent(void) {
    ...
    if (gameMode == PlayFromGameFile || gameMode == TwoMachinesPlay || gameMode == Training || gameMode == AnalyzeMode ||
     gameMode == EndOfGame) {
        EditGameEvent();
    }
    ...
    if (gameMode == EditGame || gameMode == AnalyzeMode || gameMode == AnalyzeFile) {
        TruncateGame();
    }
...
void DisplayTwoMachinesTitle(void) {
    ...
    if (appData.matchGames > 0) {
        if (appData.tourneyFile[0]) {
            snprintf(buf, MSG_SIZ, "%s %s %s (%d/%d%s)", gameInfo.white, _("vs."), gameInfo.black, nextGame + 1,
             appData.matchGames + 1,
             appData.tourneyType > 0    ? "gt"
              : appData.tourneyType < 0 ? "sw"
                                        : "rr");
        } else if (first.twoMachinesColor[0] == 'w') {
            snprintf(buf, MSG_SIZ, "%s %s %s (%d-%d-%d)", gameInfo.white, _("vs."), gameInfo.black, first.matchWins,
             second.matchWins, matchGame - 1 - (first.matchWins + second.matchWins));
        } else {
            snprintf(buf, MSG_SIZ, "%s %s %s (%d-%d-%d)", gameInfo.white, _("vs."), gameInfo.black, second.matchWins,
             first.matchWins, matchGame - 1 - (first.matchWins + second.matchWins));
        }
    } else {
        snprintf(buf, MSG_SIZ, "%s %s %s", gameInfo.white, _("vs."), gameInfo.black);
    }
...
int WaitForEngine(ChessProgramState * cps, DelayedEventCallback retry) {
    char buf[MSG_SIZ];
    if (cps->pr == NoProc) {
...
void TwoMachinesEvent(void) {
    ...
    /*forwardMostMove = currentMove;*/
    /* [HGM] vari: MachineWhite and MachineBlack do this... */
    TruncateGame();
    startingEngine = TRUE;

    if (!ResurrectChessProgram()) {
        /* in case first program isn't running (unbalances its ping due to InitChessProgram!) */
        return;
    }

    if (!first.initDone && GetDelayedEvent() == TwoMachinesEventIfReady) {
        /* [HGM] engine #1 still waiting for feature timeout */
        return;
    }
    /* [HGM] wait till we are sure first engine has set up position */
    if (first.lastPing != first.lastPong) {
        ScheduleDelayedEvent(TwoMachinesEventIfReady, 10);
        return;
    }
    if (!appData.epd) {
        if (WaitForEngine(&second, TwoMachinesEventIfReady)) {
            /* (if needed:) started up second engine, so wait for features */
            return;
        }

        if (!SupportedVariant(second.variants, gameInfo.variant, gameInfo.boardWidth, gameInfo.boardHeight, gameInfo.holdingsSize,
             second.protocolVersion, second.tidy)) {
            startingEngine = matchMode = FALSE;
            DisplayError("second engine does not play this", 0);
            gameMode = TwoMachinesPlay;
            /* Needed to make sure menu item is unchecked */
            ModeHighlight();
            /* switch back to EditGame mode */
            EditGameEvent();
            return;
        }

        if (!stalling) {
            /* unbalances ping of second engine */
            InitChessProgram(&second, FALSE);
            SendToProgram("force\n", &second);
            stalling = 1;
            ScheduleDelayedEvent(TwoMachinesEventIfReady, 10);
    ...
    /* [HGM] matchpause: implement match pause after engine load */
    GetTimeMark(&now);
    if (appData.matchPause > 10000 || appData.matchPause < 10) {
        /* [HGM] make pause adjustable */
    ...
    pausing = FALSE;
    /* [HGM] logo: this triggers display update of logos */
    ModeHighlight();
    SetGameInfo();
    ...
    if (appData.debugMode) {
        fprintf(debugFP, "New game (%d): %s-%s (%c)\n", matchGame, first.tidy, second.tidy, first.twoMachinesColor[0]);
    }
    ...
    if (!first.sendTime || !second.sendTime || move == 0) {
        /* [HGM] first engine changed sides from Reset, so recalc time odds */
        ResetClocks();
        timeRemaining[0][forwardMostMove] = whiteTimeRemaining;
        timeRemaining[1][forwardMostMove] = blackTimeRemaining;
    }
    if (onmove->sendTime) {
        if (onmove->useColors) {
            /*gnu kludge*/
            SendToProgram(onmove->other->twoMachinesColor, onmove);
        }
    ...
    /* [HGM] book: send go or retrieve book move */
    bookHit = SendMoveToBookUser(forwardMostMove - 1, onmove, TRUE);
    /* SendToProgram("go\n", onmove); */
...
void EditGameEvent(void) {
    ...
    if (gameMode == MachinePlaysWhite || gameMode == MachinePlaysBlack || gameMode == TwoMachinesPlay || gameMode == EndOfGame) {
        i = forwardMostMove;
        while (i > currentMove) {
            SendToProgram("undo\n", &first);
            i--;
...
void DisplayClockMessage(char * msg) {
    if (!msg) {
...
void EditPositionDone(Boolean fakeRights) {
    ...
    if (fakeRights) {  /* [HGM] suppress this if we just pasted a FEN. */
        ...
        for (f = 0; f <= 6; f++) {
            boards[0][CASTLING][f] = NoRights;
        }
        for (r = BOARD_HEIGHT - 1; r >= 0; r--) {
            for (f = BOARD_RGHT - 1; f >= BOARD_LEFT; f--) {  /* first pass: Kings & e.p. */
                if (rightsBoard[r][f]) {
                    ChessSquare p = boards[0][r][f];
                    if (p == (blackPlaysFirst ? WhitePawn : BlackPawn)) {
                        boards[0][EP_STATUS] = f;
                    } else if (p == king) {
                        boards[0][CASTLING][2] = f;
                    } else if (p == WHITE_TO_BLACK king) {
                        boards[0][CASTLING][5] = f;
                    } else {
                        rightsBoard[r][f] = 2;  /* mark for second pass */
                    }
                }
            }
        }
        for (r = BOARD_HEIGHT - 1; r >= 0; r--) {
            for (f = BOARD_RGHT - 1; f >= BOARD_LEFT; f--) {  /* second pass: Rooks */
                if (rightsBoard[r][f] == 2) {
                    ChessSquare p = boards[0][r][f];
                    if (p == WhiteRook) {
                        boards[0][CASTLING][(f < boards[0][CASTLING][2])] = f;
                    } else if (p == BlackRook) {
                        boards[0][CASTLING][(f < boards[0][CASTLING][5]) + 3] = f;
                    }
                }
            }
        }
...
/* !! Ugh, this is a kludge. Fix it sometime. --tpm */
void SendMultiLineToICS(char * buf) {
...
void SetWhiteToPlayEvent(void) {
    if (gameMode == EditPosition) {
        blackPlaysFirst = FALSE;
        /* works because currentMove is 0 */
        DisplayBothClocks();
...
void EditPositionMenuEvent(ChessSquare selection, int x, int y) {
                ...
                for (r = 0; r < BOARD_HEIGHT; r++) {
                    for (x = BOARD_LEFT; x < BOARD_RGHT; x++) {
                        ...
                        for (y = x + 1; y < BOARD_RGHT; y++) {
                            if (menuBoard[r][y] == p) {
                                menuBoard[r][y] = EmptySquare;
                            }
                        }
                    }
                }
                menuBoard[CASTLING][0] = NoRights;
                menuBoard[CASTLING][3] = NoRights;
                /* h-side Rook was deleted */
                switch (clearCycle++) {
                case 0:
                ...
                case 1:
                    ...
                    for (r = 0; r < BOARD_HEIGHT; r++) {
                        ...
                        for (x = 0; x < BOARD_WIDTH; x++) {
                            ...
                            if ((x < BOARD_WIDTH / 2 - 2 || x >= BOARD_WIDTH / 2 + 2 || r < BOARD_HEIGHT / 2 - 2 ||
                                 r >= BOARD_HEIGHT / 2 + 2) &&
                             boards[0][r][x] != king && boards[0][r][x] != king + BlackPawn && boards[0][r][x] != DarkSquare &&
                             boards[0][r][x] != p) {
    ...
    case EmptySquare:
        if (gameMode == IcsExamining) {
            ...
            if (x < BOARD_LEFT || x >= BOARD_RGHT) {
                if (x == BOARD_LEFT - 2) {
                    if (y < handSize - 1 - gameInfo.holdingsSize) {
                        break;
                    }
                    boards[0][y][1] = 0;
                } else if (x == BOARD_RGHT + 1) {
                    if (y >= gameInfo.holdingsSize) {
                        break;
                    }
    ...
    case PromotePiece:
        if (piece >= (int)WhitePawn && piece < (int)WhiteMan || piece >= (int)BlackPawn && piece < (int)BlackMan) {
    ...
    case DemotePiece:
        if (piece > (int)WhiteMan && piece <= (int)WhiteKing || piece > (int)BlackMan && piece <= (int)BlackKing) {
    ...
    case WhiteQueen:
    case BlackQueen:
        if (gameInfo.variant == VariantShatranj || gameInfo.variant == VariantXiangqi || gameInfo.variant == VariantJanggi ||
         gameInfo.variant == VariantCourier || gameInfo.variant == VariantASEAN || gameInfo.variant == VariantMakruk) {
    ...
    case WhiteRook:
        ...
        /* Intentionally fall through. */
    case BlackRook:
        if (y == baseRank && (x == BOARD_LEFT || x == BOARD_RGHT - 1 || appData.fischerCastling)) {
            hasRights = 1;
        }
...
defaultlabel:
        if (gameMode == IcsExamining) {
            ...
            snprintf(buf, MSG_SIZ, "%s%c@%c%c\n", ics_prefix, PieceToChar(selection), AAA + x, ONE + y);
            SendToICS(buf);
        } else {
...
void DropMenuEvent(ChessSquare selection, int x, int y) {
    ...
    if (moveType == BlackDrop && selection < BlackPawn) {
        selection = (ChessSquare)((int)selection + (int)BlackPawn - (int)WhitePawn);
    }
    if (boards[currentMove][y][x] != EmptySquare) {
...
void AcceptEvent(void) {
    ...
    if (appData.icsActive) {
        ...
        if (currentMove == cmailOldMove && commentList[cmailOldMove] != NULL &&
         StrStr(commentList[cmailOldMove], WhiteOnMove(cmailOldMove) ? "Black offers a draw" : "White offers a draw")) {
            TruncateGame();
            GameEnds(GameIsDrawn, "Draw agreed", GE_PLAYER);
...
void CallFlagEvent(void) {
    ...
    if (appData.icsActive) {
        ...
        case MachinePlaysWhite:
            if (whiteFlag) {
                if (blackFlag) {
                    GameEnds(GameIsDrawn, "Both players ran out of time", GE_PLAYER);
                } else {
...
void ClockClick(int which) {  /* [HGM] code moved to back-end from winboard.c */
    if (which) {
        /* black clock */
        if (gameMode == EditPosition || gameMode == IcsExamining) {
            if (blackPlaysFirst) {
                ...
                EditPositionMenuEvent(BlackPlay, 0, 0);
            }
        } else if ((gameMode == AnalyzeMode || gameMode == EditGame || gameMode == BeginningOfGame ||
                    gameMode == MachinePlaysBlack && PosFlags(0) & F_NULL_MOVE && !blackFlag && !shiftKey) &&
         WhiteOnMove(currentMove)) {
            /* [HGM] multi-move: if not out of time, enters null move */
            UserMoveEvent((int)EmptySquare, DROP_RANK, 0, 0, 0);
        } else if (shiftKey) {
            AdjustClock(which, -1);
        ...
        if (gameMode == EditPosition || gameMode == IcsExamining) {
            if (!blackPlaysFirst) {
                ...
                EditPositionMenuEvent(WhitePlay, 0, 0);
            }
        } else if ((gameMode == AnalyzeMode || gameMode == EditGame ||
                    gameMode == MachinePlaysWhite && PosFlags(0) & F_NULL_MOVE && !whiteFlag && !shiftKey) &&
         !WhiteOnMove(currentMove)) {
            /* [HGM] multi-move */
            UserMoveEvent((int)EmptySquare, DROP_RANK, 0, 0, 0);
        } else if (shiftKey) {
...
void DrawEvent(void) {
    ...
    if (appData.icsActive) {
        /* Note: tournament rules require draw offers to be made after you make your move but before you punch your clock.
        Currently ICS doesn't let you do that; instead, you immediately punch your clock after making a move, but you can offer a
        draw at any time. */

        SendToICS(ics_prefix);
        SendToICS("draw\n");
        /* [HGM] drawclaim: also set flag in ICS play */
        ...
        if (currentMove == cmailOldMove && commentList[cmailOldMove] != NULL &&
         StrStr(commentList[cmailOldMove], WhiteOnMove(cmailOldMove) ? "Black offers a draw" : "White offers a draw")) {
            ...
            char * offer = WhiteOnMove(cmailOldMove) ? "White offers a draw" : "Black offers a draw";
...
void ForwardInner(int target) {
    int limit;
    int oldSeekGraphUp = seekGraphUp;
    ...
    seekGraphUp = FALSE;
    MarkTargetSquares(1);
    /* [HGM] abort any move entry in progress. */
    kill2Y = -1;
    kill2X = -1;
    killY = -1;
    killX = -1;
    ...
    if (gameMode == EditGame || gameMode == AnalyzeMode || gameMode == Training || gameMode == PlayFromGameFile ||
     gameMode == AnalyzeFile) {
        while (currentMove < target) {
            if (second.analyzing) {
                SendMoveToProgram(currentMove, &second);
            }
            SendMoveToProgram(currentMove++, &first);
        }
    } else {
...
void ToEndEvent(void) {
    if (gameMode == AnalyzeMode || gameMode == AnalyzeFile) {
        /* To optimize, we temporarily turn off analysis mode while we feed the remaining moves to the engine.  Otherwise, we would
        get analysis output after each move. */
        if (first.analysisSupport) {
            SendToProgram("exit\nforce\n", &first);
...
void BackwardInner(int target) {
    /* [AS] Was FALSE, had to change it! */
    int full_redraw = TRUE;
    ...
    if (gameMode == EditGame || gameMode == AnalyzeMode || gameMode == PlayFromGameFile || gameMode == AnalyzeFile) {
        while (currentMove > target) {
            if (moveList[currentMove - 1][1] == '@' && moveList[currentMove - 1][0] == '@') {
                ...
                int i;
                /* seek back to start or previous null move */
                for (i = target; i > backwardMostMove; i--) {
                    if (moveList[i - 1][1] == '@' && moveList[i - 1][0] == '@') {
                        break;
                    }
                }
                SendBoard(&first, i);
...
void ToStartEvent(void) {
    if (gameMode == AnalyzeMode || gameMode == AnalyzeFile) {
        /* To optimize, we temporarily turn off analysis mode while we undo all the moves.  Otherwise, we would get analysis output
        after each undo. */
        if (first.analysisSupport) {
            SendToProgram("exit\nforce\n", &first);
            first.analyzing = FALSE;
...
void ToNrEvent(int to) {
    ...
    if (to >= forwardMostMove) {
        to = forwardMostMove;
    }
    if (to <= backwardMostMove) {
        to = backwardMostMove;
    }
    if (to < currentMove) {
        BackwardInner(to);
...
void RevertEvent(Boolean annotate) {
    /* [HGM] vari: restore old game tail */
    if (PopTail(annotate)) {
        return;
    }
    if (gameMode != IcsExamining) {
...
void RetractMoveEvent(void) {
    ...
    case MachinePlaysBlack:
        ...
        /*!! could figure this out*/
        ClearHighlights();
        /* [AS] Changed to full redraw! */
        DrawPosition(TRUE, boards[currentMove]);
        SendToProgram("remove\n", &first);
        /* GNU Chess does not ponder here. */
        /*first.maybeThinking = TRUE;*/
        break;
...
void MoveNowEvent(void) {
    ...
    case MachinePlaysBlack:
        ...
        break;
    case TwoMachinesPlay:
        if (WhiteOnMove(forwardMostMove) == (first.twoMachinesColor[0] == 'w')) {
            cps = &first;
        } else {
            cps = &second;
        }
...
void TruncateGame(void) {
    /* [HGM] vari: only keep current variation if we explicitly truncate */
    CleanupTail();
    if (forwardMostMove > currentMove) {
        if (gameInfo.resultDetails != NULL) {
            free(gameInfo.resultDetails);
...
int SaveSelected(FILE * g, int dummy, char * dummy2) {
    ...
    /* suppresses stuff during load game */
    creatingBook = TRUE;
...
void TidyProgramName(char * prog, char * host, char buf[MSG_SIZ]) {
    char *p, *q, c;
...
void SetGameInfo(void) {
    ...
    /* [HGM] vari: do not erase result on EditGame */
    if (gameMode == EditGame) {
        r = gameInfo.result;
...
void ReplaceComment(int index, char * text) {
    ...
    if (index && sscanf(text, "%f/%d", &score, &len) == 2 && pvInfoList[index - 1].depth == len &&
     fabs(pvInfoList[index - 1].score - score * 100.) < 0.5 && (p = strchr(text, '\n'))) {
        /* [HGM] strip off first line with PV info, if any */
        text = p;
    }
    while (*text == '\n') {
        text++;
     ...
     *text == '(' && strchr(text, ')')) {  /* (perhaps check if this parses as comment-only?) */
        ...
        while (p = strchr(commentList[index], '}')) {
            /* kill all } to make it one comment */
            *p = ')';
        }
...
void AppendComment(int index, char * text, Boolean addBraces)
{
    ...
    if (appData.debugMode) {
        fprintf(debugFP, "Append: in='%s' %d\n", text, addBraces);
    }
    if (addBraces == 3) {
        addBraces = 0;
    } else {
        /* force appending literally */
        /* [HGM] PV time: strip PV info from comment */
        text = GetInfoFromComment(index, text);
    }
    ...
    if (commentList[index] != NULL) {
        ...
        /* might waste 4 */
        commentList[index] = (char *)malloc(oldlen + len + 6);
        ...
        if (addClosingBrace) {
            strcat(commentList[index], addClosingBrace == 2 ? ")\n" : "\n}\n");
        } else {
            strcat(commentList[index], "\n");
        }
    } else {
...
char * GetInfoFromComment(int index, char * text) {
    ...
    if (text != NULL && index > 0) {
...
#else
        /* [HGM] this code is not finished, and could actually be detrimental */
        if (0) {
#endif
            /* New style */
            char delim;
            ...
            if (*text != '{') {
                /* [HGM] braces: must be normal comment */
                return text;
            }
            ...
            p = text;
            if (!strncmp(p + 1, "final score ", 12)) {
                p += 12, index++;
            } else if (p[1] == '(') {
                /* comment starts with PV */
                /* locate end of PV */
                p = strchr(p, ')');
                if (p == NULL || sep < p + 5) {
                    return text;
        ...
        /* centi-sec */
        pvInfoList[index - 1].time = 10 * time;
        if (*sep == '}') {
            *sep = 0;
        } else {
            *--sep = '{';
...
void SendToProgram(char * message, ChessProgramState * cps) {
    ...
    if (appData.debugMode) {
        TimeMark now;
        GetTimeMark(&now);
        fprintf(debugFP, "%ld >%-6s: %s", SubtractTimeMarks(&now, &programStartTime), cps->which, message);
        if (serverFP) {
            fprintf(serverFP, "%ld >%-6s: %s", SubtractTimeMarks(&now, &programStartTime), cps->which, message), fflush(serverFP);
        }
    }

    count = strlen(message);
    outCount = OutputToProcess(cps->pr, message, count, &error);
    if (outCount < count && !exiting && !endingGame) {
        /* [HGM] crash: to not hang GameEnds() writing to deceased engines */
        if (!cps->initDone) {
            /* [HGM] should not generate fatal error during engine load */
            return;
        }
        snprintf(buf, MSG_SIZ, _("Error writing to %s chess program"), _(cps->which));
        if (gameInfo.resultDetails == NULL) {
            /* [HGM] crash: if game in progress, give reason for abort */
        ...
        if (!cps->userError || !appData.popupExitMessage) {
...
void ReceiveFromProgram(InputSourceRef isr, void * closure, char * message, int count, int error) {
    char * end_str;
    char buf[MSG_SIZ];
    ...
    if (count <= 0) {
        if (count == 0) {
            ...
            if (LoadError(cps->userError ? NULL : buf, cps)) {
                /* [HGM] should not generate fatal error during engine load */
                return;
            }
            if (gameInfo.resultDetails == NULL) {
            ...
            snprintf(buf, MSG_SIZ, _("Error reading from %s chess program (%s)"), _(cps->which), cps->program);
            RemoveInputSource(cps->isr);
    ...
    if (appData.debugMode) {
        ...
        /* [HGM] debug: decide if protocol-violating output is written */
        if (appData.engineComments != 1) {
            char start = message[0];
            if (start >= 'A' && start <= 'Z') {
                /* be tolerant to capitalizing */
                start += 'a' - 'A';
            }
            if (sscanf(message, "%d%c%d%d%d", &i, &c, &i, &i, &i) != 5 && sscanf(message, "move %c", &c) != 1 &&
             sscanf(message, "offer%c", &c) != 1 && sscanf(message, "resign%c", &c) != 1 &&
             sscanf(message, "feature %c", &c) != 1 && sscanf(message, "error %c", &c) != 1 &&
             sscanf(message, "illegal %c", &c) != 1 && sscanf(message, "tell%c", &c) != 1 && sscanf(message, "0-1 %c", &c) != 1 &&
             sscanf(message, "1-0 %c", &c) != 1 && sscanf(message, "1/2-1/2 %c", &c) != 1 &&
             sscanf(message, "setboard %c", &c) != 1 && sscanf(message, "setup %c", &c) != 1 &&
             sscanf(message, "hint: %c", &c) != 1 && sscanf(message, "pong %c", &c) != 1 && start != '#') {
        ...
        if (print) {
            GetTimeMark(&now);
            fprintf(debugFP, "%ld <%-6s: %s%s\n", SubtractTimeMarks(&now, &programStartTime), cps->which, quote, message);
            if (serverFP) {
    ...
    if (appData.icsEngineAnalyze) {
        if (strstr(message, "whisper") != NULL || strstr(message, "kibitz") != NULL || strstr(message, "tellics") != NULL) {
            return;
        }
    }
...
void SendTimeControl(ChessProgramState * cps, int mps, long tc, int inc, int sd, int st) {
    ...
    /* [HGM] time odds: apply before telling engine */
    tc /= cps->timeOdds;
    inc /= cps->timeOdds;
    st /= cps->timeOdds;

    /* [HGM] displaced to after applying odds */
    seconds = (tc / 1000) % 60;
    ...
    if (st > 0) {
        ...
        if (seconds == 0) {
            /* Note old gnuchess bug -- minutes:seconds used to not work.  Fixed in later versions, but still avoid :seconds when
            seconds is 0. */
            snprintf(buf, MSG_SIZ, "level %d %ld %g\n", mps, tc / 60000, inc / 1000.);
        } else {
            snprintf(buf, MSG_SIZ, "level %d %ld:%02d %g\n", mps, tc / 60000, seconds, inc / 1000.);
        }
    }
    SendToProgram(buf, cps);
    ...
    if (cps->nps >= 0) {
        if (cps->supportsNPS == FALSE) {
            /* don't use if engine explicitly says not supported! */
            cps->nps = -1;
        } else {
...
ChessProgramState * WhitePlayer(void) {
    if (gameMode == TwoMachinesPlay && first.twoMachinesColor[0] == 'b' || gameMode == BeginningOfGame ||
     gameMode == MachinePlaysBlack) {
        return &second;
    }
    return &first;
...
void SendTimeRemaining(ChessProgramState * cps, int machineWhite) {
    char message[MSG_SIZ];
    long time, otime;

    /* Note: this routine must be called when the clocks are stopped or when they have *just* been set or switched; otherwise it
    will be off by the time since the current tick started. */
    if (machineWhite) {
...
char * EngineDefinedVariant(ChessProgramState * cps, int n) {
    ...
    do {
        /* parse string from variants feature */
        VariantClass v;
        p = strchr(s, ',');
        if (p) {
            *p = NULLCHAR;
        ...
        v = StringToVariant(s);
        if (v == VariantNormal && strcmp(s, "normal") && !strstr(s, "_normal")) {
            v = VariantUnknown;  /* garbage is recognized as normal */
        }
        if (v == VariantUnknown) {  /* non-standard variant in list of engine-supported variants */
            if (!strcmp(s, "tenjiku") || !strcmp(s, "dai") || !strcmp(s, "dada") ||  /* ignore Alien-Edition variants */
             !strcmp(s, "maka") || !strcmp(s, "tai") || !strcmp(s, "kyoku") || !strcmp(s, "checkers") || !strcmp(s, "go") ||
             !strcmp(s, "reversi") || !strcmp(s, "dark") || !strcmp(s, "alien") || !strcmp(s, "multi") || !strcmp(s, "amazons")) {
                n++;
            }
            if (--n < 0) {
...
int BoolFeature(char ** p, char * name, int * loc, ChessProgramState * cps) {
    char buf[MSG_SIZ];
    int len = strlen(name);
    int val;
...
int IntFeature(char ** p, char * name, int * loc, ChessProgramState * cps) {
    char buf[MSG_SIZ];
    int len = strlen(name);
    if (strncmp((*p), name, len) == 0 && (*p)[len] == '=') {
        (*p) += len + 1;
...
int StringFeature(char ** p, char * name, char ** loc, ChessProgramState * cps) {
    char buf[MSG_SIZ];
    int len = strlen(name);
...
int ParseOption(Option * opt, ChessProgramState * cps)
/* [HGM] options: process the string that defines an engine option, and determine name, type, default value, and allowed value
range. */
{
    char * p;
    char * q;
    ...
    /* OK for spin/slider and checkbox */
    opt->target = &opt->value;
    if (p = strstr(opt->name, " -spin ")) {
        if ((n = sscanf(p, " -spin %d %d %d", &def, &min, &max)) < 3) {
            return FALSE;
        }
        if (max < min) {
            /* enforce consistency */
        ...
        if ((n = sscanf(p, " -slider %d %d %d", &def, &min, &max)) < 3) {
            return FALSE;
        }
        if (max < min) {
            /* enforce consistency */
        ...
        if (sscanf(p, " -check %d", &def) < 1) {
            return FALSE;
        }
        opt->value = (def != 0);
        opt->type = CheckBox;
    } else if (p = strstr(opt->name, " -combo ")) {
        /* cheat with pointer type */
        opt->textValue = (char *)(opt->choice = &cps->comboList[cps->comboCnt]);
        /* holds possible choices */
        cps->comboList[cps->comboCnt++] = q = p + 8;
        if (*q == '*') {
            cps->comboList[cps->comboCnt - 1]++;
        }
        opt->value = n = 0;
        while (q = StrStr(q, " /// ")) {
            n++;
            /* count choices, and null-terminate each of them */
            *q = 0;
            q += 5;
            if (*q == '*') {
                /* remember default, which is marked with * prefix */
                q++;
                opt->value = n;
            }
    ...
    *p = 0;
    /* hide default values somewhere */
    *(int *)(opt->name + MSG_SIZ - 104) = opt->value;
    if (opt->target == &opt->textValue) {
        strncpy(opt->name + MSG_SIZ - 100, opt->textValue, 99);
    }
    ...
    if (p && (p == cps->optionSettings || p[-1] == ',')) {
        ...
        if (q = strchr(buf, '=')) {
            ...
            case ComboBox:
                for (n = 0; n < opt->max; n++) {
                    if (!strcmp(((char **)opt->textValue)[n], q + 1)) {
                        opt->value = n;
                    }
                }
                break;
...
void FeatureDone(ChessProgramState * cps, int val) {
    ...
    if ((cb == InitBackEnd3 && cps == &first) || (cb == SettingsMenuIfReady && cps == &second) || (cb == LoadEngine) ||
     (cb == StartSecond) || (cb == TwoMachinesEventIfReady)) {
        CancelDelayedEvent();
        ScheduleDelayedEvent(cb, val ? 1 : 3600000);
    } else if (!val && !cps->reload) {
        /* Let 'spurious' done=0 clear engine's option list. */
        ClearOptions(cps);
    }
    cps->initDone = val;
    if (val) {
        cps->reload = FALSE, RefreshSettingsDialog(cps, val);
    }
}
...
void ParseFeatures(char * args, ChessProgramState * cps) {
    ...
    for (;;) {
        ...
        if (BoolFeature(&p, "setboard", &cps->useSetboard, cps)) {
            continue;
        }
        if (BoolFeature(&p, "xedit", &cps->extendedEdit, cps)) {
            continue;
        }
        if (BoolFeature(&p, "time", &cps->sendTime, cps)) {
            continue;
        }
        if (BoolFeature(&p, "draw", &cps->sendDrawOffers, cps)) {
            continue;
        }
        if (BoolFeature(&p, "sigint", &cps->useSigint, cps)) {
            continue;
        }
        if (BoolFeature(&p, "sigterm", &cps->useSigterm, cps)) {
            continue;
        }
        if (BoolFeature(&p, "reuse", &val, cps)) {
            /* The engine can disable reuse, but it may not override the user's choice to prohibit reuse. */
            if (!val) {
                cps->reuse = FALSE;
            }
            continue;
        }
        if (BoolFeature(&p, "analyze", &cps->analysisSupport, cps)) {
            continue;
        }
        ...
        if (StringFeature(&p, "variants", &cps->variants, cps)) {
            continue;
        }
        if (BoolFeature(&p, "san", &cps->useSAN, cps)) {
            continue;
        }
        if (BoolFeature(&p, "ping", &cps->usePing, cps)) {
            continue;
        }
        if (BoolFeature(&p, "playother", &cps->usePlayother, cps)) {
            continue;
        }
        if (BoolFeature(&p, "colors", &cps->useColors, cps)) {
            continue;
        }
        if (BoolFeature(&p, "usermove", &cps->useUsermove, cps)) {
            continue;
        }
        if (BoolFeature(&p, "exclude", &cps->excludeMoves, cps)) {
            continue;
        }
        if (BoolFeature(&p, "ics", &cps->sendICS, cps)) {
            continue;
        }
        if (BoolFeature(&p, "name", &cps->sendName, cps)) {
            continue;
        }
        if (BoolFeature(&p, "dice", &cps->dice, cps)) {
            continue;
        }
        if (BoolFeature(&p, "pause", &cps->pause, cps)) {
            continue;
        }
        ...
        if (BoolFeature(&p, "fen960", &cps->useFEN960, cps)) {
            continue;
        }
        if (BoolFeature(&p, "oocastle", &cps->useOOCastle, cps)) {
            continue;
        }
        if (BoolFeature(&p, "highlight", &cps->highlight, cps)) {
            continue;
        }
        if (BoolFeature(&p, "debug", &cps->debug, cps)) {
            continue;
        }
        if (BoolFeature(&p, "nps", &cps->supportsNPS, cps)) {
            continue;
        }
        if (IntFeature(&p, "level", &cps->maxNrOfSessions, cps)) {
            continue;
        }
        if (BoolFeature(&p, "memory", &cps->memSize, cps)) {
            continue;
        }
        if (BoolFeature(&p, "smp", &cps->maxCores, cps)) {
            continue;
        }
        if (StringFeature(&p, "egt", &cps->egtFormats, cps)) {
            continue;
        }
...
void PonderNextMoveEvent(int newState) {
    if (newState == appData.ponderNextMove) {
        return;
    }
    if (gameMode == EditPosition) {
        EditPositionDone(TRUE);
...
void NewSettingEvent(int option, int * feature, char * command, int value) {
    ...
    if (gameMode == TwoMachinesPlay) {
        if (feature == NULL || feature[(int *)&second - (int *)&first]) {
            SendToProgram(buf, &second);
        }
    }
}
...
void ShowThinkingEvent(void) {
    /* kludge alert!  Neither true nor false, so first time oldState is always updated */
    ...
    /* [HGM] thinking: responsible option should already have be changed when calling this routine! */
...
void TypeInEvent(char firstChar) {
    if ((gameMode == BeginningOfGame && !appData.icsActive) || gameMode == MachinePlaysWhite || gameMode == MachinePlaysBlack ||
     gameMode == AnalyzeMode || gameMode == EditGame || gameMode == EditPosition || gameMode == IcsExamining ||
     ...
     isdigit(firstChar) &&  /* [HGM] movenum: allow typing in of move nr in 'passive' modes */
      (gameMode == AnalyzeFile || gameMode == PlayFromGameFile || gameMode == IcsObserving || gameMode == TwoMachinesPlay) ||
     gameMode == Training) {
        PopUpMoveDialog(firstChar);
    }
}
...
void TypeInDoneEvent(char * move) {
    ...
    /* Undocumented kludge: allow command-line option to be typed in!  (Potentially fatal, and does not implement the effect of the
    option.)  This should only be used for options that are values on which future decisions will be made, and definitely not on
    options that would be used during initialization. */
    if (strstr(move, "!!! -") == move) {
        ParseArgsFromString(move + 4);
        return;
    }

    if (gameMode != EditGame && currentMove != forwardMostMove && gameMode != Training) {
        DisplayMoveError(_("Displayed move is not current"));
    } else {
        int ok = ParseOneMove(
         move, gameMode == EditPosition ? blackPlaysFirst : currentMove, &moveType, &fromX, &fromY, &toX, &toY, &promoChar);
        if (!ok && move[0] >= 'a') {
            /* [HGM] try also capitalized */
            move[0] += 'A' - 'a';
            ok = 2;
        }
        if (ok == 1 ||
...
void DisplayMove(int moveNumber) {
    ...
    if (appData.noGUI) {
        /* [HGM] fast: suppress display of moves */
        return;
    }

    if (moveNumber == forwardMostMove - 1 || gameMode == AnalyzeMode || gameMode == AnalyzeFile) {
    ...
    if (moveNumber == forwardMostMove - 1 && gameInfo.resultDetails != NULL) {
        if (gameInfo.resultDetails[0] == NULLCHAR) {
            snprintf(res, MSG_SIZ, " %s", PGNResult(gameInfo.result));
        } else {
            snprintf(res, MSG_SIZ, " {%s} %s", T_(gameInfo.resultDetails), PGNResult(gameInfo.result));
        }
    } else {
        res[0] = NULLCHAR;
    }
    ...
    if (moveNumber < 0 || parseList[moveNumber][0] == NULLCHAR) {
        ...
        snprintf(
         message, MSG_SIZ, "%d.%s%s%s", moveNumber / 2 + 1, WhiteOnMove(moveNumber) ? " " : ".. ", parseList[moveNumber], res);
...
void DisplayComment(int moveNumber, char * text) {
    ...
    if (moveNumber < 0 || parseList[moveNumber][0] == NULLCHAR) {
        ...
        snprintf(
         title, MSG_SIZ, "Comment on %d.%s%s", moveNumber / 2 + 1, WhiteOnMove(moveNumber) ? " " : ".. ", parseList[moveNumber]);
    }
...
/* This routine sends a ^C interrupt to gnuchess, to awaken it if it might be busy thinking or pondering.  It can be omitted if your
gnuchess is configured to stop thinking immediately on any user input.  However, that gnuchess feature depends on the FIONREAD
...
void Attention(ChessProgramState * cps) {
    ...
    if (appData.noChessProgram || (cps->pr == NoProc)) {
        return;
    }
    switch (gameMode) {
    case MachinePlaysWhite:
...
int CheckFlags(void) {
    if (whiteTimeRemaining <= 0) {
        if (!whiteFlag) {
            whiteFlag = TRUE;
            if (appData.icsActive) {
                if (appData.autoCallFlag && gameMode == IcsPlayingBlack && !blackFlag) {
                    SendToICS(ics_prefix);
                    SendToICS("flag\n");
                }
            } else {
    ...
    if (blackTimeRemaining <= 0) {
        if (!blackFlag) {
            blackFlag = TRUE;
            if (appData.icsActive) {
                if (appData.autoCallFlag && gameMode == IcsPlayingWhite && !whiteFlag) {
                    SendToICS(ics_prefix);
                    SendToICS("flag\n");
                }
            } else {
...
void CheckTimeControl(void) {
    if (!appData.clockMode || appData.icsActive || searchTime ||  /* [HGM] st: no inc in st mode */
     gameMode == PlayFromGameFile || forwardMostMove == 0) {
        return;
    }
    ...
    if (!WhiteOnMove(forwardMostMove)) {
        ...
        /* [HGM] leave absolute time (after quota), so next switch we can us it to calculate thinking time */
        lastBlack = blackTimeRemaining;
    } else {
        lastBlack -= blackTimeRemaining;
        /* Black made time control. */
        blackTimeRemaining +=
         GetTimeQuota((forwardMostMove - blackStartMove - 1) / 2, lastBlack, blackTC) / WhitePlayer()->other->timeOdds;
        lastWhite = whiteTimeRemaining;
    }
}

void DisplayBothClocks(void) {
    int wom = gameMode == EditPosition ? !blackPlaysFirst : WhiteOnMove(currentMove);
    DisplayWhiteClock(whiteTimeRemaining, wom);
    DisplayBlackClock(blackTimeRemaining, !wom);
}


/* A previous programmer thought that timekeeping seems to be a portability nightmare, and that probably everyone had ftime(), but
wasn't really sure, so included ifdefs to use other calls just in case.  It was also noted that clocks will be less accurate on
machines with neither ftime nor gettimeofday. */
#if !HAVE_GETTIMEOFDAY && HAVE_FTIME
# include <sys/timeb.h>
#endif

/* Get the current time as a TimeMark. */
void GetTimeMark(TimeMark * tm) {
...
/* Return the difference in milliseconds between two time marks.  We assume the difference will fit in a long! */
long SubtractTimeMarks(TimeMark * tm2, TimeMark * tm1) { return 1000l * (tm2->sec - tm1->sec) + (long)(tm2->ms - tm1->ms); }


/* Code to manage the game clocks.

In tournament play, black starts the clock and then white makes a move.  We give the human user a slight advantage if he is playing
white---the clocks don't run until he makes his first move, so it takes zero time.  Also, we don't account for network lag, so we
could get out of sync with GNU Chess's clock -- but then, referees are always right. */

static TimeMark tickStartTM;
static long intendedTickLength;

long NextTickLength(long timeRemaining) {
...
void AdjustClock(Boolean which, int dir) {
    if (appData.autoCallFlag) {
        DisplayError(_("Clock adjustment not allowed in auto-flag mode"), 0);
        return;
    }
    if (which) {
        blackTimeRemaining += 60000 * dir;
    } else {
        whiteTimeRemaining += 60000 * dir;
    }
    DisplayBothClocks();
    adjustedClock = TRUE;
}
...
void ResetClocks(void) {
    ...
    if (appData.icsActive) {
        ...
        /* [HGM] correct new time quote for time odds */
...
/* 25ms = 1/40 sec; should be plenty even for 50 Hz clocks */
#define FUDGE 25

/* [HGM] This should realy be a passed parameter, but it has to pass through too many levels for a previous programmer's
laziness... */
static int timeSuffix;
...
void DecrementClocks(void) {
    ...
    if (WhiteOnMove(forwardMostMove)) {
        ...
        if (tRemaining < 0 && !appData.icsActive) {
            /* sets suddenDeath & nextSession; */
            GetTimeQuota((forwardMostMove - whiteStartMove - 1) / 2, 0, whiteTC);
            if (suddenDeath) {
                /* [HGM] if we run out of a non-last incremental session, go to the next */
                whiteStartMove = forwardMostMove;
                whiteTC = nextSession;
                lastWhite = tRemaining = whiteTimeRemaining += GetTimeQuota(-1, 0, whiteTC);
            }
        }
        if (forwardMostMove && appData.moveTime) {
            timeSuffix = timeRemaining[0][forwardMostMove - 1] - tRemaining;
        }
        DisplayWhiteClock(whiteTimeRemaining - fudge, WhiteOnMove(currentMove < forwardMostMove ? currentMove : forwardMostMove));
        timeSuffix = 0;
    } else {
        if (blackNPS >= 0) {
            lastTickLength = 0;
        ...
        if (forwardMostMove && appData.moveTime) {
            timeSuffix = timeRemaining[1][forwardMostMove - 1] - tRemaining;
        }
        DisplayBlackClock(blackTimeRemaining - fudge, !WhiteOnMove(currentMove < forwardMostMove ? currentMove : forwardMostMove));
        timeSuffix = 0;
    }
    if (CheckFlags()) {
        return;
    ...
    if (twoBoards) {
        /* Count down secondary board's clocks as well. */
        activePartnerTime -= lastTickLength;
        partnerUp = 1;
        if (activePartner == 'W') {
            /* The counting clock is always the highlighted one! */
            DisplayWhiteClock(activePartnerTime, TRUE);
        } else {
    ...
    /* If the time remaining has fallen below the alarm threshold, then sound the alarm.  If the alarm has sounded and (due to a
    takeback or time control with increment) the time remaining has increased to a level above the threshold, reset the alarm so it
    can sound again. */
...
/* A player has just moved, so stop the previously running clock and (if in clock mode) start the other one.  We redisplay both
clocks in case we're in ICS mode, because ICS gives us an update to both clocks after every move.  Note that this routine is called
*after* forwardMostMove is updated, so the last fractional tick must be subtracted from the color that is *not* on move now. */
void SwitchClocks(int newMoveNr) {
    long lastTickLength;
    TimeMark now;
    int flagged = FALSE;
    ...
    if (StopClockTimer() && appData.clockMode) {
        ...
        if (!WhiteOnMove(forwardMostMove)) {
            ...
            /* [HGM] PGNtime: save time for PGN file if engine did not give it */
            /*if(pvInfoList[forwardMostMove].time == -1)*/
            pvInfoList[forwardMostMove].time = (timeRemaining[0][forwardMostMove - 1] - whiteTimeRemaining) / 10;
        }
        flagged = CheckFlags();
    }
    /* [HGM] race: change stm when no timer interrupt scheduled */
    forwardMostMove = newMoveNr;
    CheckTimeControl();
    ...
    if (searchTime) {
        /* [HGM] st: set clock of player that has to move to max time */
        if (WhiteOnMove(forwardMostMove)) {
            whiteTimeRemaining = 1000 * searchTime / WhitePlayer()->timeOdds;
        } else {
            blackTimeRemaining = 1000 * searchTime / WhitePlayer()->other->timeOdds;
    ...
    tickStartTM = now;
    intendedTickLength = NextTickLength(WhiteOnMove(forwardMostMove) ? whiteTimeRemaining : blackTimeRemaining);
    StartClockTimer(intendedTickLength);
}
...
/* Start clock of player on move.  Time may have been reset, so if clock is already running, stop and restart it. */
void StartClocks(void) {
    /* in case it was running already */
    (void)StopClockTimer();
    DisplayBothClocks();
    if (CheckFlags()) {
        return;
    ...
    if (gameMode == MachinePlaysWhite || gameMode == TwoMachinesPlay && first.twoMachinesColor[0] == 'w' ||
     appData.zippyPlay && gameMode == IcsPlayingBlack) {
        /* The first (and perhaps only) engine plays white. */
        whiteNPS = first.nps;
    }
    if (gameMode == MachinePlaysBlack || gameMode == TwoMachinesPlay && first.twoMachinesColor[0] == 'b' ||
     appData.zippyPlay && gameMode == IcsPlayingWhite) {
        /* The first (and perhaps only) engine plays black. */
        blackNPS = first.nps;
    }
    if (gameMode == TwoMachinesPlay && first.twoMachinesColor[0] == 'b') {
        /* Second is only used in Two Machines mode. */
        whiteNPS = second.nps;
    }
    ...
    if (appData.debugMode) {
        fprintf(debugFP, "nps: w=%d, b=%d\n", whiteNPS, blackNPS);
    }

    StartClockTimer(intendedTickLength);
}

char * TimeString(long ms) {
    ...
    /* Convert milliseconds to seconds, rounding up. Use floating-point arithmetic to avoid the strangeness of integer division with
       negative dividends on many machines. */
    ...
    if (timeSuffix) {
        /* [HGM] kludge alert; fraction contains move time */
        snprintf(moveTime, 8, " (%d)", timeSuffix / 1000);
    } else {
        *moveTime = NULLCHAR;
    }

    if (day > 0) {
        snprintf(buf, sizeof(buf) / sizeof(buf[0]), " %s%ld:%02ld:%02ld:%02ld%s ", sign, day, hour, minute, second, moveTime);
    } else if (hour > 0) {
...
TODO: Eliminate this function, which was added to XBoard in 1991, and rely on strstr from the C standard library.
We no longer support pre-ANSI C89/ISO C90 compilers. */
...
char * PGNDate(void) {
    ...
    clock = time((time_t *)NULL);
    tm = localtime(&clock);
    snprintf(buf, MSG_SIZ, "%04d.%02d.%02d", tm->tm_year + 1900, tm->tm_mon + 1, tm->tm_mday);
    return StrSave(buf);
}


char * PositionToFEN(int move, char * overrideCastling, int moveCounts) {
    ...
    whiteToPlay = (gameMode == EditPosition) ? !blackPlaysFirst : (move % 2 == 0);
    p = buf;

    /* Piece placement data */
    for (i = BOARD_HEIGHT - 1 - deadRanks; i >= 0; i--) {
        if (MSG_SIZ - (p - buf) < BOARD_RGHT - BOARD_LEFT + 20) {
            *p = 0;
            return StrSave(buf);
        }
        emptycount = 0;
        for (j = BOARD_LEFT; j < BOARD_RGHT; j++) {
            if (boards[move][i][j] == EmptySquare) {
                ...
                ChessSquare piece = boards[move][i][j];
                if (emptycount > 0) {
                    if (emptycount < 10) {
                        *p++ = '0' + emptycount;
                    } else {
                ...
                if (c == '+') {
                    ...
                    if (autoProm[piece] && pieceNickName[piece] >= 'A') {
    ...
    *(p - 1) = ' ';
    ...
    if (gameInfo.holdingsWidth) {
        /* if we wanted to support BFEN, this could be '/' */
        *(p - 1) = '[';
        q = p;
        for (i = 0; i < gameInfo.holdingsSize; i++) {
            /* white holdings */
    ...
    *p++ = ' ';
    ...
    if (pieceDesc[WhiteKing] && strchr(pieceDesc[WhiteKing], 'i') && !strchr(pieceDesc[WhiteKing], 'O')) {
        /* redefined without castling */
        haveRights = 0;
        q = p;
        for (i = BOARD_RGHT - 1; i >= BOARD_LEFT; i--) {
            piece = boards[move][0][i];
            if (piece >= WhitePawn && piece <= WhiteKing && pieceDesc[piece] && strchr(pieceDesc[piece], 'i')) {
                /* piece with initial move */
                if (!(boards[move][TOUCHED_W] & 1 << i)) {
                    /* print file ID if it has not moved */
                    *p++ = 'A' + i;
                }
            }
        }
        for (i = BOARD_RGHT - 1; i >= BOARD_LEFT; i--) {
            ...
            if (piece >= BlackPawn && piece <= BlackKing && pieceDesc[piece] && strchr(pieceDesc[piece], 'i')) {
                /* piece with initial move */
                if (!(boards[move][TOUCHED_B] & 1 << i)) {
                    /* print file ID if it has not moved */
                    *p++ = 'a' + i;
                }
            }
    ...
    if (q = overrideCastling) {
        /* [HGM] FRC: override castling & e.p fields for non-compliant engines */
        while (*p++ = *q++)
            ;
        if (q != overrideCastling + 1) {
            p[-1] = ' ';
        } else {
            --p;
        }
        ...
        if (haveRights) {
            int handW = 0, handB = 0;
            if (gameInfo.variant == VariantSChess) {
                /* for S-Chess, all virgin backrank pieces must be listed */
                for (i = 0; i < BOARD_HEIGHT; i++) {
                    /* count white held pieces */
                    handW += boards[move][i][BOARD_RGHT];
                }
                for (i = 0; i < BOARD_HEIGHT; i++) {
                    /* count black held pieces */
                    handB += boards[move][i][BOARD_LEFT - 1];
                }
            }
            q = p;
            if (appData.fischerCastling) {
                if (handW) {
                    /* in shuffle S-Chess simply dump all virgin pieces */
                    for (i = BOARD_RGHT - 1; i >= BOARD_LEFT; i--) {
                        if (boards[move][VIRGIN][i] & VIRGIN_W) {
                            *p++ = i + AAA + 'A' - 'a';
                        }
                    }
                } else {
                    /* [HGM] write directly from rights */
                    if (boards[move][CASTLING][2] != NoRights && boards[move][CASTLING][0] != NoRights) {
                        *p++ = boards[move][CASTLING][0] + AAA + 'A' - 'a';
                    }
                    if (boards[move][CASTLING][2] != NoRights && boards[move][CASTLING][1] != NoRights) {
                        *p++ = boards[move][CASTLING][1] + AAA + 'A' - 'a';
                    }
                }
                if (handB) {
                    for (i = BOARD_RGHT - 1; i >= BOARD_LEFT; i--) {
                        if (boards[move][VIRGIN][i] & VIRGIN_B) {
                            *p++ = i + AAA;
                        }
                    }
                } else {
                    if (boards[move][CASTLING][5] != NoRights && boards[move][CASTLING][3] != NoRights) {
                        *p++ = boards[move][CASTLING][3] + AAA;
                    }
                    if (boards[move][CASTLING][5] != NoRights && boards[move][CASTLING][4] != NoRights) {
                ...
                if (nrCastlingRights == 6) {
                    int q, k = 0;
                    if (boards[move][CASTLING][0] != NoRights && boards[move][CASTLING][2] != NoRights) {
                        k = 1, *p++ = 'K';
                    }
                    q = (boards[move][CASTLING][1] != NoRights && boards[move][CASTLING][2] != NoRights);
                    if (handW) {
                        /* for S-Chess with pieces in hand, list virgin pieces between K and Q */
                        for (i = BOARD_RGHT - 1 - k; i >= BOARD_LEFT + q; i--) {
                            if ((boards[move][0][i] != WhiteKing || k + q == 0) && boards[move][VIRGIN][i] & VIRGIN_W) {
                                *p++ = i + AAA + 'A' - 'a';
                            }
                        }
                    }
                    ...
                    k = 0;
                    if (boards[move][CASTLING][3] != NoRights && boards[move][CASTLING][5] != NoRights) {
                        k = 1, *p++ = 'k';
                    }
                    q = (boards[move][CASTLING][4] != NoRights && boards[move][CASTLING][5] != NoRights);
                    if (handB) {
                        for (i = BOARD_RGHT - 1 - k; i >= BOARD_LEFT + q; i--) {
                            if ((boards[move][BOARD_HEIGHT - 1][i] != BlackKing || k + q == 0) &&
                             boards[move][VIRGIN][i] & VIRGIN_B) {
                                *p++ = i + AAA;
                            }
                        }
                    }
    ...
    if (moveCounts) {
        ...
        while (j > backwardMostMove && (signed char)boards[j][EP_STATUS] <= EP_NONE) {
            j--, i++;
        }
        if (j == backwardMostMove) {
            i += initialRulePlies;
        }
        sprintf(p, "%d ", i);
        p += i >= 100 ? 4 : i >= 10 ? 3 : 2;
...
Boolean ParseFEN(Board board, int * blackPlaysFirst, char * fen, Boolean autoSize) {
    ...
    for (i = 1; i <= deadRanks; i++) {
        for (j = BOARD_LEFT; j < BOARD_RGHT; j++) {
            board[BOARD_HEIGHT - i][j] = DarkSquare;
        }
    }
    ...
    for (i = BOARD_HEIGHT - 1 - deadRanks; i >= 0; i--) {
        ...
        for (;;) {
            if (*p == '/' || *p == ' ' || *p == '[') {
                ...
                if (*p == '/') {
                    p++;
                } else if (autoSize && i != BOARD_HEIGHT - 1) {
                    /* we stumbled unexpectedly into end of board */
                    /* too few ranks; shift towards bottom */
                    for (k = i; k < BOARD_HEIGHT; k++) {
                        for (j = 0; j < BOARD_WIDTH; j++) {
                            board[k - i][j] = board[k][j];
                        }
                    }
                    appData.NrRanks = gameInfo.boardHeight - i;
                    i = 0;
                }
                break;
#if (BOARD_FILES >= 10) * 0
                ...
                p++;
                emptycount = 10;
                if (j + emptycount > gameInfo.boardWidth) {
                    return FALSE;
                }
                while (emptycount--) {
                    board[i][(j++) + gameInfo.holdingsWidth] = EmptySquare;
                ...
                board[i][(j++) + gameInfo.holdingsWidth] = DarkSquare;
                p++;
            } else if (*p == '0') {
                p++;
                board[i][(j++) + gameInfo.holdingsWidth] = EmptySquare;
                ...
                /* For now, ignore closing shuffle range, and assume rank-end. */
                p++;
            } else if (*p == '?') {
                if (j >= gameInfo.boardWidth) {
                    return FALSE;
                }
                ...
                board[i][(j++) + gameInfo.holdingsWidth] = ClearBoard;
                p++;
                /* placeHolder */
                subst++;
            } else if (*p == '+' || isalpha(*p)) {
                ...
                if (*p == '+') {
                    ...
                    piece = (ChessSquare)(CHUPROMOTED(piece));
                    p++;
                ...
                if (*p == '~') {
                    /* [HGM] make it a promoted piece for Crazyhouse */
                    piece = (ChessSquare)(PROMOTED(piece));
                    if (PieceToChar(piece) != '~') {
                        /* cannot be a promoted piece */
                        return FALSE;
                    }
                    p++;
                }
    ...
    if (autoSize && w != 0) {
        appData.NrFiles = w, InitPosition(TRUE);
    }
    ...
    if (gameInfo.holdingsWidth) {
        for (i = 0; i < handSize; i++) {
            /* black holdings */
            board[i][0] = EmptySquare;
            /* white holdings */
            board[i][BOARD_WIDTH - 1] = EmptySquare;
            /* black counts */
            board[i][1] = (ChessSquare)0;
            /* white counts */
            board[i][BOARD_WIDTH - 2] = (ChessSquare)0;
        }
    }
    ...
    if (gameInfo.holdingsWidth && p[-1] == '/' || *p == '[') {
        ...
        if (*p == '-') {
            ...
            if (!gameInfo.holdingsWidth) {
                /* no room to put holdings! */
                return FALSE;
            }
            /* If we would allow FEN reading to set the board size, then we would have to add holdings and shift the board read so
            far here. */
            while ((piece = CharToPiece(*p)) != EmptySquare) {
                ...
                if ((int)piece >= (int)BlackPawn) {
                    ...
                    if (i >= gameInfo.holdingsSize) {
                        return FALSE;
                    }
                    /* black holdings */
                    board[handSize - 1 - i][0] = piece;
                    /* black counts */
                    board[handSize - 1 - i][1]++;
                    bcnt++;
                } else {
            ...
            if (subst) {
                /* substitute back-rank question marks by holdings pieces */
                for (j = BOARD_LEFT; j < BOARD_RGHT; j++) {
                    int k, m, n = bcnt + 1;
                    if (board[0][j] == ClearBoard) {
                        ...
                        n = rand() % wcnt;
                        for (k = 0, m = n; k < gameInfo.holdingsSize; k++) {
                            if ((m -= board[k][BOARD_WIDTH - 2]) < 0) {
                                board[0][j] = board[k][BOARD_WIDTH - 1];
                                wcnt--;
                                if (--board[k][BOARD_WIDTH - 2] == 0) {
                                    board[k][BOARD_WIDTH - 1] = EmptySquare;
                                }
                                break;
                            }
                    ...
                    if (board[BOARD_HEIGHT - 1][j] == ClearBoard) {
                        ...
                        if (n >= bcnt) {
                            /* use same randomization for black and white if possible */
                            n = rand() % bcnt;
                        }
                        for (k = 0, m = n; k < gameInfo.holdingsSize; k++) {
                            if ((n -= board[handSize - 1 - k][1]) < 0) {
                                board[BOARD_HEIGHT - 1][j] = board[handSize - 1 - k][0];
                                bcnt--;
                                if (--board[handSize - 1 - k][1] == 0) {
                                    board[handSize - 1 - k][0] = EmptySquare;
                                }
                                break;
                            }
    ...
    if (subst) {
        /* substitution requested, but no holdings */
        return FALSE;
    }
    ...
    if (appData.colorNickNames) {
        if (c == appData.colorNickNames[0]) {
            c = 'w';
        } else if (c == appData.colorNickNames[1]) {
            c = 'b';
        }
    }
    switch (c) {
    ...
    /* [HGM] We NO LONGER ignore the rest of the FEN notation.  Return the extra info in global variables. */
    while (*p == ' ') {
        p++;
    }

    if (!isdigit(*p) && *p != '-') {
        /* We seem to have castling rights.  Make sure they are on the rank the King actually is. */
        if (wKingRank >= 0) {
            for (i = 0; i < 3; i++) {
                castlingRank[i] = wKingRank;
            }
        }
        if (bKingRank >= 0) {
            for (i = 3; i < 6; i++) {
                castlingRank[i] = bKingRank;
            }
        }
    }
    ...
    for (i = 0; i < 6; i++) {
        ...
        board[CASTLING][i] = appData.fischerCastling ? NoRights : initialRights[i];
    }
    if (initialRights[0] != NoRights && board[castlingRank[0]][initialRights[0]] != WhiteRook) {
        board[CASTLING][0] = NoRights;
    }
    if (initialRights[1] != NoRights && board[castlingRank[1]][initialRights[1]] != WhiteRook) {
        board[CASTLING][1] = NoRights;
    }
    if (initialRights[2] != NoRights && board[castlingRank[2]][initialRights[2]] != WhiteUnicorn &&
     board[castlingRank[2]][initialRights[2]] != WhiteKing) {
        board[CASTLING][2] = NoRights;
    }
    if (initialRights[3] != NoRights && board[castlingRank[3]][initialRights[3]] != BlackRook) {
        board[CASTLING][3] = NoRights;
    }
    if (initialRights[4] != NoRights && board[castlingRank[4]][initialRights[4]] != BlackRook) {
        board[CASTLING][4] = NoRights;
    }
    if (initialRights[5] != NoRights && board[castlingRank[5]][initialRights[5]] != BlackUnicorn &&
     board[castlingRank[5]][initialRights[5]] != BlackKing) {
        board[CASTLING][5] = NoRights;
    }
    FENrulePlies = 0;
    ...
    if (pieceDesc[WhiteKing] && strchr(pieceDesc[WhiteKing], 'i') && !strchr(pieceDesc[WhiteKing], 'O')) {
     ...
     if (nrCastlingRights) {
        ...
        while (*p == 'K' || *p == 'Q' || *p == 'k' || *p == 'q' || *p == '-' ||
         (appData.fischerCastling || gameInfo.variant == VariantSChess) && (*p >= 'a' && *p < 'a' + gameInfo.boardWidth) ||
         (*p >= 'A' && *p < 'A' + gameInfo.boardWidth)) {
            int c = *p++, whiteKingFile = NoRights, blackKingFile = NoRights;

            for (i = BOARD_LEFT; i < BOARD_RGHT; i++) {
                if (board[castlingRank[5]][i] == BlackKing) {
                    blackKingFile = i;
                }
                if (board[castlingRank[2]][i] == WhiteKing) {
                    whiteKingFile = i;
                }
            }
            if (gameInfo.variant == VariantTwoKings || gameInfo.variant == VariantKnightmate) {
                /* for these variant scanning fails */
                whiteKingFile = blackKingFile = BOARD_WIDTH >> 1;
            }
            if (whiteKingFile == NoRights ||
             board[castlingRank[2]][whiteKingFile] != WhiteUnicorn && board[castlingRank[2]][whiteKingFile] != WhiteKing) {
                whiteKingFile = NoRights;
            }
            if (blackKingFile == NoRights ||
             board[castlingRank[5]][blackKingFile] != BlackUnicorn && board[castlingRank[5]][blackKingFile] != BlackKing) {
                blackKingFile = NoRights;
            }
            switch (c) {
            case 'K':
                ...
                if (board[CASTLING][0] != NoRights) {
                    virgin[board[CASTLING][0]] |= VIRGIN_W;
                }
                if (board[CASTLING][2] != NoRights) {
                    virgin[board[CASTLING][2]] |= VIRGIN_W;
                }
                if (whiteKingFile != BOARD_WIDTH >> 1 || i != BOARD_RGHT - 1) {
                    fischer = 1;
                }
                break;
            case 'Q':
                ...
                board[CASTLING][2] = whiteKingFile;
                if (board[CASTLING][1] != NoRights) {
                    virgin[board[CASTLING][1]] |= VIRGIN_W;
                }
                if (board[CASTLING][2] != NoRights) {
                    virgin[board[CASTLING][2]] |= VIRGIN_W;
                }
                if (whiteKingFile != BOARD_WIDTH >> 1 || i != BOARD_LEFT) {
                    fischer = 1;
                }
                break;
            case 'k':
                ...
                if (board[CASTLING][3] != NoRights) {
                    virgin[board[CASTLING][3]] |= VIRGIN_B;
                }
                if (board[CASTLING][5] != NoRights) {
                    virgin[board[CASTLING][5]] |= VIRGIN_B;
                }
                if (blackKingFile != BOARD_WIDTH >> 1 || i != BOARD_RGHT - 1) {
                    fischer = 1;
                }
                break;
            case 'q':
                ...
                board[CASTLING][5] = blackKingFile;
                if (board[CASTLING][4] != NoRights) {
                    virgin[board[CASTLING][4]] |= VIRGIN_B;
                }
                if (board[CASTLING][5] != NoRights) {
                    virgin[board[CASTLING][5]] |= VIRGIN_B;
                }
                if (blackKingFile != BOARD_WIDTH >> 1 || i != BOARD_LEFT) {
                    fischer = 1;
                }
            case '-':
                break;
            default:
                ...
                if (c >= 'a') {
                    /* black rights */
                    if (gameInfo.variant == VariantSChess) {
                        virgin[c - AAA] |= VIRGIN_B;
                        break;
                    }  /* in S-Chess castlings are always kq, so just virginity */
                    for (i = BOARD_LEFT; i < BOARD_RGHT; i++) {
                        if (board[BOARD_HEIGHT - 1][i] == BlackKing) {
                            break;
                        }
                    }
                    if (i == BOARD_RGHT) {
                    ...
                    board[CASTLING][5] = i;
                    c -= AAA;
                    if (board[BOARD_HEIGHT - 1][c] < BlackPawn || board[BOARD_HEIGHT - 1][c] >= BlackKing) {
                        break;
                    }
                    if (c > i) {
                        board[CASTLING][3] = c;
                    ...
                    /* white rights */
                    if (gameInfo.variant == VariantSChess) {
                        virgin[c - AAA - 'A' + 'a'] |= VIRGIN_W;
                        break;
                    }  /* in S-Chess castlings are always KQ */
                    for (i = BOARD_LEFT; i < BOARD_RGHT; i++) {
                        if (board[0][i] == WhiteKing) {
                            break;
                        }
                    }
                    if (i == BOARD_RGHT) {
        ...
        for (i = 0; i < nrCastlingRights; i++) {
            if (board[CASTLING][i] != NoRights) {
                initialRights[i] = board[CASTLING][i];
            }
        }
        if (gameInfo.variant == VariantSChess) {
            for (i = 0; i < BOARD_FILES; i++) {
                /* when shuffling assume all virgin */
                board[VIRGIN][i] = shuffle ? VIRGIN_W | VIRGIN_B : virgin[i];
            }
        }
        if (fischer && shuffle) {
            appData.fischerCastling = TRUE;
    ...
    if (shuffle) {
        SetUpShuffle(board, appData.defaultFrcPosition);
    }
     ...
     gameInfo.variant != VariantASEAN) {
        if (*p == '-') {
            ...
            if (c >= BOARD_LEFT && c < BOARD_RGHT) {
                p++;
                board[EP_STATUS] = board[EP_FILE] = c;
                r = 0;
                if (*p >= '0' && *p <= '9') {
                    r = board[EP_RANK] = *p++ - ONE;
                }
                /* assume double-push (P next to e.p. square nearer center) */
                d = (r < BOARD_HEIGHT << 1 ? 1 : -1);
                if (board[r + d][c] == EmptySquare) {
                    /* but if no Pawn there, triple push */
                    d *= 2;
                }
    ...
    if (c > 0) {
        ...
        if (c == 3 && !board[CHECK_COUNT]) {
            /* SCIDB-style check count */
            board[CHECK_COUNT] = (3 - j) + 256 * (3 - k);
        }
    }
...
void EditPositionPasteFEN(char * fen) {
    if (fen != NULL) {
        ...
        if (!ParseFEN(initial_position, &blackPlaysFirst, fen, TRUE)) {
            ...
            /* [HGM] copy FEN attributes as well */
            initialRulePlies = FENrulePlies;
            /* [HGM] fake: do not fake rights if we had FEN */
...
/* Reformat a source message so words don't cross the width boundary.  Internal newlines are not removed.  Returns the wrapped size
(no null character unless included in source message).  If dest is NULL, only calculate the size required for the dest buffer.  The
lp argument indicates line position upon entry, and it's passed back upon exit.*/
int wrap(char * dest, char * src, int count, int width, int * lp) {
    ...
    if (dest && appData.debugMode) {
        fprintf(debugFP, "wrap(count:%d,width:%d,line:%d,len:%d,*lp:%d,src: ", count, width, line, len, *lp);
...
void PushInner(int firstMove, int lastMove) {
    int i;
    int j;
    int nrMoves = lastMove - firstMove;
    ...
    /* reserve space for the boards */
    framePtr -= nrMoves;
    /* copy boards to stack, working downwards, in case of overlap */
    for (i = nrMoves; i >= 1; i--) {
    ...
    storedGames++;
    /* truncate game so we can start variation */
    forwardMostMove = firstMove;
}

void PushTail(int firstMove, int lastMove) {
    if (appData.icsActive) {
        /* only in local mode */
        /* mimic old ICS behavior */
        forwardMostMove = currentMove;
        return;
    }
    if (storedGames >= MAX_VARIATIONS - 2) {
        /* leave one for PV-walk */
        return;
    }
    ...
    if (gameMode == PlayFromGameFile) {
        gameMode = EditGame, modeRestore = TRUE;
    }
}
...
void PopInner(Boolean annotate) {
    ...
    /* sets currentMove */
    ToNrEvent(savedFirst[storedGames - 1]);
    /* do this after ToNrEvent, to make sure HistorySet will refresh entire game after PopInner returns */
    storedGames--;
    ...
    if (annotate) {
        ...
        for (i = currentMove; i < forwardMostMove; i++) {
            if (WhiteOnMove(i)) {
                ...
                snprintf(moveBuf, sizeof(moveBuf) / sizeof(moveBuf[0]), " %s", SavePart(parseList[i]));
            }
            strcat(buf, moveBuf);
            if (commentList[i]) {
                strcat(buf, " ");
                strcat(buf, commentList[i]);
            }
            if (!--cnt) {
                strcat(buf, "\n");
                cnt = 10;
    ...
    for (i = 1; i <= nrMoves; i++) {
        ...
        if (commentList[currentMove + i]) {
            free(commentList[currentMove + i]);
        }
        commentList[currentMove + i] = commentList[framePtr + i];
        commentList[framePtr + i] = NULL;
    }
    if (annotate) {
        AppendComment(currentMove + 1, buf, FALSE);
    }
...
Boolean PopTail(Boolean annotate) {
    ...
    /* make sure no stale variation comments to the destroyed line can remain open */
    CommentPopDown();
    ...
    if (storedGames == 0) {
        GreyRevert(TRUE);
        if (modeRestore) {
            modeRestore = FALSE, gameMode = PlayFromGameFile;
        }
    }
    return TRUE;
}
...
void LoadVariation(int index, char * text) {
    ...
    if (gameMode != EditGame && gameMode != AnalyzeMode && gameMode != PlayFromGameFile) {
        return;
    }
    /* first find outermost bracketing variation */
    while (*p) {
        /* previous developer hoped they got this right... Non-nesting {} and [] can screen each other and nesting () */
        if (!wait) {
            /* while inside [] pr {}, ignore everyting except matching closing ]} */
            if (*p == '{') {
                wait = '}';
            } else if (*p == '[') {
                wait = ']';
            } else if (*p == '(' && level++ == 0 && p - text < index) {
                start = p + 1;
            }
            if (*p == ')' && level > 0 && --level == 0 && p - text > index && end == NULL) {
                end = p - 1;
            }
        }
        if (*p == wait) {
    ...
    if (!start || !end) {
        /* no variation found, or syntax error in PGN: ignore click */
        return;
    }
    if (appData.debugMode) {
        fprintf(debugFP, "at move %d load variation '%s'\n", currentMove, start);
    }
    end[1] = NULLCHAR;  /* clip off comment beyond variation */
    ToNrEvent(currentMove - 1);
    /* Shelve main variation.  This truncates the game. */
    PushTail(currentMove, forwardMostMove);
    /* kludge: use ParsePV() to append variation to game. */
    move = currentMove;
    ParsePV(start, TRUE, TRUE, 0);
    forwardMostMove = endPV;
    endPV = -1;
    /* Cleanup what ParsePV did. */
    currentMove = move;
    ClearPremoveHighlights();
    CommentPopDown();
    ToNrEvent(currentMove + 1);
...
#define BUF_SIZ (2 * MSG_SIZ)
    ...
    if (engineLine && engineLine[0]) {
        /* A theme was selected from the list box. */
        snprintf(buf, BUF_SIZ, "-theme %s", engineLine);
        ParseArgsFromString(buf);
        /* Also redo the colors. */
        ActivateTheme(TRUE);
        return;
    }
    p = nickName;
    if (*p && !strchr(p, '"')) {
        /* Theme name specified and well-formed: add settings to theme list.*/
        int len;
        q = appData.themeNames;
        snprintf(buf, BUF_SIZ, "\"%s\"", nickName);
        if (appData.useBitmaps) {
            snprintf(buf + strlen(buf), BUF_SIZ - strlen(buf), " -ubt true -lbtf \"%s\"", Shorten(appData.liteBackTextureFile));
            snprintf(buf + strlen(buf), BUF_SIZ - strlen(buf), " -dbtf \"%s\" -lbtm %d -dbtm %d",
             Shorten(appData.darkBackTextureFile), appData.liteBackTextureMode, appData.darkBackTextureMode);
        } else {
        ...
        if (appData.useBorder) {
            snprintf(buf + strlen(buf), BUF_SIZ - strlen(buf), " -ub true -border \"%s\"", appData.border);
        } else {
        ...
        if (appData.useFont) {
            snprintf(buf + strlen(buf), BUF_SIZ - strlen(buf), " -upf true -pf \"%s\" -fptc \"%s\" -fpfcw %s -fpbcb %s",
             appData.renderPiecesWithFont, appData.fontToPieceTable, Col2Text(9) /*appData.fontBackColorWhite*/,
            ...
            if (appData.pieceDirectory[0]) {
                ...
                /* 2 is a kludge to suppress this in WinBoard */
                if (appData.trueColors != 2) {
            ...
            if (!appData.pieceDirectory[0] || !appData.trueColors) {
                snprintf(buf + strlen(buf), BUF_SIZ - strlen(buf), " -wpc %s -bpc %s", Col2Text(0) /*whitePieceColor*/,
